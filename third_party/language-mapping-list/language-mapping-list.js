...
mozilla.LanguageMapping = {
  ...
  'zh-TW': "中文（台灣）",
  'zu-ZA': "isiZulu",
  //  Names are the reference names from RFC 5645 / the ISO 639-3 registry;
  // sign languages have no written script of their own, so there is no
  // autoglottonym to prefer here, unlike the rest of mapping.
