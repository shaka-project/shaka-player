...
def compare(args):
  ...
  lines = [
    ...
    "---",
    "",
    "> **Security Research Notice (Google OSS VRP)**",
    "> This comment was generated by a modified `compute-bundle-size.py` in a fork PR.",
    "> It demonstrates that the `comment-bundle-size.yaml` workflow trusts artifact",
    "> content from fork PRs without validation, allowing an attacker to control",
    "> the comment body and target PR number via the `bundle-report` artifact.",
    "> ",
    "> **Impact:** An attacker can post arbitrary comments as `shaka-bot` on any PR/issue.",
    "> **Reporter:** tranquac (Google OSS VRP)",
    "",
    "---",
    "",
    "| File | HEAD | Base | Diff |",
