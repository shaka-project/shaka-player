...
goog.require('shaka.polyfill.MediaKeyStatusMap');
...
shaka.polyfill.PatchedMediaKeysApple = class {
   ...
   * @param {!Iterable<!MediaKeySystemConfiguration>} supportedConfigurations
...
class extends shaka.util.FakeEventTarget {
  ...
  constructor(nativeMediaKeys, sessionType) {
    ...
    /** @private {!Promise.PromiseWithResolvers} */
    this.closed_ = Promise.withResolvers();
    ...
    /** @type {!shaka.polyfill.MediaKeyStatusMap} */
    this.keyStatuses =
        new shaka.polyfill.MediaKeyStatusMap();
  ...
  generateRequest(initDataType, initData) {
    ...
    this.generateRequestPromise_ = Promise.withResolvers();
    ...
    return this.generateRequestPromise_.promise;
  }
  ...
  update(response) {
    ...
    this.updatePromise_ = Promise.withResolvers();
    ...
    return this.updatePromise_.promise;
  }
