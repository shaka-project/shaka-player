...
shaka.polyfill.PatchedMediaKeysApple = class {
  ...
  static install() {
    ...
    */
    ...
    PatchedMediaKeysApple.MediaKeyStatusMap.KEY_ID_ =
        shaka.util.Uint8ArrayUtils.toArrayBuffer(new Uint8Array([0]));
  ...
  static onWebkitNeedKey_(event) {
    ...
    event2.initData = shaka.util.Uint8ArrayUtils.toArrayBuffer(event.initData);
      ...
      class extends shaka.util.FakeEventTarget {
        ...
        onWebkitKeyMessage_(event) {
          ...
          const event2 = new shaka.util.FakeEvent('message', {
            ...
            message: shaka.util.Uint8ArrayUtils.toArrayBuffer(event.message),
          });
