...
goog.require('shaka.polyfill.PatchedMediaKeysSafari');
...
shaka.polyfill.MediaKeys.install = function() {
  ...
  if (navigator.requestMediaKeySystemAccess &&
    ...
    // Safari's WebKit-prefixed EME is not v0.1b as seen on old chromium-based
    // platforms.
    shaka.log.info('Using Safari\'s webkit-prefixed EME');
    shaka.polyfill.PatchedMediaKeysSafari.install();
