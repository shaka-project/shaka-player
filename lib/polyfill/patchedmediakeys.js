...
goog.provide('shaka.polyfill.PatchedMediaKeys');
 ...
 */
shaka.polyfill.PatchedMediaKeys.install = function() {
  shaka.log.debug('PatchedMediaKeys.install');

  goog.asserts.assert(HTMLMediaElement.prototype.generateKeyRequest,
                      'PatchedMediaKeys APIs not available!');

  // Alias.
  var PatchedMediaKeys = shaka.polyfill.PatchedMediaKeys;
  ...
  PatchedMediaKeys.MediaKeyStatusMap.KEY_ID_ =
      (new Uint8Array([0])).buffer;

  // Install patches.
  navigator.requestMediaKeySystemAccess =
      PatchedMediaKeys.requestMediaKeySystemAccess;
  ...
  HTMLMediaElement.prototype.setMediaKeys = PatchedMediaKeys.setMediaKeys;
  window.MediaKeys = PatchedMediaKeys.MediaKeys;
  window.MediaKeySystemAccess = PatchedMediaKeys.MediaKeySystemAccess;
};
 ...
 */
shaka.polyfill.PatchedMediaKeys.requestMediaKeySystemAccess =
    function(keySystem, supportedConfigurations) {
  shaka.log.debug('PatchedMediaKeys.requestMediaKeySystemAccess');
  ...
  var PatchedMediaKeys = shaka.polyfill.PatchedMediaKeys;
  try {
    var access = new PatchedMediaKeys.MediaKeySystemAccess(
 ...
 * @return {!Promise}
 */
shaka.polyfill.PatchedMediaKeys.setMediaKeys = function(mediaKeys) {
  shaka.log.debug('PatchedMediaKeys.setMediaKeys');
  ...
  var newMediaKeys =
      /** @type {shaka.polyfill.PatchedMediaKeys.MediaKeys} */ (
          mediaKeys);
  var oldMediaKeys =
      /** @type {shaka.polyfill.PatchedMediaKeys.MediaKeys} */ (
          this.mediaKeys);
  ...
  if (oldMediaKeys && oldMediaKeys != newMediaKeys) {
    goog.asserts.assert(
        oldMediaKeys instanceof PatchedMediaKeys.MediaKeys,
  ...
  if (newMediaKeys) {
    goog.asserts.assert(
        newMediaKeys instanceof PatchedMediaKeys.MediaKeys,
 ...
 * @private
 */
shaka.polyfill.PatchedMediaKeys.getVideoElement_ = function() {
 ...
 */
shaka.polyfill.PatchedMediaKeys.MediaKeySystemAccess =
    function(keySystem, supportedConfigurations) {
  shaka.log.debug('PatchedMediaKeys.MediaKeySystemAccess');
  ...
  var success = false;
  var tmpVideo = shaka.polyfill.PatchedMediaKeys.getVideoElement_();
...
/** @override */
shaka.polyfill.PatchedMediaKeys.MediaKeySystemAccess.prototype.
    createMediaKeys = function() {
  shaka.log.debug(
      'PatchedMediaKeys.MediaKeySystemAccess.createMediaKeys');

  // Alias.
  var PatchedMediaKeys = shaka.polyfill.PatchedMediaKeys;
  var mediaKeys = new PatchedMediaKeys.MediaKeys(this.internalKeySystem_);
...
shaka.polyfill.PatchedMediaKeys.MediaKeySystemAccess.prototype.
  ...
  shaka.log.debug(
      'PatchedMediaKeys.MediaKeySystemAccess.getConfiguration');
 ...
 */
shaka.polyfill.PatchedMediaKeys.MediaKeys = function(keySystem) {
  shaka.log.debug('PatchedMediaKeys.MediaKeys');
  ...
  /**
   * @private {!Array.<!shaka.polyfill.PatchedMediaKeys.MediaKeySession>}
   */
  this.newSessions_ = [];

  /**
   * @private {!Object.<string,
   *                    !shaka.polyfill.PatchedMediaKeys.MediaKeySession>}
   */
  this.sessionMap_ = {};
};
 ...
 * @protected
 */
shaka.polyfill.PatchedMediaKeys.MediaKeys.prototype.setMedia =
    function(media) {
  this.media_ = media;
  ...
  if (media) {
    ...
    this.eventManager_.listen(media, 'needkey',
        /** @type {shaka.util.EventManager.ListenerType} */ (
            this.onNeedKey_.bind(this)));

    this.eventManager_.listen(media, 'keymessage',
        /** @type {shaka.util.EventManager.ListenerType} */ (
            this.onKeyMessage_.bind(this)));

    this.eventManager_.listen(media, 'keyadded',
        /** @type {shaka.util.EventManager.ListenerType} */ (
            this.onKeyAdded_.bind(this)));

    this.eventManager_.listen(media, 'keyerror',
        /** @type {shaka.util.EventManager.ListenerType} */ (
            this.onKeyError_.bind(this)));
  }
};


/** @override */
shaka.polyfill.PatchedMediaKeys.MediaKeys.prototype.createSession =
    function(opt_sessionType) {
  shaka.log.debug('PatchedMediaKeys.MediaKeys.createSession');
  ...
  var session = new PatchedMediaKeys.MediaKeySession(
...
/** @override */
shaka.polyfill.PatchedMediaKeys.MediaKeys.prototype.setServerCertificate =
    function(serverCertificate) {
  shaka.log.debug('PatchedMediaKeys.MediaKeys.setServerCertificate');
 ...
 * @private
 */
shaka.polyfill.PatchedMediaKeys.MediaKeys.prototype.onNeedKey_ =
    function(event) {
  shaka.log.debug('PatchedMediaKeys.onNeedKey_', event);
  goog.asserts.assert(this.media_, 'media_ not set in onNeedKey_');
 ...
 * @private
 */
shaka.polyfill.PatchedMediaKeys.MediaKeys.prototype.onKeyMessage_ =
    function(event) {
  shaka.log.debug('PatchedMediaKeys.onKeyMessage_', event);
 ...
 * @private
 */
shaka.polyfill.PatchedMediaKeys.MediaKeys.prototype.onKeyAdded_ =
    function(event) {
  shaka.log.debug('PatchedMediaKeys.onKeyAdded_', event);

  var session = this.findSession_(event.sessionId);
  goog.asserts.assert(session, 'unable to find session in onKeyAdded_');
  if (session) {
    session.ready();
  }
};
 ...
 * @private
 */
shaka.polyfill.PatchedMediaKeys.MediaKeys.prototype.onKeyError_ =
    function(event) {
  shaka.log.debug('PatchedMediaKeys.onKeyError_', event);

  var session = this.findSession_(event.sessionId);
  goog.asserts.assert(session, 'unable to find session in onKeyError_');
  if (session) {
 ...
 * @return {shaka.polyfill.PatchedMediaKeys.MediaKeySession}
 * @private
 */
shaka.polyfill.PatchedMediaKeys.MediaKeys.prototype.findSession_ =
    function(sessionId) {
  var session = this.sessionMap_[sessionId];
  if (session) {
    shaka.log.debug('PatchedMediaKeys.MediaKeys.findSession_', session);
    return session;
  }
...
shaka.polyfill.PatchedMediaKeys.MediaKeySession =
  ...
  shaka.log.debug('PatchedMediaKeys.MediaKeySession');
  ...
  this.keyStatuses =
      new shaka.polyfill.PatchedMediaKeys.MediaKeyStatusMap();
};
goog.inherits(shaka.polyfill.PatchedMediaKeys.MediaKeySession,
 ...
 * @protected
 */
shaka.polyfill.PatchedMediaKeys.MediaKeySession.prototype.generated =
    function() {
  shaka.log.debug('PatchedMediaKeys.MediaKeySession.generated');
 ...
 * @protected
 */
shaka.polyfill.PatchedMediaKeys.MediaKeySession.prototype.ready =
    function() {
  shaka.log.debug('PatchedMediaKeys.MediaKeySession.ready');
 ...
 * @param {!MediaKeyEvent} event
 */
shaka.polyfill.PatchedMediaKeys.MediaKeySession.prototype.handleError =
    function(event) {
  shaka.log.debug('PatchedMediaKeys.MediaKeySession.handleError', event);
 ...
 * are ultimately implemented with generateKeyRequest in prefixed EME.
 *
 ...
 * @private
 */
shaka.polyfill.PatchedMediaKeys.MediaKeySession.prototype.generate_ =
  ...
  try {
    this.media_.generateKeyRequest(this.keySystem_, mangledInitData);
  } catch (exception) {
 ...
 * @private
 */
shaka.polyfill.PatchedMediaKeys.MediaKeySession.prototype.update_ =
  ...
  try {
    this.media_.addKey(this.keySystem_, key, keyId, this.sessionId);
  } catch (exception) {
    // Reject the promise.
 ...
 * @private
 */
shaka.polyfill.PatchedMediaKeys.MediaKeySession.prototype.
...
shaka.polyfill.PatchedMediaKeys.MediaKeySession.prototype.
  ...
  shaka.log.debug('PatchedMediaKeys.MediaKeySession.generateRequest');
  return this.generate_(initData, null);
};


/** @override */
shaka.polyfill.PatchedMediaKeys.MediaKeySession.prototype.load =
    function(sessionId) {
  shaka.log.debug('PatchedMediaKeys.MediaKeySession.load');
  if (this.type_ == 'persistent-license') {
...
/** @override */
shaka.polyfill.PatchedMediaKeys.MediaKeySession.prototype.update =
    function(response) {
  shaka.log.debug('PatchedMediaKeys.MediaKeySession.update', response);
...
/** @override */
shaka.polyfill.PatchedMediaKeys.MediaKeySession.prototype.close =
    function() {
  shaka.log.debug('PatchedMediaKeys.MediaKeySession.close');
  ...
  if (this.type_ != 'persistent-license') {
    ...
    // should not throw.
    try {
      this.media_.cancelKeyRequest(this.keySystem_, this.sessionId);
    } catch (exception) {}
  }
...
/** @override */
shaka.polyfill.PatchedMediaKeys.MediaKeySession.prototype.remove =
    function() {
  shaka.log.debug('PatchedMediaKeys.MediaKeySession.remove');
 ...
 */
shaka.polyfill.PatchedMediaKeys.MediaKeyStatusMap = function() {
  /**
   * @type {number}
   */
  this.size = 0;
 ...
 * @private
 */
shaka.polyfill.PatchedMediaKeys.MediaKeyStatusMap.KEY_ID_;
 ...
 */
shaka.polyfill.PatchedMediaKeys.MediaKeyStatusMap.prototype.setStatus =
    function(status) {
 ...
 */
shaka.polyfill.PatchedMediaKeys.MediaKeyStatusMap.prototype.getStatus =
    function() {
  return this.status_;
};
...
/** @override */
shaka.polyfill.PatchedMediaKeys.MediaKeyStatusMap.prototype.forEach =
    function(fn) {
  if (this.status_) {
    var fakeKeyId =
        shaka.polyfill.PatchedMediaKeys.MediaKeyStatusMap.KEY_ID_;
...
/** @override */
shaka.polyfill.PatchedMediaKeys.MediaKeyStatusMap.prototype.get =
    function(keyId) {
  if (this.has(keyId)) {
    return this.status_;
  }
...
/** @override */
shaka.polyfill.PatchedMediaKeys.MediaKeyStatusMap.prototype.has =
    function(keyId) {
  var fakeKeyId =
      shaka.polyfill.PatchedMediaKeys.MediaKeyStatusMap.KEY_ID_;
  if (this.status_ &&
...
shaka.polyfill.PatchedMediaKeys.MediaKeyStatusMap.prototype.
    entries = function() {
