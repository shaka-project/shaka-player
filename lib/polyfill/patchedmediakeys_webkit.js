...
shaka.polyfill.PatchedMediaKeysWebkit.install = function(prefix) {
  ...
  var prefixApi = PatchedMediaKeysWebkit.prefixApi;
...
shaka.polyfill.PatchedMediaKeysWebkit.prefixApi = function(api) {
  var prefix = shaka.polyfill.PatchedMediaKeysWebkit.Prefix;
  if (prefix) {
...
shaka.polyfill.PatchedMediaKeysWebkit.MediaKeySession.prototype.generate_ =
  ...
  try {
    this.media_[prefixedApi](this.keySystem_, mangledInitData);
  } catch (exception) {
...
shaka.polyfill.PatchedMediaKeysWebkit.MediaKeySession.prototype.update_ =
  ...
  try {
    this.media_[prefixedApi](this.keySystem_, key, keyId, this.sessionId);
  } catch (exception) {
    // Reject the promise.
...
shaka.polyfill.PatchedMediaKeysWebkit.MediaKeySession.prototype.close =
  ...
  if (this.type_ != 'persistent-license') {
    ...
    try {
      this.media_[prefixedApi](this.keySystem_, this.sessionId);
    } catch (exception) {}
  }
