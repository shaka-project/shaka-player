...
<<<<<<< HEAD:lib/net/http_xhr_plugin.js
 ...
 * @export
 */
shaka.net.HttpPlugin = function(uri, request, requestType) {
  var xhr = new shaka.net.HttpPlugin.xhr_();
>>>>>>> Update signatures of other networking scheme plugins.:lib/net/http_plugin.js
