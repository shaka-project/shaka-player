...
goog.provide('shaka.msf.draft14.ControlStream');
goog.provide('shaka.msf.draft14.ControlStreamDecoder');
goog.provide('shaka.msf.draft14.ControlStreamEncoder');
...
/**
 * @implements {shaka.extern.MsfControlStream}
 */
shaka.msf.draft14.ControlStream = class {
  /**
  ...
  constructor(reader, writer, codec) {
    /** @private {!shaka.msf.draft14.ControlStreamDecoder} */
    this.decoder_ = new shaka.msf.draft14.ControlStreamDecoder(reader);
    /** @private {!shaka.msf.draft14.ControlStreamEncoder} */
    this.encoder_ =
        new shaka.msf.draft14.ControlStreamEncoder(writer, codec);
...
shaka.msf.draft14.ControlStreamDecoder = class {
  /**
   * @param {!shaka.msf.Reader} reader
   */
  constructor(reader) {
...
shaka.msf.draft14.ControlStreamEncoder = class {
  /**
   * @param {!shaka.msf.Writer} writer
   * @param {!shaka.extern.MsfCodec} codec
   */
  ...
  async message(msg) {
    ...
    const writer = new shaka.msf.draft14.MessageWriter(this.codec_);
