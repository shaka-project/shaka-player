...
shaka.metadata.IlstUtils = class {
    ...
    new shaka.util.Mp4Parser()
        ...
        .box('ilst', (box) => {
          while (box.reader.hasMoreData()) {
            ...
            const frame = (type === '----') ?
                shaka.metadata.IlstUtils.parseFreeform_(payload) :
                shaka.metadata.IlstUtils.parseStandard_(type, payload);
  ...
  static parseFreeform_(data) {
    ...
    new shaka.util.Mp4Parser()
        ...
        .fullBox('data', (box) => {
          value = shaka.metadata.IlstUtils.parseDataBox_(box);
        })
        .parse(data);
  ...
  static parseStandard_(key, data) {
    ...
    new shaka.util.Mp4Parser()
        .fullBox('data', (box) => {
          const parsed = shaka.metadata.IlstUtils.parseDataBox_(box, key);
