...
shaka.lcevc.Dec = class {
  ...
  create_() {
    ...
    console.log('LCEVCdec create_ called');
    if (this.isSupported_() && !this.dec_) {
      // eslint-disable-next-line no-console
      console.log('LCEVCdec isSupported check passed');
      // eslint-disable-next-line no-console
      console.log('LCEVCdec checking webGLSupport',
          this.canvas_,
          this.canvas_.getContext('webgl'),
          this.canvas_.getContext('experimental-webgl'),
          !!window.WebGLRenderingContext,
          this.lcevcLib_.SupportObject.webGLSupport(this.canvas_));
      if (this.lcevcLib_.SupportObject.webGLSupport(this.canvas_)) {
        // eslint-disable-next-line no-console
        console.log('LCEVCdec webGLSupport true');
        ...
        // eslint-disable-next-line no-console
        console.log('LCEVCdec deprecated check', this.toBeDeprecated_);
        if (this.toBeDeprecated_) {
          ...
          // eslint-disable-next-line no-console
          console.log('Creating an LCEVCdec instance');
          this.dec_ = new this.lcevcLib_.LCEVCdec(
              this.media_,
              this.canvas_,
              this.decConfig_);
          // eslint-disable-next-line no-console
          console.log('LCEVCdec instance created successfully');
        }
      }
    }
  }
  ...
  isSupported_() {
    ...
    // eslint-disable-next-line no-console
    console.log('LCEVC isSupported check',
        typeof this.lcevcLib_ !== 'undefined',
