  ...
  async initializeMediaSourceEngineInner_() {
    ...
    const mediaSourceEngine = this.createMediaSourceEngine(
        ...
        this.textDisplayer_,
        {
          ...
          onMediaSourceReset: (time) => {
            this.streamingEngine_?.notifyOfMediaSourceReset(time);
            if (this.playhead_ instanceof
                shaka.media.MediaSourcePlayhead) {
              this.playhead_.notifyOfMediaSourceReset(time);
            }
          },
          onMediaSourceResetEnd: () => {
            this.streamingEngine_?.notifyOfMediaSourceResetEnd();
            if (this.playhead_ instanceof
                shaka.media.MediaSourcePlayhead) {
              this.playhead_.notifyOfMediaSourceResetEnd();
            }
          },
        },
        this.lcevcDec_,
