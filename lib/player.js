...
shaka.Player = class extends shaka.util.FakeEventTarget {
   ...
   *
   * @return {?Array<shaka.extern.MetadataTimelineRegionInfo> | undefined}
   * @export
   */
   ...
   *
   * @return {?Array<shaka.extern.EmsgTimelineRegionInfo> | undefined}
   * @export
   */
  getAllEmsgRegions() {
   ...
   *
   * @return {?Array<shaka.extern.TimelineRegionInfo> | undefined}
   * @export
   */
