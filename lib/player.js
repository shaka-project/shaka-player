...
shaka.Player = class extends shaka.util.FakeEventTarget {
  ...
  async onLoad_(has, wants) {
    ...
    // const abrFactory = this.config_.streaming.harmonicLowLatencyABR ?
    //   () => new shaka.abr.SimpleLLAbrManager() :
    //   this.config_.abrFactory;
    ...
    if (this.config_.streaming.lowLatencyMode &&
        this.config_.streaming.harmonicLowLatencyABR) {
