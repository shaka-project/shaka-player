 ...
 * @description Fired when playback crosses a discontinuity that introduces a
 *   new PROGRAM-DATE-TIME base (e.g. server-side ad insertion or a live
 *   restart).  Only fired for MSE playback.
 * @property {string} type
 *   'timelinechange'
