...
shaka.Player = class extends shaka.util.FakeEventTarget {
  ...
  async srcEqualsInner_(startTimeOfLoad, mimeType) {
    ...
    let timerId;
    mediaElement.textTracks.addEventListener('addtrack', () => {
    ...
    const waitForNativeTracks = () => {
      return new Promise((resolve) => {
        ...
        this.loadEventManager_.listen(mediaElement.textTracks,
            'addtrack', () => timer.tickAfter(GRACE_PERIOD));
        // Do the same for audioTracks.
        this.loadEventManager_.listen(mediaElement.audioTracks,
            'addtrack', () => timer.tickAfter(GRACE_PERIOD));
