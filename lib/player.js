    ...
    try {
      ...
      if (shouldUseSrcEquals) {
        ...
        if (!this.abrManager_ || this.abrManagerFactory_ != abrFactory) {
          ...
          if (typeof this.abrManager_.getVariants != 'function') {
            shaka.Deprecate.deprecateFeature(5,
                'AbrManager w/o getVariants',
                'Please use an AbrManager with getVariants function.');
            this.abrManager_.getVariants = () => {
              return [];
            };
          }
  ...
  chooseVariant_(initialSelection = false) {
    if (this.updateAbrManagerVariants_()) {
      if (this.config_.abr.enabled) {
        ...
        const variants = this.abrManager_.getVariants();
        if (variants.length) {
