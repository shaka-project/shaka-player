...
shaka.Player = class extends shaka.util.FakeEventTarget {
  ...
  async onInitializeParser_(has, wants) {
    ...
    // request.
    this.cmcdManager_ = this.createCmcd(has.mimeType);
  ...
  onParseManifest_(has, wants) {
    ...
    const playerInterface = {
      ...
      modifyRequest: (request) => this.cmcdManager_.applyManifestData(request),
  ...
  createCmcd(mimeType) {
    ...
    return new shaka.cmcd.CmcdManager(playerInterface, mimeType);
  }
