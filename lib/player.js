...
shaka.Player = class extends shaka.util.FakeEventTarget {
  ...
  configure(config, value) {
    ...
    if (config['streaming'] &&
      ...
      const min = config['streaming']['liveSyncMinLatency'] ||
          defaultConfig['streaming']['liveSyncMinLatency'];
      const max = config['streaming']['liveSyncMaxLatency'] ||
          defaultConfig['streaming']['liveSyncMaxLatency'];
    ...
    const ret = shaka.util.PlayerConfiguration.mergeConfigObjects(
        this.config_, config, defaultConfig);
  ...
  onTimeUpdate_() {
    ...
    if (this.config_.streaming.liveSync) {
      if ('liveSyncTargetLatency' in this.config_.streaming) {
