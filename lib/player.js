...
shaka.Player = class extends shaka.util.FakeEventTarget {
   ...
   *    video will be drawn.
   * @param {?LcevcDil.LcevcDilConfig | undefined} [lcevcDilConfig] LCEVC DIL
   * Configuration
   */
  constructor(mediaElement, dependencyInjector, canvas, lcevcDilConfig) {
    ...
    // This is the LCEVC DIl configuration object.
    /** @private {?LcevcDil.LcevcDilConfig | undefined} */
  ...
  load(assetUri, startTime, mimeType) {
    ...
    return new Promise((resolve, reject) => {
      ...
      events.onEnd = () => {
        resolve();
        this.lcevcDil_ && this.lcevcDil_.updateVariant(this.getVariantTracks());
  ...
  onAdaptation_(from, to) {
    ...
    const data = new Map()
        ...
        .set('newTrack', to);
    if (this.lcevcDil_) {
      this.lcevcDil_.updateVariant(this.getVariantTracks());
    }
    const event =
