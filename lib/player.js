...
shaka.Player = class extends shaka.util.FakeEventTarget {
   ...
   *
   * @return {?Iterable<shaka.extern.MetadataTimelineRegionInfo> | undefined}
   * @export
   */
   ...
   *
   * @return {?Iterable<shaka.extern.EmsgTimelineRegionInfo> | undefined}
   * @export
   */
  getAllEmsgRegions() {
   ...
   *
   * @return {?Iterable<shaka.extern.TimelineRegionInfo> | undefined}
   * @export
   */
