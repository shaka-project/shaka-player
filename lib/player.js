...
/**
 * Get the current effective playback rate. When trick play is enabled, this
 * will return the trick play rate. When trick play is disabled, this will
 * return the media element playback rate.
 *
