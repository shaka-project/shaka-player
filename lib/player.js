    ...
    config.streaming.failureCallback = (error) => {
      ...
      if (this.config_.autoRetryOnLiveHttpError == null) {
        shaka.Deprecate.deprecateFeature(5,
          ...
          'Auto retry in StreamingConfiguration.failureCallback is ' +
          'deprecated and will move to earlier stages. Please migrate to ' +
          '"PlayerConfiguration.autoRetryOnLiveHttpError = true|false".');
