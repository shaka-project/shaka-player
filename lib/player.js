...
shaka.Player = class extends shaka.util.FakeEventTarget {
  ...
  /**
   * Can be used to update the stream startTime in the
   * <code>manifestparsed</code> event handler using
  ...
  async onLoad_(has, wants) {
    ...
    // If setStartTime has been called since load() was invoked use the
    // requested startTime
    if (this.startTime_ != null) {
      has.startTime = this.startTime_;
      this.startTime_ = null;
    }
