...
shaka.Player.prototype.chooseStreams_ = function(manifest, period) {
  ...
  // unless it's CEA closed captions.
  const hasClosedCaptions = chosenVariant && chosenVariant.video &&
      chosenVariant.video.closedCaptions &&
      chosenVariant.video.closedCaptions.size > 0;
  if (this.streamText_() || hasClosedCaptions) {
