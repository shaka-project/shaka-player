...
shaka.Player = class extends shaka.util.FakeEventTarget {
  ...
  configure(config, value) {
    ...
    // Deprecate 'streaming.liveSync' configuration.
    if (config['streaming'] && 'liveSync' in config['streaming']) {
      shaka.Deprecate.deprecateFeature(5,
          'streaming.liveSync',
          'Please Use streaming.liveSync.enabled instead.');
      config['streaming']['liveSync']['enabled'] =
          config['streaming']['liveSync'];
      delete config['streaming']['liveSync'];
    }
    ...
    if (config['streaming'] && 'liveSyncPlaybackRate' in config['streaming']) {
      shaka.Deprecate.deprecateFeature(5,
          ...
          'Please Use streaming.liveSync.playbackRate instead.');
      config['streaming']['liveSync']['playbackRate'] =
  ...
  onTimeUpdate_() {
    ...
    if (this.config_.streaming.liveSync &&
      ...
      maxPlaybackRate = this.config_.streaming.liveSync.playbackRate;
      ...
      if (this.manifest_ && this.manifest_.serviceDescription) {
        ...
        maxPlaybackRate =
          ...
          this.config_.streaming.liveSync.playbackRate;
        minPlaybackRate =
