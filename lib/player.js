...
shaka.Player.prototype.getStats = function() {
  ...
  return {
    ...
    switchHistory: /** @type {!Array.<shakaExtern.StreamChoice>} */(
        JSON.parse(JSON.stringify(this.stats_.switchHistory))),
    stateHistory: /** @type {!Array.<shakaExtern.StateChange>} */(
        JSON.parse(JSON.stringify(this.stats_.stateHistory)))
  };
};
