 ...
 * @description Fired before a segment is appended to the media element. Provides segment data.
 * @property {string} type
 *   'bufferappending'
 ...
 *   Indicates if the segment is an init segment. Useful for prepending to data for decoding.
 * @exportDoc
 */
