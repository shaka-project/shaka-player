...
goog.require('shaka.media.QualityTimeline');
...
shaka.Player = class extends shaka.util.FakeEventTarget {
  ...
  constructor(mediaElement, dependencyInjector) {
    ...
    /** @private {shaka.media.QualityTimeline} */
    this.qualityTimeline_ = null;
  ...
  onParseManifest_(has, wants) {
    ...
    this.qualityTimeline_ = new shaka.media.QualityTimeline();
    this.qualityTimeline_.setListeners((mediaQualityInfo) => {
  ...
  createPlayheadObserversForMSE_() {
    ...
    goog.asserts.assert(this.qualityTimeline_, 'Must have quality timeline');
    ...
    manager.manage(this.qualityTimeline_);
    return manager;
  }
    ...
    const playerInterface = {
      ...
      onInitSegmentAppended: (position, initSegment) => {
        if (initSegment.mediaQuality) {
          this.qualityTimeline_.addMediaQualityChange(
...
shaka.Player.EventName = {
  ...
  MediaQualityChanged: 'mediaqalitychanged',
};
