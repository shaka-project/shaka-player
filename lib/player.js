...
shaka.Player = class extends shaka.util.FakeEventTarget {
  ...
  async load(assetUri, startTime = null, mimeType) {
    ...
    try {
      ...
      const detectInterruption = () => {
        // TODO: &&& also test to see if this solves #2894
  ...
  async guessMimeType_() {
    ...
    if (shaka.Player.SRC_EQUAL_EXTENSIONS_TO_MIME_TYPES_[extension]) {
      return shaka.Player.SRC_EQUAL_EXTENSIONS_TO_MIME_TYPES_[extension];
    }
