...
/**
 * @event shaka.Player.TimestampCorrectedEvent
 * @description Fired when the timestmapOffset is corrected
 * @property {string} type
 *  'timestampcorrected'
 * @property {string} contentType
 *   The type of content e.g. 'audio', 'video'
 * @property {number} segmentStartTime
 *   The actual base media decode time + timestampOffset
 * @property {number} referenceStartTime
 *   The expected segment start time from SegmentReference
 * @property {number} timestampDiscrepancy
 *   Difference between expected and actual media times for a segment
 * @exportDoc
 */
