  ...
  async srcEqualsInner_(startTimeOfLoad, mimeType) {
    ...
    shaka.util.MediaReadyState.waitForReadyState(mediaElement,
        ...
        async () => {
          ...
          // On Safari, setting mode='disabled' as instructed below sometimes
          // causes the browser to select the next AUTOSELECT text playlist.
          // Using mode='hidden' for tracks disabled by the browser initially
          // makes Safari skip selecting the next default track.
          // See https://github.com/shaka-project/shaka-player/issues/8255
