...
shaka.Player = class extends shaka.util.FakeEventTarget {
  ...
  /**
   * Get the expected playback rate.
   * If the video hasn't started playing, return 1 as default.
   * If the video is buffering and the playback rate gets updated, return the
   * new playback rate.
   *
   * @return {number}
   * @export
   */
  getExpectedPlaybackRate() {
 ...
 * @export
 */
shaka.Player.version = 'v2.5.11-master-uncompiled';
