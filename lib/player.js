...
shaka.Player = class extends shaka.util.FakeEventTarget {
  ...
  getTextTracks() {
    if (this.manifest_) {
      if (this.isRemotePlayback()) {
        ...
        if (this.speechToText_) {
          const speechToTextTrack = this.speechToText_.getTextTrack();
          if (speechToTextTrack) {
            tracks.push(speechToTextTrack);
          }
        }
        return tracks;
      }
  ...
  selectTextTrack(track) {
    ...
    if (this.speechToText_ && track != null) {
      isSpeechToText = track === this.speechToText_.getTextTrack();
    }
