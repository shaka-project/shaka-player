...
shaka.Player = class extends shaka.util.FakeEventTarget {
   ...
   *
   * If selectTextWithoutAudioConcern configuration is true, then preferred
   * text will automatically be shown regardless of the audio
   *
  ...
  shouldInitiallyShowText_(audioStream, textStream) {
    ...
    if (this.config_.selectTextWithoutAudioConcern) {
