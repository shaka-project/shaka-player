 ...
 * @export
 */
shaka.Player.version = 'v2.4.2-master-uncompiled';
...
shaka.Player.prototype.loadManifest_ = async function(
    assetUri, manifestParserFactory) {
  ...
  return this.parser_.start(assetUri, playerInterface);
};
...
shaka.Player.prototype.load = async function(
    assetUri, startTime = null, manifestParserFactory = undefined) {
  if (!this.video_) {
    throw new shaka.util.Error(
        shaka.util.Error.Severity.CRITICAL,
  ...
  try {
    ...
    this.manifest_ = await this.loadManifest_(assetUri, manifestParserFactory);
    ...
    await this.drmEngine_.init(
        /** @type{shaka.extern.Manifest} */ (this.manifest_),
        /* isOffline */ false);
...
shaka.Player.prototype.chooseCodecsAndFilterManifest_ = function() {
  ...
  /** @type {!Object.<string, !Array.<shaka.extern.Variant>>} */
...
shaka.Player.prototype.filterNewPeriod_ = function(period) {
  ...
  const hasAvailableVariant = variants.some(StreamUtils.isPlayable);
