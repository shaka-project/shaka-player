...
goog.require('shaka.event.DrmSessionUpdate');
goog.require('shaka.event.LicenseRenewal');
...
shaka.drm.DrmEngine = class {
  ...
  async sendLicenseRequest_(event) {
    ...
    this.playerInterface_.onEvent(new shaka.event.DrmSessionUpdate());
  ...
  async triggerRenewal_(session) {
    ...
    this.playerInterface_.onEvent(
        new shaka.event.LicenseRenewal(oldSessionMetadata, newSessionMetadata));
  }
