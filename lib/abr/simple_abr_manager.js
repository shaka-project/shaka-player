...
goog.require('shaka.abr.VideoPlaybackQualityWatcher');
...
shaka.abr.SimpleAbrManager.prototype.init = function(switchCallback, videoElem) {
  ...
  this.videoQualityEstimator_ = new shaka.abr
    .VideoPlaybackQualityWatcher(videoElem, 
      1e6, // FIXME: this is a placeholder value. 
           // we should update the currently played streams' bandwidth
           // using the `updateBandwidth` function of the VideoPlaybackQualityEstimator
           // in order to attain a valid estimate
           // TODO: player needs to maintain a map of variant stream properties 
           // contained in the buffer (like bandwidth/bitrate, etc)
      3000, // sampling period (ms)
      this.onVideoPlaybackQualityWatcherUpdate_.bind(this));
};
...
shaka.abr.SimpleAbrManager.prototype
  .onVideoPlaybackQualityWatcherUpdate_ = function(info) {
