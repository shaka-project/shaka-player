  ...
  chooseVariant() {
    ...
    if (maxHeight != Infinity || maxWidth != Infinity) {
      ...
      for (const resolution of resolutions) {
        // This is strange but has a good reason.
        // Using Sintel 4K asset
        // Resolutions: 256x110, 426x182, 640x272, 864x364, 1024x436, 1280x546,
        //              1920x818, 2560x1090, 3840x1636.
        // Example 1: Using restrictToScreenSize on a MacBook Pro 14" (2023)
        // Previous: maxWidth = 1964 and maxHeight = 3024
        // After: maxWidth = 3840 and maxHeight = 1636
        // Example 2: Using restrictToScreenSize with a HD ready screen
        // Previous maxWidth = 1366 and maxHeight = 768
        // After: maxWidth = 1920  and maxHeight = 818
        // The first if allows us to select a superior quality that only meet
        // one of the conditions, but we continue searching for one that is
        // superior in case it exists if the second if is not met, which stops
        // searching in case the quality is already superior in both conditions.
