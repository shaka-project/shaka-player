...
shaka.abr.SimpleAbrManager = class {
  ...
  chooseVariant(preferFastSwitching = false) {
    ...
    if (maxHeight != Infinity || maxWidth != Infinity) {
      ...
      console.log(`[APPLE, SimpleAbrManager]: maxResolution: ${maxWidth}x${maxHeight}`);
  ...
  setVariants(variants) {
    ...
    console.log(`[APPLE, SimpleAbrManager]: setVariants:`);
    for (const v of variants) {
      console.log(`[APPLE, SimpleAbrManager]: Variant: ${shaka.util.StreamUtils.getVariantSummaryString(v)}`);
    }
