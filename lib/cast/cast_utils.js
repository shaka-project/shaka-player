...
shaka.cast.CastUtils.PlayerGetterMethods = {
  ...
  // TODO(vaage): Remove comment below when |getManifestUri| is removed from the
  //              player interface in v2.6.
  // Note that the 'getManifestUri' property is not proxied as we should use
  // |getAssetUri| instead.
  'getPlaybackRate': 2,
  'getTextLanguages': 2,
