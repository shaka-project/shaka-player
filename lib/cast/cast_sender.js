...
shaka.cast.CastSender = class {
   ...
   * @param {boolean} androidReceiverCompatible Indicates if the app is compatible with an Android Receiver.
   */
  constructor(receiverAppId, onStatusChanged, onFirstCastStateUpdate,
      onRemoteEvent, onResumeLocal, onInitStateRequired, androidReceiverCompatible) {
    /** @private {string} */
  ...
  init() {
    ...
    const sessionRequest = new chrome.cast.SessionRequest(this.receiverAppId_, null, null, this.androidReceiverCompatible_, null);
