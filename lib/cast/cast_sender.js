...
shaka.cast.CastSender = class {
  ...
  constructor(receiverAppId, onStatusChanged, onFirstCastStateUpdate,
    ...
    this.__onGCastApiAvailable_ = null;
  ...
  init() {
    ...
    if (!window.chrome || !chrome.cast || !chrome.cast.isAvailable) {
      ...
      // save to restore
      this.__onGCastApiAvailable_ = window.__onGCastApiAvailable || null;
      window.__onGCastApiAvailable = (av) => this.onGCastApiAvailable_(av);
      return;
    }
  ...
  onGCastApiAvailable_(available) {
    // restore from saved
    if (this.__onGCastApiAvailable_) {
      window.__onGCastApiAvailable = this.__onGCastApiAvailable_;
    } else {
