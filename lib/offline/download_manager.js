...
shaka.offline.DownloadManager = function(netEngine, retryParams, config) {
  /** @private {!Array.<shaka.offline.DownloadManager.Segment>} */
  this.segments_ = [];
...
shaka.offline.DownloadManager.prototype.download = function(manifest) {
  ...
  // TODO(modmaker): Download different stream types in parallel.
  ...
  return (this.promise_ = downloadNext());
};
