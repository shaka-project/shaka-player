...
shaka.offline.Storage.prototype.removeByUrl_ = function(offlineUri) {
  ...
  return this.initIfNeeded_().then(() => {
    ...
    return this.removeManifest_(offlineUri, uri.key(), manifestDb);
  });
};
...
shaka.offline.Storage.prototype.removeManifest_ = function(
  ...
  var content = shaka.offline.OfflineUtils.createStoredContentFromManifestDB(
...
shaka.offline.Storage.prototype.list = function() {
  ...
  return this.initIfNeeded_().then(() => {
    ...
    return this.storageEngine_.forEachManifest((id, manifestDB) => {
      let uri = shaka.offline.OfflineUri.manifest(id);
      let content = OfflineUtils.createStoredContentFromManifestDB(
          uri.toString(), manifestDB);
