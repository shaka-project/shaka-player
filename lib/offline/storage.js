...
shaka.offline.Storage.prototype.store = function(
  ...
  return this.initIfNeeded_()
      .then(function() {
        ...
        return this.loadInternal(
          ...
          function(data) {
            ...
            this.manifestId_ = this.storageEngine_.reserveManifestId();
            this.duration_ = 0;
            manifestDb =
      ...
      .then(function() {
        return shaka.offline.OfflineUtils.createStoredContent(manifestDb);
      }.bind(this))
      .catch(function(err) {
...
shaka.offline.Storage.prototype.list = function() {
  ...
  return this.initIfNeeded_()
      .then(function() {
        this.checkDestroyed_();
        return this.storageEngine_.forEachManifest(function(manifest) {
          storedContents.push(OfflineUtils.createStoredContent(manifest));
        });
      }.bind(this))
...
shaka.offline.Storage.prototype.initIfNeeded_ = function() {
  ...
  /** @type {?shakaExtern.OfflineConfiguration} */
  ...
  return shaka.offline.StorageEngineFactory.createStorageEngine()
      .then(function(storageEngine) {
        ...
        goog.asserts.assert(config, 'Need valid config.');
...
shaka.offline.Storage.prototype.createStream_ = function(
  ...
  if (stream.initSegmentReference) {
    var id = this.storageEngine_.reserveSegmentId();
    initUri = shaka.offline.OfflineScheme.segmentIdToUri(id);
