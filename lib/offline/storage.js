...
shaka.offline.Storage = class {
  ...
  async filterManifest_(manifest, drmEngine, config) {
    ...
    const codecSwitchingStrategy = config.mediaSource.codecSwitchingStrategy;
    const trackComparator = config.mediaSource.trackComparator;
    ...
    shaka.util.StreamUtils.chooseCodecsAndFilterManifest(
        ...
        codecSwitchingStrategy, trackComparator);
