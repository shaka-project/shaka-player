 ...
 * @private
 */
shaka.offline.Storage.prototype.filterManifest_ = async function(
    manifest, drmEngine) {
...
shaka.offline.Storage.prototype.parseManifest = async function(
  ...
  try {
    ...
    const streams = shaka.offline.Storage.getAllStreamsFromManifest_(manifest);
...
shaka.offline.Storage.prototype.createOfflineManifest_ = function(
  ...
  let usePersistentLicense = this.config_.offline.usePersistentLicense;
 ...
 * @private
 */
shaka.offline.Storage.getAllStreamsFromManifest_ = function(manifest) {
 ...
 * @private
 */
shaka.offline.Storage.getAllStreamsFromPeriod_ = function(period) {
  /** @type {!Set.<shaka.extern.Stream>} */
  const set = new Set();
