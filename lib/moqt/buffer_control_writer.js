...
goog.provide('shaka.moqt.BufferControlWriter');
 ...
 */
shaka.moqt.BufferControlWriter = class {
  /**
   ...
   * @param {shaka.moqt.Utils.Location} location
   * @private
   */
   ...
   * @param {(Array<shaka.moqt.Utils.KeyValuePair>|undefined)} pairs
   * @private
   */
   ...
   * @param {shaka.moqt.Utils.MessageTypeId} messageType
   ...
   * @param {shaka.moqt.Utils.Subscribe} msg
   * @return {!shaka.moqt.BufferControlWriter}
   */
  marshalSubscribe(msg) {
    const MessageTypeId = shaka.moqt.Utils.MessageTypeId;
    this.marshalWithLength(MessageTypeId.SUBSCRIBE, () => {
      ...
      if (msg.filterType === shaka.moqt.Utils.FilterType.ABSOLUTE_START ||
          msg.filterType === shaka.moqt.Utils.FilterType.ABSOLUTE_RANGE) {
        // Write the location
      ...
      if (msg.filterType === shaka.moqt.Utils.FilterType.ABSOLUTE_RANGE) {
        // Write the end group
        if (!msg.endGroup) {
   ...
   * @param {shaka.moqt.Utils.SubscribeOk} msg
   * @return {!shaka.moqt.BufferControlWriter}
   */
   ...
   * @param {shaka.moqt.Utils.SubscribeError} msg
   * @return {!shaka.moqt.BufferControlWriter}
   */
   ...
   * @param {shaka.moqt.Utils.SubscribeDone} msg
   * @return {!shaka.moqt.BufferControlWriter}
   */
   ...
   * @param {shaka.moqt.Utils.Announce} msg
   * @return {!shaka.moqt.BufferControlWriter}
   */
  marshalAnnounce(msg) {
    const MessageTypeId = shaka.moqt.Utils.MessageTypeId;
   ...
   * @param {shaka.moqt.Utils.AnnounceOk} msg
   * @return {!shaka.moqt.BufferControlWriter}
   */
   ...
   * @param {shaka.moqt.Utils.Unsubscribe} msg
   * @return {!shaka.moqt.BufferControlWriter}
   */
   ...
   * @param {shaka.moqt.Utils.AnnounceError} msg
   * @return {!shaka.moqt.BufferControlWriter}
   */
   ...
   * @param {shaka.moqt.Utils.Unannounce} msg
   * @return {!shaka.moqt.BufferControlWriter}
   */
   ...
   * @param {shaka.moqt.Utils.ClientSetup} msg
   * @return {!shaka.moqt.BufferControlWriter}
   */
   ...
   * @param {shaka.moqt.Utils.ServerSetup} msg
   * @return {!shaka.moqt.BufferControlWriter}
   */
