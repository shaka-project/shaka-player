...
goog.provide('shaka.moqt.ControlStream');
goog.provide('shaka.moqt.Reader');
goog.provide('shaka.moqt.Receiver');
goog.provide('shaka.moqt.Sender');
goog.provide('shaka.moqt.TracksManager');
goog.provide('shaka.moqt.Writer');

goog.require('shaka.log');
goog.require('shaka.moqt.BufferControlWriter');
goog.require('shaka.moqt.Utils');
goog.require('shaka.util.BufferUtils');
goog.require('shaka.util.StringUtils');
goog.require('shaka.util.Timer');

goog.requireType('shaka.moqt.MoqtTransport');

/**
 * Reader wraps a stream and provides convenience methods for reading
 * pieces from a stream.
 */
shaka.moqt.Reader = class {
  /**
  ...
  /**
   * @return {!Promise<!Array<shaka.moqt.Utils.KeyValuePair>>}
   */
  async keyValuePairs() {
...
shaka.moqt.Receiver = class {
  /**
   * @param {!shaka.moqt.Reader} reader
   */
  constructor(reader) {
    /** @private {!shaka.moqt.Reader} */
    this.reader_ = reader;
  }

  /**
   * @return {!Promise<shaka.moqt.Utils.ServerSetup>}
   */
  async server() {
    const SetupType = shaka.moqt.Utils.SetupType;
  ...
  /**
   * @return {!Promise<(Array<shaka.moqt.Utils.KeyValuePair> | undefined)>}
   */
  async parameters() {
...
shaka.moqt.Sender = class {
  /**
   * @param {!shaka.moqt.Writer} writer
   */
  constructor(writer) {
    /** @private {!shaka.moqt.Writer} */
    this.writer_ = writer;
  }

  /**
   * @param {shaka.moqt.Utils.ClientSetup} client
   * @return {!Promise}
   */
  async client(client) {
    ...
    const writer = new shaka.moqt.BufferControlWriter();
...
shaka.moqt.ControlStream = class {
  /**
   * @param {!shaka.moqt.Reader} reader
   * @param {!shaka.moqt.Writer} writer
   */
  constructor(reader, writer) {
    /** @private {!shaka.moqt.ControlStreamDecoder} */
    this.decoder_ = new shaka.moqt.ControlStreamDecoder(reader);
    /** @private {!shaka.moqt.ControlStreamEncoder} */
    this.encoder_ = new shaka.moqt.ControlStreamEncoder(writer);
    /** @private {!Promise} */
   ...
   *
   * @return {!Promise<shaka.moqt.Utils.Message>}
   */
  async receive() {
  ...
  /**
   * @param {shaka.moqt.Utils.Message} msg
   * @return {!Promise}
   */
  async send(msg) {
...
shaka.moqt.ControlStreamDecoder = class {
  /**
   * @param {!shaka.moqt.Reader} reader
   */
  constructor(reader) {
  ...
  /**
   * @return {!Promise<shaka.moqt.Utils.MessageType>}
   * @private
   */
  async messageType_() {
    ...
    let msgType;
    switch (type) {
      case shaka.moqt.Utils.MessageTypeId.SUBSCRIBE:
        msgType = shaka.moqt.Utils.MessageType.SUBSCRIBE;
        break;
      case shaka.moqt.Utils.MessageTypeId.SUBSCRIBE_OK:
        msgType = shaka.moqt.Utils.MessageType.SUBSCRIBE_OK;
        break;
      case shaka.moqt.Utils.MessageTypeId.SUBSCRIBE_DONE:
        msgType = shaka.moqt.Utils.MessageType.SUBSCRIBE_DONE;
        break;
      case shaka.moqt.Utils.MessageTypeId.SUBSCRIBE_ERROR:
        msgType = shaka.moqt.Utils.MessageType.SUBSCRIBE_ERROR;
        break;
      case shaka.moqt.Utils.MessageTypeId.UNSUBSCRIBE:
        msgType = shaka.moqt.Utils.MessageType.UNSUBSCRIBE;
        break;
      case shaka.moqt.Utils.MessageTypeId.ANNOUNCE:
        msgType = shaka.moqt.Utils.MessageType.ANNOUNCE;
        break;
      case shaka.moqt.Utils.MessageTypeId.ANNOUNCE_OK:
        msgType = shaka.moqt.Utils.MessageType.ANNOUNCE_OK;
        break;
      case shaka.moqt.Utils.MessageTypeId.ANNOUNCE_ERROR:
        msgType = shaka.moqt.Utils.MessageType.ANNOUNCE_ERROR;
        break;
      case shaka.moqt.Utils.MessageTypeId.UNANNOUNCE:
        msgType = shaka.moqt.Utils.MessageType.UNANNOUNCE;
        break;
      case shaka.moqt.Utils.MessageTypeId.REQUESTS_BLOCKED:
        msgType = shaka.moqt.Utils.MessageType.REQUESTS_BLOCKED;
        break;
      default:
  ...
  async message() {
    ...
    /** @type {shaka.moqt.Utils.Message} */
    let result;
    switch (type) {
      case shaka.moqt.Utils.MessageType.SUBSCRIBE:
        result = await this.subscribe_();
        break;
      case shaka.moqt.Utils.MessageType.SUBSCRIBE_OK:
        result = await this.subscribeOk_();
        break;
      case shaka.moqt.Utils.MessageType.SUBSCRIBE_ERROR:
        result = await this.subscribeError_();
        break;
      case shaka.moqt.Utils.MessageType.SUBSCRIBE_DONE:
        result = await this.subscribeDone_();
        break;
      case shaka.moqt.Utils.MessageType.UNSUBSCRIBE:
        result = await this.unsubscribe_();
        break;
      case shaka.moqt.Utils.MessageType.ANNOUNCE:
        result = await this.announce_();
        break;
      case shaka.moqt.Utils.MessageType.ANNOUNCE_OK:
        result = await this.announceOk_();
        break;
      case shaka.moqt.Utils.MessageType.ANNOUNCE_ERROR:
        result = await this.announceError_();
        break;
      case shaka.moqt.Utils.MessageType.UNANNOUNCE:
        result = await this.unannounce_();
        break;
      case shaka.moqt.Utils.MessageType.REQUESTS_BLOCKED:
  ...
  /**
   * @return {!Promise<shaka.moqt.Utils.Subscribe>}
   * @private
   */
  async subscribe_() {
    ...
    const filterType = /** @type {shaka.moqt.Utils.FilterType} */(
      await this.reader_.u8());
    shaka.log.debug(`Filter type: ${filterType}`);

    let startLocation;
    if (filterType === shaka.moqt.Utils.FilterType.ABSOLUTE_START ||
        filterType === shaka.moqt.Utils.FilterType.ABSOLUTE_RANGE) {
      startLocation = await this.location_();
      shaka.log.debug(`Start Location: ${JSON.stringify(startLocation)}`);
    }

    let endGroup;
    if (filterType === shaka.moqt.Utils.FilterType.ABSOLUTE_RANGE) {
    ...
    return {
      kind: shaka.moqt.Utils.MessageType.SUBSCRIBE,
      requestId,
      trackAlias,
      namespace,
      name,
  ...
  /**
   * @return {!Promise<shaka.moqt.Utils.GroupOrder>}
   * @private
   */
  async decodeGroupOrder_() {
    ...
    switch (orderCode) {
      case 0:
        return shaka.moqt.Utils.GroupOrder.PUBLISHER;
      case 1:
        return shaka.moqt.Utils.GroupOrder.ASCENDING;
      case 2:
        return shaka.moqt.Utils.GroupOrder.DESCENDING;
      default:
  ...
  /**
   * @return {!Promise<shaka.moqt.Utils.Location>}
   * @private
   */
  async location_() {
    return {
  ...
  /**
   * @return {!Promise<shaka.moqt.Utils.SubscribeOk>}
   * @private
   */
  async subscribeOk_() {
    ...
    return {
      kind: shaka.moqt.Utils.MessageType.SUBSCRIBE_OK,
      requestId,
      expires,
      groupOrder,
      contentExists,
  ...
  /**
   * @return {!Promise<shaka.moqt.Utils.SubscribeError>}
   * @private
   */
  async subscribeError_() {
    ...
    return {
      kind: shaka.moqt.Utils.MessageType.SUBSCRIBE_ERROR,
      requestId,
      code,
      reason,
      trackAlias,
  ...
  /**
   * @return {!Promise<shaka.moqt.Utils.SubscribeDone>}
   * @private
   */
  async subscribeDone_() {
    ...
    return {
      kind: shaka.moqt.Utils.MessageType.SUBSCRIBE_DONE,
      requestId,
      code,
      streamCount,
      reason,
  ...
  /**
   * @return {!Promise<shaka.moqt.Utils.Unsubscribe>}
   * @private
   */
  async unsubscribe_() {
    ...
    return {
      kind: shaka.moqt.Utils.MessageType.UNSUBSCRIBE,
      requestId,
    };
  }

  /**
   * @return {!Promise<shaka.moqt.Utils.Announce>}
   * @private
   */
  async announce_() {
    ...
    return {
      kind: shaka.moqt.Utils.MessageType.ANNOUNCE,
      requestId,
      namespace,
      params,
    };
  ...
  /**
   * @return {!Promise<shaka.moqt.Utils.AnnounceOk>}
   * @private
   */
  async announceOk_() {
    ...
    return {
      kind: shaka.moqt.Utils.MessageType.ANNOUNCE_OK,
      requestId,
      namespace,
    };
  }
  ...
  /**
   * @return {!Promise<shaka.moqt.Utils.AnnounceError>}
   * @private
   */
  async announceError_() {
    ...
    return {
      kind: shaka.moqt.Utils.MessageType.ANNOUNCE_ERROR,
      requestId,
      code,
      reason,
    };
  ...
  /**
   * @return {!Promise<shaka.moqt.Utils.Unannounce>}
   * @private
   */
  async unannounce_() {
    ...
    return {
      kind: shaka.moqt.Utils.MessageType.UNANNOUNCE,
      namespace,
    };
  }

  /**
   * @return {!Promise<shaka.moqt.Utils.RequestsBlocked>}
   * @private
   */
  async requestsBlocked_() {
    ...
    return {
      kind: shaka.moqt.Utils.MessageType.REQUESTS_BLOCKED,
      maximumRequestId,
    };
  }
};

shaka.moqt.ControlStreamEncoder = class {
  /**
   * @param {!shaka.moqt.Writer} writer
   */
  constructor(writer) {
    ...
    switch (msg.kind) {
      case shaka.moqt.Utils.MessageType.SUBSCRIBE:
        writer.marshalSubscribe(
            /** @type {!shaka.moqt.Utils.Subscribe} */ (msg));
        break;
      case shaka.moqt.Utils.MessageType.SUBSCRIBE_OK:
        writer.marshalSubscribeOk(
            /** @type {!shaka.moqt.Utils.SubscribeOk} */ (msg));
        break;
      case shaka.moqt.Utils.MessageType.SUBSCRIBE_ERROR:
        writer.marshalSubscribeError(
            /** @type {!shaka.moqt.Utils.SubscribeError} */ (msg));
        break;
      case shaka.moqt.Utils.MessageType.SUBSCRIBE_DONE:
        writer.marshalSubscribeDone(
            /** @type {!shaka.moqt.Utils.SubscribeDone} */ (msg));
        break;
      case shaka.moqt.Utils.MessageType.UNSUBSCRIBE:
        writer.marshalUnsubscribe(
            /** @type {!shaka.moqt.Utils.Unsubscribe} */ (msg));
        break;
      case shaka.moqt.Utils.MessageType.ANNOUNCE:
        writer.marshalAnnounce(
            /** @type {!shaka.moqt.Utils.Announce} */ (msg));
        break;
      case shaka.moqt.Utils.MessageType.ANNOUNCE_OK:
        writer.marshalAnnounceOk(
            /** @type {!shaka.moqt.Utils.AnnounceOk} */ (msg));
        break;
      case shaka.moqt.Utils.MessageType.ANNOUNCE_ERROR:
        writer.marshalAnnounceError(
            /** @type {!shaka.moqt.Utils.AnnounceError} */ (msg));
        break;
      case shaka.moqt.Utils.MessageType.UNANNOUNCE:
        writer.marshalUnannounce(
            /** @type {!shaka.moqt.Utils.Unannounce} */ (msg));
        break;
      default:
 ...
 */
shaka.moqt.TrackAliasRegistry = class {
  constructor() {
    /** @private {Map<string, shaka.moqt.Utils.TrackInfo>} */
  ...
  registerTrack(namespace, trackName, requestId) {
    ...
    /** @type {shaka.moqt.Utils.TrackInfo} */
    const info = {
      namespace,
      trackName,
      trackAlias,
   ...
   * @param {string} namespace
   * @param {string} trackName
   * @return {shaka.moqt.Utils.TrackInfo}
   */
   ...
   *
   * @param {number} trackAlias
   * @return {!Array<shaka.moqt.Utils.ObjectCallback>}
   */
 ...
 */
shaka.moqt.TracksManager = class {
  /**
  ...
  constructor(webTransport, controlStream, moqtTransport) {
    ...
    /** @private {shaka.moqt.TrackAliasRegistry} */
    this.trackRegistry_ = new shaka.moqt.TrackAliasRegistry();
    /** @private {number} */
  ...
  async handleIncomingStream_(stream) {
    ...
    const reader = new shaka.moqt.Reader(new Uint8Array([]), stream);
    ...
    try {
      ...
      if (streamType >= shaka.moqt.TracksManager.SUBGROUP_HEADER_START_BIGINT &&
          streamType <= shaka.moqt.TracksManager.SUBGROUP_HEADER_END_BIGINT) {
        await this.handleSubgroupStream_(reader, streamType);
      } else if (streamType === shaka.moqt.TracksManager.FETCH_HEADER_BIGINT) {
  ...
  async handleSubgroupStream_(reader, streamType) {
    try {
      ...
      while (!(await reader.done())) {
        ...
        /** @type {shaka.moqt.Utils.MoQObject} */
        const obj = {
          trackAlias,
          location: {
            group: groupId,
   ...
   *
   * @param {number} trackAlias
   * @param {shaka.moqt.Utils.MoQObject} obj
   * @private
   */
  ...
  async subscribeTrack(namespace, trackName, callback) {
    ...
    /** @type {shaka.moqt.Utils.Subscribe} */
    const subscribeMsg = {
      kind: shaka.moqt.Utils.MessageType.SUBSCRIBE,
      requestId,
      trackAlias,
      ...
      groupOrder: shaka.moqt.Utils.GroupOrder.PUBLISHER,
      // Forward mode by default
      forward: true,
      // No filtering by default
      filterType: shaka.moqt.Utils.FilterType.NEXT_GROUP_START,
      params: [],
    };
    ...
    try {
      ...
      const subscribePromise = new Promise((resolve, reject) => {
        ...
        const unregisterHandler = this.moqtTransport_.registerMessageHandler(
            shaka.moqt.Utils.MessageType.SUBSCRIBE_OK,
            requestId,
            () => {
        ...
        this.moqtTransport_.registerMessageHandler(
            shaka.moqt.Utils.MessageType.SUBSCRIBE_ERROR,
            requestId,
            (response) => {
              timer.stop();
 ...
 */
shaka.moqt.TracksManager.FETCH_HEADER_BIGINT = 0x05;

/**
 * @private @const {number}
 */
shaka.moqt.TracksManager.SUBGROUP_HEADER_START_BIGINT = 0x08;

/**
 * @private @const {number}
 */
shaka.moqt.TracksManager.SUBGROUP_HEADER_END_BIGINT = 0x0d;
