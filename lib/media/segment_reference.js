 ...
 *
 * @param {number} segmentNumber The segment's number, one-based.
 ...
 *     the segment continues to the end of the stream's period.
...
shaka.media.SegmentReference = function(
    segmentNumber, startTime, endTime, startByte, endByte, url) {
  /**
   * The segment's number, one-based.
   * @const {number}
   */
