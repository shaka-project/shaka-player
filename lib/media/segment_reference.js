 ...
 *
 * @param {number} position The position of the segment. The following should
 *     hold true between any two SegmentReferences, r1 and r2:
 ...
 *     the start of the presentation. |startTime| must be less than |endTime|.
