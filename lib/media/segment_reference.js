...
shaka.media.InitSegmentReference = class {
  ...
  static equal(reference1, reference2) {
    ...
    if (reference1.getStartByte() != reference2.getStartByte()) {
      return false;
    }
    if (reference1.getEndByte() != reference2.getEndByte()) {
      return false;
    }
    if (reference1.getSize() != reference2.getSize()) {
      return false;
    }
    const ArrayUtils = shaka.util.ArrayUtils;
    if (!ArrayUtils.equal(reference1.getUris(), reference2.getUris())) {
      return false;
    }
    return true;
  }
