...
shaka.media.InitSegmentReference = class {
   ...
   * @param {?shaka.extern.MediaQualityInfo} mediaQuality Information about the
   *   quality of the media associated with this init segment.
   */
  constructor(uris, startByte, endByte, mediaQuality = null) {
    ...
    /** @const {?shaka.extern.MediaQualityInfo} */
