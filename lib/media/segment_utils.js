  ...
  static getBasicInfoFromMp4(initData, data, disableText) {
    ...
    new Mp4Parser()
        ...
        .fullBox('pssh', (box) => {
          ...
          let drmInfo;
          if (keySystem) {
            drmInfo = shaka.util.ManifestParserUtils.createDrmInfo(
                keySystem,
    ...
    if (encryptionScheme === 'cbcs' && defaultKID &&
        !drmInfos.find((drmInfo) => drmInfo.keySystem === 'com.apple.fps')) {
      drmInfos.push(shaka.util.ManifestParserUtils.createDrmInfo(
