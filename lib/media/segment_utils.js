...
shaka.media.SegmentUtils = class {
  ...
  static getBasicInfoFromMp4(initData, data, disableText) {
    ...
    new Mp4Parser()
        ...
        .box('iamf', (box) => {
          // The channelcount and samplerate fields of an IA Sample Entry are
          // always 0, and parsers must ignore them.  The real values live in
          // the Audio Element and Mix Presentation OBUs.
          shaka.util.Mp4BoxParsers.audioSampleEntry(box.reader);
          if (box.reader.hasMoreData()) {
            Mp4Parser.children(box);
          }
