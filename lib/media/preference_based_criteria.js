...
shaka.media.PreferenceBasedCriteria = class {
  ...
  create(variants) {
    ...
    console.log(`[APPLE, PreferenceBasedCriteria]: after filterByLang: ` +
        `${[...langs].join(',')}`);
    langs.clear();
    ...
    console.log(`[APPLE, PreferenceBasedCriteria]: after filterByPrimary: ` +
        `${[...langs].join(',')}`);
    langs.clear();
    ...
    console.log(`[APPLE, PreferenceBasedCriteria]: after filterByVideoRole: ` +
        `${[...langs].join(',')}`);
    langs.clear();
    ...
    if (this.config_.videoLayout) {
      ...
      console.log(`[APPLE, PreferenceBasedCriteria: no videoLayout`);
    }
    ...
    console.log(`[APPLE, PreferenceBasedCriteria]: after filterByVideoLayout: ` +
        `${[...langs].join(',')}`);
    langs.clear();
    ...
    if (this.config_.hdrLevel) {
      ...
      console.log(`[APPLE, PreferenceBasedCriteria]: no hdrLevel`);
    }
    ...
    console.log(`[APPLE, PreferenceBasedCriteria]: after filterByHdrLevel: ` +
        `${[...langs].join(',')}`);
    langs.clear();
    ...
    if (filteredChannelCounts.length) {
      ...
      console.log(`[APPLE, PreferenceBasedCriteria]: no filterChannelCounts`);
    }
    ...
    console.log(`[APPLE, PreferenceBasedCriteria]: after filterByChannelCounts: ` +
        `${[...langs].join(',')}`);
    langs.clear();
    ...
    if (this.config_.audioLabel) {
      ...
      console.log(`[APPLE, PreferenceBasedCriteria]: no audioLabel`);
    }
    ...
    console.log(`[APPLE, PreferenceBasedCriteria]: after filterByAudioLabel: ` +
        `${[...langs].join(',')}`);
    langs.clear();
    ...
    if (this.config_.videoLabel) {
      ...
      console.log(`[APPLE, PreferenceBasedCriteria]: no videoLabel`);
    }
    ...
    console.log(`[APPLE, PreferenceBasedCriteria]: after filterByVideoLabel: ` +
        `${[...langs].join(',')}`);
    langs.clear();
    ...
    console.log(`[APPLE, PreferenceBasedCriteria]: after filterBySpatialAudio: ` +
        `${[...langs].join(',')}`);
    langs.clear();
    ...
    console.log(`[APPLE, PreferenceBasedCriteria]: beforeAdaptationSet: ` +
        `${[...langs].join(',')}`);
    langs.clear();
