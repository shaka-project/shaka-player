...
/**
 * Called by the owner when the video source has been successfully attached
 * to the video element. This triggers any fake 'encrypted' events.
 */
shaka.media.EmeManager.prototype.onSourceAttached = function() {
  for (var i = 0; i < this.fakeEncryptedEvents_.length; ++i) {
    var event = this.fakeEncryptedEvents_[i];
