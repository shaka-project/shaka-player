...
shaka.media.SegmentIndex = class {
   ...
   * @param {{endTimeTolerance: (number|undefined)}=} options Optional.
   *   endTimeTolerance: tolerance in seconds past the last segment's
   *   end time; if time is within this range, the last segment
   *   is returned (e.g. for HLS EXTINF drift when seeking to the end).
