...
shaka.media.SegmentIndex = class {
  ...
  /**
   * Get number of evicted references
   * @protected
   * @return {number}
   */
  getNumEvicted() {
  ...
  /**
     * Set the number of evicted references
     * @protected
     * @param {number} numEvicted
     */
  setNumEvicted(numEvicted) {
    this.numEvicted_ = numEvicted;
  }
  ...
  get(position) {
    ...
    const index = position - this.getNumEvicted();
