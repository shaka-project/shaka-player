...
goog.provide('shaka.media.PresentationTimeRange');
...
shaka.media.PresentationTimeline = class {
   ...
   * information.
   *
   * @param {!Array.<!shaka.media.PresentationTimeRange>} timeline
 ...
 */
shaka.media.PresentationTimeRange;
