...
shaka.media.SegmentedTextStream.prototype.destroy = function() {
  shaka.log.warning('Cannot destroy SegmentedTextStream', 'Needs implementation');
  return undefined;
};
...
shaka.media.SegmentedTextStream.prototype.hasEnded = function() {
  shaka.log.warning('Cannot determine ending SegmentedTextStream', 'Needs implementation');
  return true;
};
