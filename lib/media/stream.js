 ...
 * @param {!SourceBuffer} sourceBuffer The SourceBuffer, whose content type
...
shaka.media.Stream = function(
    parent, video, mediaSource, sourceBuffer, estimator) {
 ...
 * <ul>
 * <li>
 *   initialStreamBufferSize: number <br>
 ...
 * must be equivalent to the underlying SourceBuffer's type.
