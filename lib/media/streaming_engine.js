...
shaka.media.StreamingEngine = class {
  ...
  async fetch_(mediaState, reference, streamDataCallback) {
    ...
    this.playerInterface_.modifyRequest(request, {
      init: !reference.initSegmentReference,
 ...
 *   modifyRequest: function(shaka.extern.Request, shaka.cmcd.Segment),
 ...
 * @property {function(shaka.extern.Request, shaka.cmcd.Segment)} modifyRequest
