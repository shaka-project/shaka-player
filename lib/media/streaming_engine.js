...
shaka.media.StreamingEngine = class {
  ...
  async fetch_(mediaState, reference, streamDataCallback) {
    ...
    this.playerInterface_.cmcdManager.applySegmentData(
        request,
        mediaState,
        reference);
 ...
 *   cmcdManager: !shaka.util.CmcdManager,
 ...
 * @property {shaka.util.CmcdManager} cmcdManager
 *   The CMCD Manager. The caller retains ownership.
