 ...
 *   The NetworkingEngine instance to use.
...
shaka.media.StreamingEngine.prototype.seeked = function() {
  ...
  var isAllBuffered = Object.keys(this.mediaStates_).every(function(type) {
    ...
    return this.playerInterface_.mediaSourceEngine.bufferedAheadOf(
        type, playheadTime) > 0;
  }.bind(this));
...
shaka.media.StreamingEngine.prototype.initStreams_ = function(
  ...
  this.playerInterface_.mediaSourceEngine.init(
      typeConfig, this.config_.useRelativeCueTimestamps);
  this.setDuration_();
