...
shaka.media.StreamingEngine = class {
  ...
  getSegmentReferenceNeeded_(mediaState, presentationTime, bufferEnd) {
    ...
    if (mediaState.segmentIterator) {
      ...
      (bufferEnd && !mediaState.forceCleared)) {
      ...
      if (mediaState.forceCleared) {
        mediaState.forceCleared = false;
      }
      return ref;
    }
  }
 ...
 * @property {boolean} forceCleared
 *   True indicates that the stream is forced to clear
 *   updating.
 */
shaka.media.StreamingEngine.MediaState_;
