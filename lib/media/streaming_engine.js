 ...
 * @return {!Promise}
 */
shaka.media.StreamingEngine.prototype.init = async function() {
  ...
  let needPeriodIndex = this.findPeriodContainingTime_(presentationTime);
...
shaka.media.StreamingEngine.prototype.loadNewTextStream = async function(
  ...
  if ((this.textStreamSequenceId_ == currentSequenceId) &&
    ...
    const presentationTime = this.playerInterface_.getPresentationTime();
    const needPeriodIndex = this.findPeriodContainingTime_(presentationTime);
