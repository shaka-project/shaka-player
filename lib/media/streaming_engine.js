      ...
      if (reference.isIndependent() && reference.initSegmentReference) {
        ...
        const append = async () => {
          try {
            ...
            //For Dash the init segments need to be updated on the media source engine for appending events.
            this.playerInterface_.mediaSourceEngine.updateInitSegment(mediaState.type, initSegment);
