      ...
      if (reference.initSegmentReference) {
        ...
        const append = async () => {
          try {
            ...
            shaka.log.info(logPrefix, 'using quality=' +
                JSON.stringify(
                    reference.initSegmentReference.getMediaQuality()));
            this.destroyer_.ensureNotDestroyed();
 ...
 *   Called after an init seggment is successfully appended to a MediaSource.
 */
