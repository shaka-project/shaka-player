...
shaka.media.StreamingEngine = class {
  ...
  discardReferenceByBoundary_(mediaState, reference) {
    ...
    if (mediaState !== leadingMediaState) {
      ...
      // type can reset the MSE. This prevents an unnecessary call to
      // resetMediaSource. If this is not the leading content type,
      // the only required action here is discarding.
      return discard;
    }
