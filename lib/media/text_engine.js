...
shaka.media.TextEngine.prototype.appendBuffer =
  ...
  return Promise.resolve().then(function() {
    ...
    // rejected by IE/Edge.  See https://goo.gl/BirBy9 and
    // https://github.com/google/shaka-player/issues/848
    var sortedCues = cues.slice().sort(function(a, b) {
      if (a.startTime != b.startTime)
        ...
        // information.
        return cues.indexOf(b) - cues.indexOf(a);
    });

    for (var i = 0; i < sortedCues.length; ++i) {
      if (sortedCues[i].startTime >= this.appendWindowEnd_) break;
      this.track_.addCue(sortedCues[i]);
    }
