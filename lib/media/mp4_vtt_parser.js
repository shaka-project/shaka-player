...
shaka.media.Mp4VttParser = function(data,
  ...
  var parser = new shaka.util.Mp4Parser()
      ...
      .box(Mp4Box.MDAT, Mp4Parser.allData(function(data) {
        ...
        payload = shaka.media.Mp4VttParser.parseData_(
            data.buffer,
            offset,
            segmentStartTime,
            segmentEndTime);
      }))
      .box(shaka.media.Mp4VttParser.BOX_TYPE_WVTT, function(box) {
...
shaka.media.Mp4VttParser.parseData_ = function(
  ...
  new shaka.util.Mp4Parser()
      .box(shaka.media.Mp4VttParser.BOX_TYPE_VTTC,
           shaka.util.Mp4Parser.allData(parseVTTC))
      .parse(data);
