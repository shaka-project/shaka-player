 ...
 *
 * @fileoverview A generic stream interface.
 */
 ...
 * position.
 *
 * @return {number} The buffering goal. A value of zero indicates that the
 *     Stream doesn't need to buffer any content.
 */
shaka.media.IStream.prototype.getBufferingGoal = function() {};
