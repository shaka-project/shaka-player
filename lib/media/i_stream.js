...
/**
 * Start the stream with the given |streamInfo|.  This should only be called
 * once.
 *
 ...
 */
shaka.media.IStream.prototype.start = function(
    streamInfo, initialBufferSize) {};


/**
 * Switch the stream to the given |streamInfo|.  The stream must have already
 * been started.
 *
 * @param {!shaka.media.StreamInfo} streamInfo
