...
shaka.media.PreloadManager = class extends shaka.util.FakeEventTarget {
  ...
  constructor(assetUri, mimeType, startTime, playerInterface) {
    ...
    this.scte35Timeline_ = typedPlayerInterface.scte35Timeline ||
        new shaka.media.Scte35Timeline(() => ({start: 0, end: Infinity}));
    /** @private {boolean} */
  ...
  /** @return {!shaka.media.Scte35Timeline} */
 ...
 *       shaka.extern.TimelineRegionInfo>,
 *   scte35Timeline: (!shaka.media.Scte35Timeline|undefined),
 ...
 *           } regionTimeline
 * @property {(!shaka.media.Scte35Timeline|undefined)} scte35Timeline
