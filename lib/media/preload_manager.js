 ...
 *   Called once, after the manifest has been parsed and before the initial
 *   variant is chosen (and therefore before any segment index is fetched),
 *   so manifest-level configuration such as CMCD parameters can take effect
 *   for the very first media requests.
 */
