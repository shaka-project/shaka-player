...
shaka.media.VideoWrapper = class {
  ...
  setStartTime_(startTime) {
    shaka.log.alwaysWarn('setStartTime_', this.video_.currentTime, startTime);
  ...
  startListeningToSeeks_() {
    shaka.log.alwaysWarn('startListeningToSeeks_', this.video_.currentTime);
    goog.asserts.assert(
