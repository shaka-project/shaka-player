...
shaka.media.MediaSourceEngine = class {
  ...
  async reset_(streamsByType) {
    ...
    try {
      ...
      this.playerInterface_.onMediaSourceReset?.(currentTime);
      this.mediaSourceOpen_ = Promise.withResolvers();
      this.mediaSource_ = this.createMediaSource(this.mediaSourceOpen_);
      await this.mediaSourceOpen_.promise;
      ...
      this.eventManager_.listenOnce(this.video_,
          shaka.util.MediaElementEvent.LOADED_METADATA, () => {
            ...
            this.playerInterface_.onMediaSourceResetEnd?.();
          });
 ...
 *   onMediaSourceReset: (function(number)|undefined),
 *   onMediaSourceResetEnd: (function()|undefined),
 * }}
 *
 ...
 * @property {(function(number)|undefined)} onMediaSourceReset
 *   Called before replacing the MediaSource during a reset.
 * @property {(function()|undefined)} onMediaSourceResetEnd
 *   Called after restoring currentTime on the new MediaSource.
 */
