  ...
  async appendBuffer(
    ...
    if (reference) {
      ...
      if (timestamp != null) {
        ...
        // For formats without containers, we need to adjust TimestampOffset
        // relative to 0 because segments do not have any timestamp
        // information.
        if (RAW_FORMATS.includes(this.sourceBufferTypes_.get(contentType))) {
          realTimestamp = 0;
        }
