...
shaka.media.MediaSourceEngine.prototype.destroy = function() {
  ...
  for (var contentType in this.transmuxers_) {
...
shaka.media.MediaSourceEngine.prototype.getBufferedInfo = function() {
  var ContentType = shaka.util.ManifestParserUtils.ContentType;
  var getBufferedInfo = shaka.media.TimeRangesUtils.getBufferedInfo;
 ...
 * presentationTimeOffset is relative to the period
 *
 * @param {shaka.util.ManifestParserUtils.ContentType} contentType
...
shaka.media.MediaSourceEngine.prototype.appendBuffer =
    function(contentType, data, startTime, endTime, presentationTimeOffset) {
  var ContentType = shaka.util.ManifestParserUtils.ContentType;
