...
shaka.media.MediaSourceEngine = class {
  ...
  async appendBuffer(
      ...
      if (ArrayBuffer.isView(transmuxerOutput)) {
        ...
        if (output.init != null) {
          ...
          this.enqueueOperation_(contentType, () => {
            //reference for HLS is not empty. Set an empty reference to determine an init segment.
            this.dispatchBufferAppending(contentType, initData, null);
    ...
    await this.enqueueOperation_(contentType, () => {
      ...
      this.dispatchBufferAppending(contentType, data, reference);
