...
shaka.media.MediaSourceEngine = class {
  ...
  addExtraFeaturesToMimeType_(mimeType) {
    let extraFeatures;
    if (this.config_.sourceBufferExtraFeatures) {
      shaka.Deprecate.deprecateFeature(5,
          'mediaSource.sourceBufferExtraFeatures',
          'use mediaSource.addExtraFeaturesToSourceBuffer() instead');
      extraFeatures = this.config_.sourceBufferExtraFeatures;
    } else {
      extraFeatures = this.config_.addExtraFeaturesToSourceBuffer(mimeType);
    }
