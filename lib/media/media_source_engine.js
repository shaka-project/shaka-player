...
shaka.media.MediaSourceEngine = class {
   ...
   * @param {?shaka.media.SegmentReference} reference
   * @param {boolean} isInitData If the chunk data is an init segment data.
   */
  dispatchBufferAppending(contentType, data, reference, isInitData = false) {
  ...
  async appendBuffer(
      ...
      if (ArrayBuffer.isView(transmuxerOutput)) {
        ...
        if (output.init != null) {
          ...
          this.enqueueOperation_(contentType, () => {
            this.dispatchBufferAppending(contentType, initData, reference, true);
    ...
    await this.enqueueOperation_(contentType, () => {
      ...
      this.dispatchBufferAppending(contentType, data, reference, isInitData);
