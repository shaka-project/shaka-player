...
shaka.media.AdaptationSet = class {
   ...
   * @return {boolean}
   */
  canInclude(variant, compareCodecs = true, enableAudioGroups = true) {
    return shaka.media.AdaptationSet.areAdaptable(
        this.root_,
        variant,
        compareCodecs,
        enableAudioGroups,
  ...
  static areAdaptable(a, b, compareCodecs, enableAudioGroups) {
    ...
    if (
      a.audio &&
      b.audio &&
      !AdaptationSet.areAudiosCompatible_(
          a.audio,
          b.audio,
          enableAudioGroups,
          compareCodecs,
   ...
   * @private
   */
  static areAudiosCompatible_(a, b, enableAudioGroups, compareCodecs) {
    const AdaptationSet = shaka.media.AdaptationSet;
