...
shaka.media.SkipRangeController = class {
   ...
   * per range.
   *
   * A boundary matches an endpoint when it lies within tolerance on either side;
   * the closest wins, since the window can span more than one boundary.  Callers
   * pass the candidate segments (a lone segment is accepted as shorthand).
   *
   * @param {shaka.media.SkipRangeController.SkipRange} region
