...
shaka.media.SkipRangeController = class {
   ...
   * gap-jump can't clear (the seek-into-range stall).  A range is carveable
   * only once the video grid confirms it aligns to segment boundaries on both
   * ends (markAlignable); until resolved, or if unalignable, this returns null.
   *
