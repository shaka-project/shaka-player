...
shaka.device.Chromecast = class extends shaka.device.AbstractDevice {
  ...
  requiresPlayheadNudgeAfterBufferClear() {
    // Older Chromecasts (the Linux-based firmware) need the pipeline to be
    // flushed after clearing the buffer for new content to replace the old
    // content.  Android- and Fuchsia-based devices do not.
