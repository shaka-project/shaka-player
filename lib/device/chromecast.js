...
shaka.device.Chromecast = class extends shaka.device.AbstractDevice {
   ...
   */
  isSeekingSlow() {
    return this.osType_.value() !== shaka.device.Chromecast.OsType_.ANDROID;
  }
  ...
  supportsOfflineStorage() {
    return super.supportsOfflineStorage() &&
        this.osType_.value() !== shaka.device.Chromecast.OsType_.ANDROID;
  }
