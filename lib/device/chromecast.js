...
shaka.device.Chromecast = class extends shaka.device.AbstractDevice {
  ...
  adjustConfig(config) {
    ...
    // Default Widevine robustness is L1
    config.drm.defaultAudioRobustnessForWidevine = 'HW_SECURE_CRYPTO';
    config.drm.defaultVideoRobustnessForWidevine = 'HW_SECURE_ALL';
