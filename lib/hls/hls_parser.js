...
shaka.hls.HlsParser = class {
   ...
   * @private
   */
  getInitSegmentReference_(playlistUri, mapTag, variables) {
  ...
  createSegmentReference_(
      ...
      startTime, timestampOffset, variables) {
  ...
  async createSegments_(
    ...
    let initSegmentRef = mapTag ? this.getInitSegmentReference_(
        playlist.absoluteUri, mapTag, variables) : null;
    ...
    for (const {i, item} of enumerate(hlsSegments)) {
      ...
      initSegmentRef = mapTag ? this.getInitSegmentReference_(
          playlist.absoluteUri, mapTag, variables) : null;
