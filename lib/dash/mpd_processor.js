...
/**
 * Calculates the duration of the given SegmentList.
 *
...
/**
 * Creates a StreamInfo for each Representation.
 *
 * @param {!shaka.dash.mpd.Mpd} mpd
 * @private
 */
shaka.dash.MpdProcessor.prototype.createPeriodInfos_ = function(mpd) {
  for (var i = 0; i < mpd.periods.length; ++i) {
    var period = mpd.periods[i];
    ...
    this.periodInfos.push(periodInfo);
  }
};
