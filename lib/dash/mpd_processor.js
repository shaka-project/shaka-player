...
shaka.dash.MpdProcessor.prototype.computeCurrentSegmentNumber_ = function(
  ...
  // Apply a small offset to |currentTime| to compensate for poor clock
  // synchronization between us and the server.
  // TODO: Account for poor clock synchronization using the server's response
  // headers.
  currentTime -= 5;
...
shaka.dash.MpdProcessor.prototype.createStreamInfo_ = function(
  ...
  if (representation.segmentBase) {
    ...
    if ((representation.segmentList.presentationTimeOffset != null) &&
      ...
      representation.segmentList.presentationTimeOffset = pto;
    }
