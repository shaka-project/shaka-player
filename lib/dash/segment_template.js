  ...
  static createStreamInfo(
    ...
    if (info.indexTemplate) {
      ...
      if (!isUpdate && context.adaptationSet.contentType !== 'image') {
        ...
        // For multi-period live streams the period duration may not be known
        // until the following period appears in an updated manifest.
        // periodDurationMap provides the updated period duration.
        const getPeriodEnd = () => {
