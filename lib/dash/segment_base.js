 ...
 *     which tells the source of the init segment.
 * @return {shaka.media.InitSegmentReference}
 */
shaka.dash.SegmentBase.createInitSegment = function(context, type) {
  var MpdUtils = shaka.dash.MpdUtils;
  var XmlUtils = shaka.util.XmlUtils;
  var SegmentBase = shaka.dash.SegmentBase;

  var initialization =
      MpdUtils.inheritChild(context, type, 'Initialization');
  if (!initialization)
    return null;
...
shaka.dash.SegmentBase.createStream = function(
  ...
  var presentationTimeOffset = MpdUtils.inheritAttribute(
      context, 'segmentBase', 'presentationTimeOffset');

  var init = SegmentBase.createInitSegment(context, 'segmentBase');
  var index =
...
shaka.dash.SegmentBase.createSegmentIndex_ = function(
  ...
  var representationIndex =
      MpdUtils.inheritChild(context, 'segmentBase', 'RepresentationIndex');
  var indexRangeElem =
      MpdUtils.inheritAttribute(context, 'segmentBase', 'indexRange');
