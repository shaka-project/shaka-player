...
shaka.dash.DashParser.prototype.requestManifest_ = function() {
  ...
  // TODO(#829): abort these requests on destroy
  return networkingEngine.request(requestType, request).promise
...
shaka.dash.DashParser.prototype.requestForTiming_ =
  ...
  return this.playerInterface_.networkingEngine.request(type, request).promise
      .then(function(response) {
        var text;
        if (method == 'HEAD') {
