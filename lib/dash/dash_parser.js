...
goog.require('shaka.event.ProducerReferenceTime');
goog.require('shaka.event.ProgramInformation');
...
shaka.dash.DashParser = class {
    ...
    if (!this.manifest_) {
      ...
      if (programInformation) {
        this.playerInterface_.onEvent(
            new shaka.event.ProgramInformation(programInformation));
      }
    } else {
  ...
  parseProducerReferenceTime_(prftNode, streamInfo, presentationTimeline) {
    ...
    if (!isNaN(programStartTime)) {
      ...
      this.playerInterface_.onEvent(
          new shaka.event.ProducerReferenceTime(prftInfo));
    }
  }
