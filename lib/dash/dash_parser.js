 ...
 * @param {?shakaExtern.DashContentProtectionCallback} drmCallback
 *
 * @struct
 * @constructor
...
shaka.dash.DashParser = function(
    netEngine, retryParameters, newPeriod, onError, drmCallback) {
  ...
  /** @private {?shakaExtern.DashContentProtectionCallback} */
  this.drmCallback_ = drmCallback;
 ...
 * of a DASH manifest.
 *
 * @property {Node} segmentBase
 *   The XML node for SegmentBase.
 * @property {Node} segmentList
 *   The XML node for SegmentList.
 * @property {Node} segmentTemplate
...
shaka.dash.DashParser.prototype.requestManifest_ = function() {
  ...
  var request = shaka.net.NetworkingEngine.makeRequest(
      [this.manifestUri_], this.retryParameters_);
...
shaka.dash.DashParser.prototype.parseManifest_ =
  ...
  if (xml) {
    mpd = XmlUtils.findChild(xml, 'MPD');
  }
  if (!mpd) {
 ...
 *
 * @param {shaka.dash.DashParser.Context} context
 * @param {!Node} elem The AdaptationSet element.
...
shaka.dash.DashParser.prototype.parseAdaptationSet_ = function(context, elem) {
  ...
  var contentProtection = shaka.dash.ContentProtection.parseFromAdaptationSet(
      contentProtectionElems, this.drmCallback_);
  ...
  return {
    ...
    main: main,
    streams: streams,
    drmInfo: contentProtection.drmInfo
  };
};
...
shaka.dash.DashParser.prototype.parseRepresentation_ = function(
  ...
  var keyIds = shaka.dash.ContentProtection.parseKeyIds(
...
shaka.dash.DashParser.prototype.createFrame_ = function(
  ...
  return {
    ...
    contentType: elem.getAttribute(elem, 'contentType') || parent.contentType,
    ...
    setsByGroup.keys().forEach(function(group) {
      ...
      setsByLang.keys().forEach(function(lang) {
        ...
        var streamSet = {
          ...
          drmInfos:
              sets.map(function(s) { return s.drmInfo; })
...
shaka.dash.DashParser.prototype.requestForTiming_ = function(uri, method) {
  var request =
      shaka.net.NetworkingEngine.makeRequest([uri], this.retryParameters_);
...
shaka.dash.DashParser.prototype.requestInitSegment_ = function(
  ...
  var request =
      shaka.net.NetworkingEngine.makeRequest(uris, this.retryParameters_);
  if (startByte != null) {
