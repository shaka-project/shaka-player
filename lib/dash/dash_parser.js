...
shaka.dash.DashParser = class {
  ...
  constructor() {
    ...
    /**
     * A map of Peroid IDs to Stream Map IDs .
     * Use to have direct acces to streamMap key
    ...
    if (this.manifest_) {
      ...
      for (const stream of Object.values(this.streamMap_)) {
        if (stream.segmentIndex) {
          ...
          console.log(stream, stream.segmentIndex);
        }
      }
    } else {
  ...
  /**
   * Clean StreamMap Object to remove reference to deleted Stream Object
   * @private
   */
  cleanStreamMap_() {
