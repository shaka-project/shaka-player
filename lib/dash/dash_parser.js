...
shaka.dash.DashParser = class {
  ...
  parseAdaptationSet_(context, elem) {
    ...
    return {
      ...
      isSegmentSequence: isSegmentSequence,
 ...
 *   associated with.
 * @property {boolean} isSegmentSequence
 *   Indicate if the representations of this AdapationSet are segment sequence.
