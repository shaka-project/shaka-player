 ...
 *   A list of media segments for the stream, if known in advance, to detect and
 *   attempt to correct common timeline issues in content.
 */
...
shaka.dash.DashParser.prototype.parseRepresentation_ = function(
  ...
  return {
    ...
    mediaSegmentReferences: streamInfo.mediaSegmentReferences,
