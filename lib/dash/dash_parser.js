...
shaka.dash.DashParser = class {
  ...
  async processManifest_(mpd, finalManifestUri) {
    ...
    // Calling makeBaseUriGetter dynamically to avoid makeBaseUriGetter_ getting
    // inlined. Inlining the function will cause it to capture `mpd` from the
    // lexical scope leading to memory leaks.
