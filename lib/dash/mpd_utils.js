...
shaka.dash.MpdUtils = class {
  ...
  static parseSegmentInfo(context, callback) {
    ...
    const endNumberAttr =
        MpdUtils.inheritAttribute(context, callback, 'endNumber');
    let endNumber = TXml.parseNonNegativeInt(endNumberAttr || '');
    if (endNumberAttr == null || endNumber == null) {
      endNumber = null;
    }
 ...
 *   The number of the last segment in the sequence, if specified.
