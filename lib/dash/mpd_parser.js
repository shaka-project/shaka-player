...
shaka.dash.mpd.SegmentUrl = function() {
  ...
  /**
   * The number of the first segment, relative to the beginning of the Period,
   * one based.
   *
   * Not an actual XML attribute, but generated from a SegmentTemplate.
   * @type {?number}
   */
...
shaka.dash.mpd.SegmentBase.prototype.parse = function(parent, elem) {
  ...
  this.mediaUrl = parent.mediaUrl || this.baseUrl;
...
shaka.dash.mpd.SegmentList.prototype.parse = function(parent, elem) {
  ...
  this.startNumber = mpd.parseAttr_(
      elem, 'startNumber', mpd.parsePositiveInt_, this.startNumber);
