...
shaka.dash.ContentProtection = class {
  ...
  static getWidevineLicenseUrl(element) {
    ...
    if (dashIfLaurlNode && dashIfLaurlNode.innerText) {
      return dashIfLaurlNode.innerText;
    }
  ...
  static getClearKeyLicenseUrl(element) {
    ...
    if (clearKeyLaurlNode &&
      ...
      if (clearKeyLaurlNode && clearKeyLaurlNode.innerText) {
        return clearKeyLaurlNode.innerText;
      }
    }
    return '';
  }
  ...
  static getPlayReadyLicenseUrl(element) {
    ...
    const bytes = shaka.util.Uint8ArrayUtils.fromBase64(proNode.innerText);
  ...
  static getInitDataFromPro_(element) {
    ...
    const data = Uint8ArrayUtils.fromBase64(proNode.innerText);
