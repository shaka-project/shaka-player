...
/**
 * Compares two SegmentReference objects by their start time.
 * @param {!shaka.dash.SegmentReference} ref1
 * @param {!shaka.dash.SegmentReference} ref2
 * @return {number}
 * @export
 */
shaka.dash.SegmentReference.compare = function(ref1, ref2) {
  if (ref1.startTime < ref2.startTime) {
    return -1;
  } else if (ref1.startTime > ref2.startTime) {
    return 1;
  }
