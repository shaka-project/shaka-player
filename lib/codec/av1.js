 ...
 * AV1 utils.
 *
 * An AV1 access unit is a "temporal unit", split into its Open Bitstream Units
 * by shaka.util.Obu.parseAv1.  This is what reads meaning out of those OBUs.
 *
 * @see https://aomediacodec.github.io/av1-spec/av1-spec.pdf
 * @see https://aomediacodec.github.io/av1-isobmff/ (av1C)
 */
shaka.codec.AV1 = class {
  /**
   ...
   *
   * @param {!Array<shaka.util.Obu.Unit>} obus
   * @return {?shaka.codec.AV1.Info}
   */
   ...
   * these bytes.
   *
   * @param {shaka.codec.AV1.SequenceHeader} header
   ...
   * @return {?shaka.codec.AV1.SequenceHeader}
   * @private
   */
   ...
   *
   * @param {shaka.codec.AV1.Reader} reader
   * @param {number} count
   * @return {number}
   * @private
   */
  ...
  static skipBits_(reader, count) {
    shaka.codec.AV1.readBits_(reader, count);
  }
 ...
 * }}
 */
shaka.codec.AV1.SequenceHeader;


/**
 * @private @const {number}
 */
shaka.codec.AV1.OBU_TYPE_SEQUENCE_HEADER_ = 1;


/**
 * @private @const {number}
 */
shaka.codec.AV1.OBU_TYPE_FRAME_HEADER_ = 3;


/**
 * @private @const {number}
 */
shaka.codec.AV1.OBU_TYPE_FRAME_ = 6;


/**
 * @private @const {number}
 */
shaka.codec.AV1.FRAME_TYPE_KEY_ = 0;
 ...
 * @private @const {number}
 */
shaka.codec.AV1.SELECT_SCREEN_CONTENT_TOOLS_ = 2;


/**
 * @private @const {number}
 */
shaka.codec.AV1.CP_BT_709_ = 1;


/**
 * @private @const {number}
 */
shaka.codec.AV1.CP_UNSPECIFIED_ = 2;


/**
 * @private @const {number}
 */
shaka.codec.AV1.TC_UNSPECIFIED_ = 2;


/**
 * @private @const {number}
 */
shaka.codec.AV1.TC_SRGB_ = 13;


/**
 * @private @const {number}
 */
shaka.codec.AV1.MC_IDENTITY_ = 0;


/**
 * @private @const {number}
 */
shaka.codec.AV1.MC_UNSPECIFIED_ = 2;


/**
 * @private @const {number}
 */
shaka.codec.AV1.CSP_UNKNOWN_ = 0;
