...
goog.provide('shaka.codec.ADTS');


/**
 * ADTS utils
 */
shaka.codec.ADTS = class {
  /**
  ...
  static getFrameDuration(samplerate) {
    return (shaka.codec.ADTS.AAC_SAMPLES_PER_FRAME * 90000) / samplerate;
  }
 ...
 * @const {number}
 */
shaka.codec.ADTS.AAC_SAMPLES_PER_FRAME = 1024;
