...
shaka.codec.H265 = class {
  ...
  static parseInfo(nalus) {
    ...
    /** @type {shaka.codec.H265.DecoderConfigurationRecordType} */
    const detail = {
   ...
   * @return {shaka.codec.H265.VPSConfiguration}
   * @private
   */
   ...
   *
   * @param {!Uint8Array} data
   * @return {shaka.codec.H265.SPSConfiguration}
   * @private
   */
  ...
  /**
   * @param {!Uint8Array} data
   * @return {shaka.codec.H265.PPSConfiguration}
   * @private
   */
   ...
   * @param {shaka.codec.H265.DecoderConfigurationRecordType} detail
   * @return {!Uint8Array}
   * @private
   */
    ...
    for (let i = 0; i < units.length; i += 1) {
      data.set(
          new Uint8Array([
            ...
            0x00,
            0x01,
            units[i].byteLength >> 8,
            units[i].byteLength & 255,
          ]),
          offset,
      );
      offset += 5;
  ...
  /**
   * @param {!Array<shaka.extern.VideoNalu>} nalus
   * @param {!shaka.codec.H265.H265Frame} frame
   * @return {boolean}
   */
  static parseFrame(nalus, frame) {
    ...
    totalNaluSize += 4 * nalusData.length;

    const data = new Uint8Array(totalNaluSize);
    let offset = 0;

    for (const naluData of nalusData) {
      const size = naluData.byteLength;
      data[offset] = (size >> 24) & 0xff;
      data[offset + 1] = (size >> 16) & 0xff;
      data[offset + 2] = (size >> 8) & 0xff;
      data[offset + 3] = size & 0xff;

      data.set(naluData, offset + 4);
      offset += size + 4;
    }
 ...
 * @private
 */
shaka.codec.H265.NALU_TYPE_TRAIL_N_ = 0x01;
 ...
 * @private
 */
shaka.codec.H265.NALU_TYPE_TRAIL_R_ = 0x00;
 ...
 * @private
 */
shaka.codec.H265.NALU_TYPE_IDR_W_RADL_ = 0x13;
 ...
 * @private
 */
shaka.codec.H265.NALU_TYPE_IDR_N_LP_ = 0x14;
 ...
 * @private
 */
shaka.codec.H265.NALU_TYPE_CRA_NUT_ = 0x15;
 ...
 * @private
 */
shaka.codec.H265.NALU_TYPE_VPS_ = 0x20;
 ...
 * @private
 */
shaka.codec.H265.NALU_TYPE_SPS_ = 0x21;
 ...
 * @private
 */
shaka.codec.H265.NALU_TYPE_PPS_ = 0x22;
 ...
 * @private
 */
shaka.codec.H265.NALU_TYPE_AUD_ = 0x23;
 ...
 * @private
 */
shaka.codec.H265.NALU_TYPE_SEI_PREFIX_ = 0x27;
 ...
 * @private
 */
shaka.codec.H265.NALU_TYPE_SEI_SUFFIX_ = 0x28;
 ...
 */
shaka.codec.H265.VPSConfiguration;
 ...
 */
shaka.codec.H265.SPSConfiguration;
 ...
 */
shaka.codec.H265.PPSConfiguration;
 ...
 * @property {boolean} frameRateFixed
 */
shaka.codec.H265.DecoderConfigurationRecordType;
