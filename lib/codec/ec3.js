 ...
 * EC3 utils
 */
shaka.codec.Ec3 = class {
  /**
   * @param {!Uint8Array} data
   * @param {!number} offset
   * @param {!shaka.codec.Ec3.Ec3Frame} frame
   * @return {boolean}
   */
  static parseFrame(data, offset, frame) {
    ...
    if (!shaka.codec.Ec3.probe(data, offset)) {
      return false;
    }
 ...
 * @const {number}
 */
shaka.codec.Ec3.EC3_SAMPLES_PER_FRAME = 1536;
