...
goog.provide('shaka.codec.Ac3');


/**
 * AC3 utils
 */
shaka.codec.Ac3 = class {
  /**
   * @param {!Uint8Array} data
   * @param {!number} offset
   * @param {!shaka.codec.Ac3.Ac3Frame} frame
   * @return {boolean}
   */
 ...
 * @const {number}
 */
shaka.codec.Ac3.AC3_SAMPLES_PER_FRAME = 1536;
