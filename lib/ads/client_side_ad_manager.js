...
shaka.ads.ClientSideAdManager = class {
   ...
   */
  constructor(adContainer, video, locale, onEvent, adsRenderingSettings) {
    /** @private {HTMLElement} */
  ...
  updateAdsRenderingSettings(adsRenderingSettings) {
    if (this.imaAdsManager_) {
      this.imaAdsManager_.updateAdsRenderingSettings(adsRenderingSettings);
    }
  }
  ...
  onAdsManagerLoaded_(e) {
    ...
    this.imaAdsManager_ = e.getAdsManager(
        this.video_,
