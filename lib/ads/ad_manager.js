...
shaka.ads.AdManager = class extends shaka.util.FakeEventTarget {
  ...
  initInterstitial(adContainer) {
    const container = adContainer || this.clientSideAdContainer_;
    if (!container) {
  ...
  initMediaTailor(adContainer) {
    ...
    const container = adContainer || this.serverSideAdContainer_;
  ...
  requestMediaTailorStream(url, adsParams, backupUrl = '') {
    if (!this.mtAdManager_) {
      this.initMediaTailor(/* adContainer= */ null);
    }
  ...
  async onHLSMetadata(metadata) {
    if (metadata.type == 'com.apple.quicktime.HLS') {
      ...
      if (!this.interstitialAdManager_) {
        this.initInterstitial(/* adContainer= */ null);
      }
      if (this.interstitialAdManager_) {
