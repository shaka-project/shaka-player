...
shaka.ads.AdManager = class extends shaka.util.FakeEventTarget {
  ...
  initInterstitial(adContainer, basePlayer) {
    ...
    this.interstitialAdManager_ = new shaka.ads.InterstitialAdManager(
        adContainer, basePlayer, (e) => this.processAndDispatchEvent_(e));
  ...
  */
  ...
  onInterstitialMetadata(basePlayer, interstitial, playerConfig) {
    if (!this.interstitialAdManager_) {
      this.initInterstitial(/* adContainer= */ null, basePlayer);
    }
    if (this.interstitialAdManager_) {
      this.interstitialAdManager_.addMetadata(interstitial, playerConfig);
    }
  }
