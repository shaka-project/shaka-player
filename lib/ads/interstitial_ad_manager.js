...
shaka.ads.InterstitialAdManager = class {
  ...
  release() {
    ...
    // Ignore potential errors as we treat destroy synchronously here
    this.player_.destroy().catch((e) => {
      shaka.log.debug('[InterstitialAdManager] Error destroying player:', e);
    });
  }
