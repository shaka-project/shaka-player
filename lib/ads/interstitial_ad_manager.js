...
shaka.ads.InterstitialAdManager = class {
  ...
  async resolveAssetList_(descriptor) {
    ...
    try {
      ...
      // A successful response with an empty ASSETS array does not reach here; it
      // simply yields an empty interstitial list. Log so failed resolutions are
      // distinguishable from legitimately empty asset lists.
      shaka.log.warning(
