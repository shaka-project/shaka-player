...
shaka.ads.InterstitialAdManager = class {
  ...
  addOverlayRegion(region) {
    ...
    let percentageReductionOfCurrentVideo = null;
    if (squeezeCurrent) {
      percentageReductionOfCurrentVideo =
  ...
  setupStaticAd_(interstitial, sequenceLength, adPosition, oncePlayed) {
    ...
    this.setBaseVideoStyles_(interstitial);
    ...
    const basicTask = () => {
      ...
      this.removeBaseVideoStyles_(interstitial);
      this.onEvent_(
   ...
   * @private
   */
  setBaseVideoStyles_(interstitial) {
    if (interstitial.displayOnBackground) {
      this.baseVideo_.style.zIndex = '1';
    }
    if (interstitial.percentageReductionOfCurrentVideo != null) {
      ...
      this.baseVideo_.style.transform =
          `scale(${interstitial.percentageReductionOfCurrentVideo})`;
    }
  }
   ...
   * @private
   */
  removeBaseVideoStyles_(interstitial) {
    if (!interstitial || interstitial.displayOnBackground) {
      this.baseVideo_.style.zIndex = '';
    }
    if (!interstitial ||
        interstitial.percentageReductionOfCurrentVideo != null) {
