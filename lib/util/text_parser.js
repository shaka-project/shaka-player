...
/**
 * Parses a WebVTT/TTML time with a given regex. Expects regex to be some
 * sort of a time-matcher to match hours, minutes, seconds and milliseconds
 *
 * @param {!RegExp} regex
 * @return {?number}
 */
shaka.util.TextParser.prototype.parseTime = function(regex) {
  var results = this.readRegex(regex);
  if (results == null)
    return null;
