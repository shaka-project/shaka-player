...
shaka.util.DataViewReader = class {
  ...
  /**
   * Reads an Uint64 as BigInt, and advances the reader.
  ...
  readUint64BigInt() {
    ...
    try {
      ...
      if (this.littleEndian_) {
        low = BigInt(this.dataView_.getUint32(this.position_, true));
        high = BigInt(this.dataView_.getUint32(this.position_ + 4, true));
      } else {
        high = BigInt(this.dataView_.getUint32(this.position_, false));
        low = BigInt(this.dataView_.getUint32(this.position_ + 4, false));
      }
