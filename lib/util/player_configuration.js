...
shaka.util.PlayerConfiguration = class {
  ...
  static createDefault() {
    ...
    // the -1kb is needed since the network API is the multiplication of 25kb, this 
    // change helps us distinguish between default value and API-based value (in AWMA getBandwidthEstimate function)
