...
shaka.util.PlayerConfiguration = class {
  ...
  static createDefault() {
    ...
    // The minus 1kb is needed since the network API is the multiplication of
    // 25kb, this change helps us distinguish between default value and
    // API-based value (in AWMA getBandwidthEstimate function)
    const bandwidthEstimate = 999000; // 1Mbps - 1kb
