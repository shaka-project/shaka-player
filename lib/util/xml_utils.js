...
shaka.util.XmlUtils = class {
  ...
  static parseXmlString(xmlString, expectedRootElemName) {
    ...
    if (xml) {
      ...
      // same type as the element linking. If there are not root
      // element, the documentElement is choosed
      if (expectedRootElemName == '' ||
          xml.documentElement.tagName == expectedRootElemName) {
