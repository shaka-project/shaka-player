...
shaka.util.Platform = class {
   ...
   * @return {boolean}
   */
  static shouldPolyfillMediaKeysApple() {
   ...
   * @return {boolean}
   */
  static shouldPolyfillMediaKeysWebkit() {
   ...
   * @return {boolean}
   */
  static shouldPolyfillMediaKeysMS() {
  ...
  static isMediaKeysPolyfilled() {
    return shaka.util.Platform.shouldPolyfillMediaKeysApple() ||
        shaka.util.Platform.shouldPolyfillMediaKeysWebkit() ||
        shaka.util.Platform.shouldPolyfillMediaKeysWebkit();
  }
};
