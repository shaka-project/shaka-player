...
shaka.util.Platform = class {
  ...
  /**
   * Returns codec switching strategy by known relaible device support.
   *
   ...
   *
   * @return {shaka.config.CodecSwitchingStrategy}
   */
  static supportsSmoothCodecSwitching() {
    ...
    if (Platform.isTizen2() || Platform.isTizen3() ||
      ...
      return shaka.config.CodecSwitchingStrategy.RELOAD;
    } else {
      return shaka.config.CodecSwitchingStrategy.SMOOTH;
    }
  }
