...
goog.provide('shaka.util.SegmentUtils');
 ...
 */
shaka.util.SegmentUtils = class {
  /**
   * @param {string} mimeType
   * @return {shaka.util.SegmentUtils.BasicInfo}
   */
   ...
   * @return {?shaka.util.SegmentUtils.BasicInfo}
   */
  static getBasicInfoFromTs(response) {
   ...
   * @return {?shaka.util.SegmentUtils.BasicInfo}
   */
  static getBasicInfoFromMp4(response) {
    const Mp4Parser = shaka.util.Mp4Parser;
    const SegmentUtils = shaka.util.SegmentUtils;
 ...
 */
shaka.util.SegmentUtils.BasicInfo;
