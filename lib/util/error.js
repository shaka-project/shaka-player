...
shaka.util.Error.Code = {
  ...
  /**
   * The StreamingEngine cannot append the next segment because it cannot
   * satisfy the byte limit.
   */
  'STREAMING_CANNOT_SATISFY_BYTE_LIMIT': 34,

  /**
   * The StreamingEngine inserted a media segment, but the segment did not
   * contain any actual media content.
   */
  'STREAMING_BAD_SEGMENT': 35,
   ...
   * <br> error.data[0] is an error message string from the browser.
   */
  'FAILED_TO_GENERATE_LICENSE_REQUEST': 43,
   ...
   */
  'NO_LICENSE_SERVER_SPECIFIED': 46,
   ...
   */
  'ENCRYPTED_CONTENT_WITHOUT_DRM_INFO': 47
};
