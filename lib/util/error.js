...
shaka.util.Error.Code = {
  ...
  /**
   * PubNub SDK was not loaded. The SDK must be included via script tag
   * or npm before using SyncManager.
   * <br> error.data[0] is a message with details.
   */
  'SYNC_PUBNUB_NOT_LOADED': 7008,

  /**
   * Invalid configuration for SyncManager.
   * <br> error.data[0] is a message with details.
   */
  'SYNC_INVALID_CONFIG': 7009,

  /**
   * No video element is attached to the player for synchronization.
   * <br> error.data[0] is a message with details.
   */
  'SYNC_NO_VIDEO_ELEMENT': 7010,
