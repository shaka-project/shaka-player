...
shaka.util.Error.Code = {
  ...
  /**
   * HLS Media playlist doesn't have an #EXT-X-MAP tag.
   */
  'HLS_MEDIA_INIT_SECTION_INFO_MISSING': 4019,
  ...
  /**
   * HLS parser has encountered encrypted content.
   * We don't have support for it implemented yet.
   * Until we do, we're going to reject it.
   */
  'HLS_ENCRYPTED_CONTENT_NOT_SUPPORTED': 4026,
