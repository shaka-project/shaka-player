...
shaka.util.Error.Code = {
   ...
   * byte limit and then seeking forwards or backwards (e.g., nudging the
   * playhead).
   *
   * <br> error.data[0] is the type of content which caused the error.
   */
   ...
   */
  'STREAMING_INVALID_STREAMS_CHOSEN': 39,
   ...
   * <br> error.data[0] is an error message string from the browser.
   */
  'FAILED_TO_GENERATE_LICENSE_REQUEST': 47,
   ...
   */
  'NO_LICENSE_SERVER_SPECIFIED': 50,
