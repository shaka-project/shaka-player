 ...
 * @param {number=} opt_requestTimeout The timeout for a RangeRequest in
 *     seconds.
 *
 * @struct
 * @constructor
 ...
 */
shaka.util.RangeRequest = function(
    url,
    begin,
    end,
    opt_maxAttempts,
    opt_baseRetryDelayMs,
    opt_requestTimeout) {
  ...
  var timeoutSeconds = opt_requestTimeout != null ?
      opt_requestTimeout : shaka.player.Defaults.RANGE_REQUEST_TIMEOUT;
