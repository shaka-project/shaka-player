...
shaka.util.Dom = class {
  ...
  /**
   * Creates a div styled as a bottom-centered subtitle/caption container.
   *
   * @param {string} className
   * @return {!HTMLElement}
   */
  static createSubtitleContainer(className) {
    const container = shaka.util.Dom.createHTMLElement('div');
    container.classList.add(className);
    // Center the text.
    container.style.textAlign = 'center';
    // Lay the captions out as a vertical column, centered horizontally.
    container.style.display = 'flex';
    container.style.flexDirection = 'column';
    container.style.alignItems = 'center';
    // Anchor the captions to the bottom by default.
