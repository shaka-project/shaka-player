...
shaka.util.Pssh.prototype.parsePsshBox_ = function(box) {
  ...
  /** @type {!DataView} */
  const psshData = new DataView(psshBox.buffer);
  let byteCursor = 0;
 ...
 * @return {boolean}
 */
shaka.util.Pssh.containsPssh = function(initData) {
 ...
 * @return {!Uint8Array}
 */
shaka.util.Pssh.getPsshFromInitData = function(initData, keySystem) {
