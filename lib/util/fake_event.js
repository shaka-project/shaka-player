...
shaka.util.FakeEvent.EventName = {
  ...
  Buffering: 'buffering',
  BufferAppending: 'bufferappending',
  ...
  TrickPlayStarted: 'trickplaystarted',
  TrickPlayStopped: 'trickplaystopped',
  TrickPlayRateChanged: 'trickplayratechanged',
  TrickFrameRendered: 'trickframerendered',
  ScrubStarted: 'scrubstarted',
  ScrubStopped: 'scrubstopped',
  Unloading: 'unloading',
