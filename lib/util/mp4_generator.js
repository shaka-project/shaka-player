...
shaka.util.Mp4Generator = class {
  ...
  constructor(streamInfo) {
    ...
    /** @private {boolean} */
    this.encrypted_ = streamInfo.encrypted;
    ...
    /** @private {!Uint8Array} */
    this.videoConfig_ = streamInfo.videoConfig;
  ...
  avc1_() {
    ...
    let avcCBox;
    if (this.videoConfig_.byteLength > 0) {
      avcCBox = Mp4Generator.box('avcC', this.videoConfig_);
    } else {
      avcCBox = Mp4Generator.box('avcC', this.avcC_());
    }
