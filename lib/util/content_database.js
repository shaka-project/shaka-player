...
shaka.util.ContentDatabase.prototype.insertStream = function(streamInfo,
  ...
  var p = Promise.all(async).then(shaka.util.TypedBind(this, function() {
    return this.getNextId_(this.getIndexStore_());
  }));
...
shaka.util.ContentDatabase.prototype.insertStreamIndex_ = function(streamInfo,
  ...
  var streamIndex = {
    ...
    'license_server_url': drmScheme.licenseServerUrl,
