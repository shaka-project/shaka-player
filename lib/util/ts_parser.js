...
shaka.util.TsParser = class {
  ...
  getMetadata() {
    ...
    // We loop in reverse mode to be able to consume all the data.
    // If an end data does not have PES, it is concatenated to the
    // immediately previous one in order to consume all the data.
