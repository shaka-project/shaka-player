...
shaka.util.FakeEventTarget = class {
  ...
  /**
   * Remove a listener that listens to all event types.
   *
   * @param {shaka.util.FakeEventTarget.ListenerType} listener
   * @exportInterface
   */
  unlistenToAllEvents(listener) {
    this.removeEventListener(shaka.util.FakeEventTarget.ALL_EVENTS_, listener);
  }
 ...
 * @private
 */
shaka.util.FakeEventTarget.ALL_EVENTS_ = '__shaka_all_events__';
