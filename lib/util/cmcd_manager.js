...
shaka.util.CmcdManager = class {
  ...
  constructor(playerInterface, mimeType) {
     ...
     * Streaming format
     *
     * @private {(shaka.util.CmcdManager.CmcdStreamingFormat|undefined)}
     */
   ...
   *
   * @param {?string} mimeType
   * @return {(shaka.util.CmcdManager.CmcdStreamingFormat|undefined)}
   */
  getStreamingFormat(mimeType) {
    switch (mimeType) {
      case 'application/dash+xml':
        return shaka.util.CmcdManager.CmcdStreamingFormat.DASH;

      case 'application/x-mpegurl':
      case 'application/vnd.apple.mpegurl':
        return shaka.util.CmcdManager.CmcdStreamingFormat.HLS;

      case 'application/vnd.ms-sstr+xml':
        return shaka.util.CmcdManager.CmcdStreamingFormat.SMOOTH;
   ...
   * @param {!shaka.util.CmcdManager.Cmcd} data The data object
   */
  apply(request, data = {}) {
    ...
    data.v = CmcdManager.CmcdVersion;
   ...
   * @param {(!shaka.media.InitSegmentReference|!shaka.media.SegmentReference)}
   *   reference
   * @return {(shaka.util.CmcdManager.CmcdObjectType|undefined)}
   * @private
   */
  getObjectType_(mediaState, reference) {
    const CmcdObjectType = shaka.util.CmcdManager.CmcdObjectType;
   ...
   *
   * @param {shaka.util.CmcdManager.Cmcd} obj The CMCD data object
   * @return {string}
   */
   ...
   * [CTA-5004](https://cdn.cta.tech/cta/media/media/resources/standards/pdfs/cta-5004-final.pdf).
   *
   * @param {shaka.util.CmcdManager.Cmcd} cmcd The CMCD data object
   * @return {!Object}
   */
  static toHeaders(cmcd) {
    const headers = {};
    const shards = {
      object: ['br', 'd', 'ot', 'tb'],
    ...
    for (const entry of Object.entries(shards)) {
      ...
      const value = shaka.util.CmcdManager
   ...
   */
  static toQuery(cmcd) {
    return `CMCD=${encodeURIComponent(shaka.util.CmcdManager.serialize(cmcd))}`;
  }
};
 ...
 *   br: (number|undefined),
 *   d: (number|undefined),
 *   ot: (shaka.util.CmcdManager.CmcdObjectType|undefined),
 *   tb: (number|undefined),
 *   bl: (number|undefined),
 *   dl: (number|undefined),
 ...
 *   pr: (number|undefined),
 *   sf: (shaka.util.CmcdManager.CmcdStreamingFormat|undefined),
 *   sid: (string|undefined),
 *   st: (shaka.util.CmcdManager.CmcdStreamType|undefined),
 *   v: (number|undefined),
 ...
 *   value is not known.
 *
 * @property {shaka.util.CmcdManager.CmcdObjectType} ot
 ...
 *
 * @property {shaka.util.CmcdManager.CmcdStreamingFormat} sf
 ...
 *   specification.
 *
 * @property {shaka.util.CmcdManager.CmcdStreamType} st
 *   Stream type
 ...
 *   feature.
 */
shaka.util.CmcdManager.Cmcd;


/**
 * @enum {string}
 */
shaka.util.CmcdManager.CmcdObjectType = {
  MANIFEST: 'm',
  AUDIO: 'a',
  VIDEO: 'v',
  MUXED: 'av',
 ...
 * @enum {string}
 */
shaka.util.CmcdManager.CmcdStreamType = {
  VOD: 'v',
  LIVE: 'l',
};
 ...
 * @enum {string}
 */
shaka.util.CmcdManager.CmcdStreamingFormat = {
  DASH: 'd',
  HLS: 'h',
  SMOOTH: 's',
  OTHER: 'o',
 ...
 * @const {number}
 */
shaka.util.CmcdManager.CmcdVersion = 1;
