...
shaka.util.Mp4Parser = class {
  ...
  static audioSampleEntry(box) {
    ...
    // Skip 6 reserved bytes.
    // Skip 2-byte data reference index.
    // Skip 8 more reserved bytes.
    // Skip 2 bytes for channel count.
    // Skip 2 bytes for sample size.
    // Skip 4 more reserved bytes (0)
    // Skip 4 bytes for sample rate.
    // 28 bytes total.
    // See also https://github.com/shaka-project/shaka-packager/blob/d5ca6e84/packager/media/formats/mp4/box_definitions.cc#L1929
    box.reader.skip(28);
