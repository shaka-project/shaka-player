...
goog.provide('shaka.util.Mp4Box');
...
shaka.util.Mp4Parser.prototype.box = function(type, definition) {
  this.headers_[type] = shaka.util.Mp4Parser.BoxType_.BASIC_BOX;
  this.boxDefinitions_[type] = definition;
  return this;
};
...
shaka.util.Mp4Parser.prototype.fullBox = function(type, definition) {
  this.headers_[type] = shaka.util.Mp4Parser.BoxType_.FULL_BOX;
  this.boxDefinitions_[type] = definition;
  return this;
};
...
// TODO(google-vaage) Clean these up into either an enum or a string parameter
//                    that gets converted to an int internally.


/** @const {number} */
shaka.util.Mp4Box.IDEN = 0x6964656F;


/** @const {number} */
shaka.util.Mp4Box.MDAT = 0x6D646174;


/** @const {number} */
shaka.util.Mp4Box.MDHD = 0X6D646864;


/** @const {number} */
shaka.util.Mp4Box.MDIA = 0x6D646961;


/** @const {number} */
shaka.util.Mp4Box.MINF = 0x6D696E66;


/** @const {number} */
shaka.util.Mp4Box.MOOF = 0X6D6F6F66;


/** @const {number} */
shaka.util.Mp4Box.MOOV = 0x6D6F6F76;


/** @const {number} */
shaka.util.Mp4Box.PAYL = 0x7061796C;


/** @const {number} */
shaka.util.Mp4Box.STBL = 0x7374626C;


/** @const {number} */
shaka.util.Mp4Box.STSD = 0x73747364;


/** @const {number} */
shaka.util.Mp4Box.STTG = 0x73747467;


/** @const {number} */
shaka.util.Mp4Box.TFDT = 0x74666474;


/** @const {number} */
shaka.util.Mp4Box.TRAF = 0x74726166;


/** @const {number} */
shaka.util.Mp4Box.TRAK = 0x7472616B;


/** @const {number} */
shaka.util.Mp4Box.TRUN = 0x7472756E;
