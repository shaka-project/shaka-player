...
goog.provide('shaka.cea.Parser');

/**
 * Interface for parsing stream data.
 * @interface
 */
shaka.cea.Parser = class {
  /**
 ...
 * @const {number}
 */
shaka.cea.Parser.NALU_TYPE_SEI = 0x06;

/**
 * Default timescale value for a track.
 */
shaka.cea.Parser.DEFAULT_TIMESCALE_VALUE = 90000;
