...
shaka.cea.Cea708Window = class {
  ...
  forceEmit(endTime, serviceNumber) {
    ...
    const justificationEnum = shaka.cea.Cea708Window.TextJustification;
    const topLevelCue = new shaka.text.Cue(
        this.startTime_, endTime, /* payload= */ '');

    if (this.justification_ === justificationEnum.LEFT) {
      // LEFT justified.
      topLevelCue.textAlign = shaka.text.Cue.textAlign.LEFT;
    } else if (this.justification_ === justificationEnum.RIGHT) {
      // RIGHT justified.
