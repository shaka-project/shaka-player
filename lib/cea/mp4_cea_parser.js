...
shaka.cea.Mp4CeaParser = class {
  constructor() {
    ...
    /**
     * Cpation packets to return
     * @private {!Array<!shaka.cea.ICeaParser.CaptionPacket>}
     */
