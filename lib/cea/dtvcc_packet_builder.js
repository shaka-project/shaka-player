...
shaka.cea.DtvccPacketBuilder = class {
  ...
  build() {
     ...
     * @param {!shaka.cea.Cea708Service.Cea708Byte} ccPacket1
     * @param {!shaka.cea.Cea708Service.Cea708Byte} ccPacket2
     * @return {!number}
     */
        (ccPacket1, ccPacket2) => {
    ...
    // Keeps track of whether we just saw a packet start,
    // so the next byte isn't also considered a packet start.
