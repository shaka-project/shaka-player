...
goog.require('shaka.cea.CeaDecoderUtils.StyledChar');
...
shaka.cea.Cea608Memory = class {
  ...
  constructor(fieldNum, channelNum) {
     ...
     * @private @const {!Array<!Array<!shaka.cea.CeaDecoderUtils.StyledChar>>}
     */
    this.rows_ = [];
  ...
  forceEmit(startTime, endTime) {
    ...
    return shaka.cea.CeaDecoderUtils.getParsedCaption(
  ...
  addChar(set, b) {
    ...
    if (char) {
      const styledChar = new shaka.cea.CeaDecoderUtils.StyledChar(
