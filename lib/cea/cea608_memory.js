...
shaka.cea.Cea608Memory = class {
  ...
  forceEmit(startTime, endTime) {
    ...
    let currentCue = this.createStyledCue_(startTime, endTime, '', currentUnderline,
        currentItalics, currentTextColor, currentBackgroundColor);
   ...
   * @private
   */
  createStyledCue_(startTime, endTime, text, underline, italics,
      txtColor, bgColor) {
