...
shaka.cea.AtscDecoder = class {
  ...
  /**
   * Adds a new parsed caption to the current parsed captions list.
   * @param {!shaka.cea.ICaptionDecoder.ClosedCaption} closedCaption
   */
  addParsedClosedCaption(closedCaption) {
    this.parsedClosedCaptions_.push(closedCaption);
  }

  /**
   * @return {!Array<!shaka.cea.ICaptionDecoder.ClosedCaption>}
   */
  getParsedClosedCaptions() {
    return this.parsedClosedCaptions_;
  }

  /**
   * Clears any currently buffered parsed captions.
   */
  clearParsedClosedCaptions() {
    this.parsedClosedCaptions_ = [];
  }
  ...
  clear() {
    ...
    this.clearParsedClosedCaptions();
    this.reset();
  }
