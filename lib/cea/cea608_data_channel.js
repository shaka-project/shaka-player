...
shaka.cea.Cea608DataChannel = class {
  ...
  controlPac_(b1, b2) {
    ...
    // Set up the defaults.
    let textColor = shaka.cea.CeaDecoderUtils.DEFAULT_TXT_COLOR;
    let italics = false;
    ...
    this.curbuf_.setBackgroundColor(shaka.cea.CeaDecoderUtils.DEFAULT_BG_COLOR);
  }
  ...
  controlMidrow_(b2) {
    ...
    this.curbuf_.setTextColor(shaka.cea.CeaDecoderUtils.DEFAULT_TXT_COLOR);
  ...
  controlBackgroundAttribute_(b1, b2) {
    let backgroundColor = shaka.cea.CeaDecoderUtils.DEFAULT_BG_COLOR;
    if ((b1 & 0x07) === 0x0) {
