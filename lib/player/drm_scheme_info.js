...
/**
 * Describes a license request. This type of object is used by license request
 * pre-processors, see {@link shaka.player.DrmSchemeInfo#LicensePreProcessor}.
 *
 ...
 * <li>
 *   body: (ArrayBuffer|?string) <br>
 *   The license request's body.
 * <li>
 *   method: string (required) <br>
 *   The HTTP request method, which must be either 'GET' or 'POST'.
 * <li>
 *   headers: Object.<string, string> <br>
 ...
 * @expose
 */
shaka.player.DrmSchemeInfo.LicenseRequestInfo;


/**
 * A callback which does application-specific post-processing on license
 * responses before they are passed to the CDM. <br>
 *
 ...
 * requests before they are sent to the license server. <br>
 *
 * The parameter is a {@link shaka.player.DrmSchemeInfo.LicenseRequestInfo}
 ...
 *   license request pre-processor's corresponding DrmSchemeInfo; it may be set
 *   to an arbitrary URL, or may be extended with extra query parameters.
 *
 * <li>
 *   The |body| field is initially set to the raw license request (ArrayBuffer)
 *   emitted by the browser; it may be replaced (to another ArrayBuffer or
 *   string) or be removed entirely (e.g., if the server expects the raw
 *   license to be encoded in the URL).
 *
 * <li>
 ...
 *   may be added as key-value pairs, e.g., headers['my_header'] = 'foo';
 * </ul>
 *
