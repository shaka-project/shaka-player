...
/**
 * The amount of content that audio and video streams will buffer ahead of the
 * playhead, in seconds, after stream startup. Stream startup entails acquiring
 * some initial resources for each stream. For DASH audio and video streams,
 * startup completes when each stream buffers N seconds of content, where N
 * equals the 'minBufferTime' attribute from the MPD.
 *
 * @const {number}
 * @exportDoc
 */
