...
/**
 * The license request timeout in seconds.
 * @type {number}
 * @const
 */
...
/**
 * The MPD request timeout in seconds.
 * @type {number}
 * @const
 */
...
/**
 * The range request timeout in seconds. Range requests are used to
 * fetch metadata and media content.
 * @type {number}
 * @const
 */
shaka.player.Defaults.RANGE_REQUEST_TIMEOUT = 0;
