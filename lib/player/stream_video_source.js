...
shaka.player.StreamVideoSource.prototype.startStreams_ = function(
  ...
  if (this.video.readyState >= HTMLMediaElement.HAVE_METADATA) {
    ...
    this.eventManager.listen(this.video, 'loadedmetadata',
        this.setInitialCurrentTime_.bind(this, streamStartTime));
  }
 ...
 * @private
 */
shaka.player.StreamVideoSource.prototype.setInitialCurrentTime_ = function(
    streamStartTime) {
  this.video.currentTime = streamStartTime;
  this.eventManager.unlisten(this.video, 'loadedmetadata');
};
