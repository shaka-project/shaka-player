...
shaka.player.Player.prototype.load = function(videoSource) {
  ...
  return p.then(shaka.util.TypedBind(this,
      ...
      function() {
        ...
        this.eventManager_.listen(this.videoSource_, 'pleasebuffer',
                                  this.enterBufferingState_.bind(this));
...
/**
 * Called to enter a buffering state, either due to a 'pleasebuffer' event or
 * because of the watchdog's decision.
 * @private
 */
