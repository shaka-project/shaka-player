 ...
 * startup.
 *
 * Where startup consists of waiting until the streams have buffered some
 * minimum amount of content, which is determined by the VideoSource
 * implementation; for DASH content, the minimum buffer size is equal to the
 * 'minBufferTime' attribute from the MPD.
 *
