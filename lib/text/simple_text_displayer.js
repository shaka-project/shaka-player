...
shaka.text.SimpleTextDisplayer.prototype.removeWhere_ = function(predicate) {
  // Use a new version of textTrack.cues_ if one is available.
  // TODO: This is for a non-browser environment. Remove when possible.
  let cues = this.textTrack_.cues || this.textTrackCues_;
  this.textTrackCues_ = cues;
