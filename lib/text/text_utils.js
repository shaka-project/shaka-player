...
shaka.text.Utils = class {
  ...
  /**
   * @param {!VTTCue} vttCue
   * @param {number} defaultEnd
   * @return {!shaka.text.Cue}
   */
  static mapNativeCue(vttCue, defaultEnd) {
    const endTime = vttCue.endTime !== Infinity ? vttCue.endTime : defaultEnd;
    const cue = new shaka.text.Cue(vttCue.startTime, endTime, vttCue.text);
