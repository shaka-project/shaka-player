...
shaka.text.UITextDisplayer = class {
    ...
    if (this.isTextVisible_) {
      ...
      if (this.config_ &&
        ...
        for (const cue of this.cues_) {
          cues.push(this.processCueStyle_(cue));
        }
      }
  ...
  processCueStyle_(cue) {
    goog.asserts.assert(this.config_.positionArea !== PositionArea.DEFAULT, 'processCueStyle_ is intended to use on non default positioning');
