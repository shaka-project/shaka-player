...
describe('VttTextParser', () => {
  ...
  // Regression test #1 for PR https://github.com/shaka-project/shaka-player/pull/4767
  it('supports position setting according to text alignment', () => {
    verifyHelper(
        [
          {
            startTime: 10, endTime: 20, payload: 'Test', position: 50,
            positionAlign: Cue.positionAlign.LEFT,
          },
          {
            startTime: 25, endTime: 35, payload: 'Test2', position: 50,
            positionAlign: Cue.positionAlign.RIGHT,
          },
          {
            startTime: 40, endTime: 50, payload: 'Test3', position: 0,
            positionAlign: Cue.positionAlign.LEFT,
          },
          {
            startTime: 55, endTime: 65, payload: 'Test4', position: 100,
            positionAlign: Cue.positionAlign.RIGHT,
          },
          {
            startTime: 70, endTime: 80, payload: 'Test5', position: 50,
            positionAlign: Cue.positionAlign.CENTER,
          },
          {
            startTime: 85, endTime: 95, payload: 'Test6', position: 45,
            positionAlign: Cue.positionAlign.LEFT,
          },
          {
            startTime: 100, endTime: 110, payload: 'Test7', position: 45,
            positionAlign: Cue.positionAlign.RIGHT,
          },
        ],
        'WEBVTT\n\n' +
        '00:00:10.000 --> 00:00:20.000 align:start position:auto\n' +
        'Test\n\n' +
        '00:00:25.000 --> 00:00:35.000 align:end position:auto\n' +
        'Test2\n\n' +
        '00:00:40.000 --> 00:00:50.000 align:left position:auto\n' +
        'Test3\n\n' +
        '00:00:55.000 --> 00:01:05.000 align:right position:auto\n' +
        'Test4\n\n' +
        '00:01:10.000 --> 00:01:20.000 align:center position:auto\n' +
        'Test5\n\n' +
        '00:01:25.000 --> 00:01:35.000 align:start position:45%\n' +
        'Test6\n\n' +
        '00:01:40.000 --> 00:01:50.000 align:right position:45%\n' +
        'Test7\n\n',
        {periodStart: 0, segmentStart: 0, segmentEnd: 0, vttOffset: 0});
  });

  // Regression test #2 for PR https://github.com/shaka-project/shaka-player/pull/4767
  it('supports position alignment setting according to text alignment', () => {
    verifyHelper(
        [
          {
            startTime: 10, endTime: 20, payload: 'Test', position: 45,
            positionAlign: Cue.positionAlign.LEFT,
          },
          {
            startTime: 25, endTime: 35, payload: 'Test2', position: 12.3,
            positionAlign: Cue.positionAlign.RIGHT,
          },
          {
            startTime: 40, endTime: 50, payload: 'Test3', position: 45,
            positionAlign: Cue.positionAlign.RIGHT,
          },
          {
            startTime: 55, endTime: 65, payload: 'Test4', position: 12.3,
            positionAlign: Cue.positionAlign.LEFT,
          },
        ],
        'WEBVTT\n\n' +
        '00:00:10.000 --> 00:00:20.000 align:start position:45%,auto\n' +
        'Test\n\n' +
        '00:00:25.000 --> 00:00:35.000 align:right position:12.3%,auto\n' +
        'Test2\n\n' +
        '00:00:40.000 --> 00:00:50.000 align:start position:45%,line-right\n' +
        'Test3\n\n' +
        '00:00:55.000 --> 00:01:05.000 align:right position:12.3%,line-left\n' +
        'Test4\n\n',
        {periodStart: 0, segmentStart: 0, segmentEnd: 0, vttOffset: 0});
  });
