...
describe('HlsParser', () => {
  ...
  it('includes rebuilt segments in mergeAndEvict on live update', async () => {
    // Regression test for #9998 which skipped merging already-known segments
    // on live playlist updates. In LL-HLS, a segment's partial references
    ...
    // Initial live playlist: last segment has 2 partials.
    const initialMedia = [
      '#EXTM3U\n',
      '#EXT-X-TARGETDURATION:5\n',
      ...
      '#EXTINF:5,\n',
      'main.mp4\n',
      '#EXT-X-PART:DURATION=1.0,URI="main.mp4"\n',
      '#EXT-X-PART:DURATION=1.0,URI="main.mp4"\n',
      '#EXTINF:5,\n',
      'main.mp4\n',
    ].join('');
    ...
    // Updated playlist: same segments, but the last one now has 4 partials.
    const updatedMedia = [
      '#EXTM3U\n',
      '#EXT-X-TARGETDURATION:5\n',
      '#EXT-X-MEDIA-SEQUENCE:100\n',
    ...
    fakeNetEngine.setResponseText('test:/video', updatedMedia);
    await parser.update();
