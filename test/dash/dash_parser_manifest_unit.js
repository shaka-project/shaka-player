...
describe('DashParser Manifest', () => {
  ...
  it('ignores duplicate Representation IDs for VOD', async () => {
    ...
    expect(variant1Ref.getUris()).toEqual(['http://foo/1.mp4']);
    expect(variant2Ref.getUris()).toEqual(['http://foo/2.mp4']);
  });
  ...
  it('supports dvb fonts', async () => {
    ...
    expect(addFontSpy).toHaveBeenCalledWith('foo', 'http://foo/foo.woff');
  ...
  describe('supports flexible insertion of URL parameters', () => {
    it('with SegmentList', async () => {
      ...
      expect(variant1Ref.getUris()).toEqual(['http://foo/s1.mp4?a=1&b=1']);
      expect(variant1Ref.initSegmentReference.getUris())
          .toEqual(['http://foo/init.mp4?a=1&b=1']);
    });
    ...
    it('with SegmentTemplate', async () => {
      ...
      expect(variant1Ref.getUris()).toEqual(['http://foo/l-1.mp4?a=1']);
      expect(variant1Ref.initSegmentReference.getUris())
          .toEqual(['http://foo/init.mp4?a=1']);
    });
    ...
    it('with SupplementalProperty in Representation', async () => {
      ...
      expect(variant1Ref.getUris()).toEqual(['http://foo/l-1.mp4?a=1&b=foo']);
      expect(variant1Ref.initSegmentReference.getUris())
          .toEqual(['http://foo/init.mp4?a=1&b=foo']);
    });
