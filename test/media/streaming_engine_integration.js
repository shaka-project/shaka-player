...
describe('StreamingEngine', () => {
  ...
  describe('gap jumping', () => {
    ...
    it('jumps small gaps at the beginning with stallSkip = 0', async () => {
      config.stallSkip = 0;
      await setupGappyContent(/* gapAtStart= */ 1, /* dropSegment= */ false);
    ...
    it('jumps large gaps at the beginning with stallSkip = 0', async () => {
      config.stallSkip = 0;
      await setupGappyContent(/* gapAtStart= */ 5, /* dropSegment= */ false);
    ...
    it('jumps small gaps in the middle with stallSkip = 0', async () => {
      config.stallSkip = 0;
      await setupGappyContent(/* gapAtStart= */ 0, /* dropSegment= */ true);
    ...
    it('jumps large gaps in the middle with stallSkip = 0', async () => {
      config.stallSkip = 0;
      await setupGappyContent(/* gapAtStart= */ 0, /* dropSegment= */ true);
