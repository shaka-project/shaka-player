...
check `chrome://media-internals` for more info (see {@link 
https://github.com/google/shaka-player/issues/489#issuecomment-240466224|
#489(comment)}).
...
See discussion in {@link https://github.com/google/shaka-player/issues/1667|
#1667} for details.
...
We have another project called {@link 
https://github.com/google/shaka-player-embedded|Shaka Player Embedded} that 
offers the same features and similar APIs for native apps on iOS. This 
project uses its own media stack, which allows it to play content that 
would otherwise not be supported.  This supports both DASH and HLS manifests.
