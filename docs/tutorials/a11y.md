...
All Shaka-provided UI elements follow the {@link https://www.w3.org/WAI/standards-guidelines/wcag/|
Web Accessibility Standards}, meaning that people who use screen readers to surf the web still get 
their full functionality even though they might not be able to see the elements.
