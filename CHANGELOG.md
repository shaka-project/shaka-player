...
* Restore correct playhead position after MediaSource reload ([#10335](https://github.com/shaka-project/shaka-player/issues/10335)) ([e0be373](https://github.com/shaka-project/shaka-player/commit/e0be3730160bf438a31f9351b83cd871cf601813))
* Retry the stall-breaking action when a stall persists ([#10327](https://github.com/shaka-project/shaka-player/issues/10327)) ([134d29e](https://github.com/shaka-project/shaka-player/commit/134d29e4aebb5e6d670edd7873c0eec0404ffcfd))
* Support negative playback rate (reverse trick play) correctly ([#10323](https://github.com/shaka-project/shaka-player/issues/10323)) ([6e2bb04](https://github.com/shaka-project/shaka-player/commit/6e2bb04baf2ac4f0adcd8ef7eb90f059e74209b1))
* **TS:** Fix timestamps when a segment straddles the 33-bit PTS/DTS rollover ([#10324](https://github.com/shaka-project/shaka-player/issues/10324)) ([92e3bb2](https://github.com/shaka-project/shaka-player/commit/92e3bb2321a692d1bf3276c8584a8fcc734fdce5))
...
* **text:** use valid CSS value 'line-through' for LINE_THROUGH ([#10249](https://github.com/shaka-project/shaka-player/issues/10249)) ([a21f501](https://github.com/shaka-project/shaka-player/commit/a21f5019671508dee70c8911a097d774686496b8))
* **UI:** Add mute_volume composite element to fix hover jank between mute button and volume bar ([#10214](https://github.com/shaka-project/shaka-player/issues/10214)) ([93b7d5a](https://github.com/shaka-project/shaka-player/commit/93b7d5a6e69540426591efdb720d28fc6bfd6114))
...
* Avoid hang when loading a new asset after DRM playback ([#10239](https://github.com/shaka-project/shaka-player/issues/10239)) ([8a6abb9](https://github.com/shaka-project/shaka-player/commit/8a6abb93a88bd775ea9735d5d25d1e66f848db71))
...
* Fix XML node attribute externs ([#10111](https://github.com/shaka-project/shaka-player/issues/10111)) ([b8e7de1](https://github.com/shaka-project/shaka-player/commit/b8e7de16d132bcb2b49353232db278823d4af422))
* Map the "audio/x-mpegurl" MIME type as HLS ([#10114](https://github.com/shaka-project/shaka-player/issues/10114)) ([0f4c137](https://github.com/shaka-project/shaka-player/commit/0f4c137467077a305b609e5df0ce4f0179fe260f))
* **UI:** Fix blurry seek bar marks ([#10097](https://github.com/shaka-project/shaka-player/issues/10097)) ([2135690](https://github.com/shaka-project/shaka-player/commit/2135690051a9173af74d534242a2eca405024cc7))


### Performance Improvements

* **transmuxer:** Write nalu lengths directly into combined buffer in h265 ([#10119](https://github.com/shaka-project/shaka-player/issues/10119)) ([7aa64ce](https://github.com/shaka-project/shaka-player/commit/7aa64cebc3152ae43949f751f2b0cf14922a99a2))
...
* **UI:** check if ad is linear before updating mute label and icon ([#10044](https://github.com/shaka-project/shaka-player/issues/10044)) ([cb8724a](https://github.com/shaka-project/shaka-player/commit/cb8724a406fe18658749a1a572eba42f29f89d4d))


### Performance Improvements

* **DASH:** lazy segment reference creation ([#10050](https://github.com/shaka-project/shaka-player/issues/10050)) ([24c9c99](https://github.com/shaka-project/shaka-player/commit/24c9c999f7bd965ca3c7c1d7d5c2dc5bf152a0f2))
* Remove unnecessary Uint8ArrayUtils.concat calls in Mp4Generator ([#10047](https://github.com/shaka-project/shaka-player/issues/10047)) ([4bcc188](https://github.com/shaka-project/shaka-player/commit/4bcc188929fa422cee14d8445002dede4b38bd1a))
* **transmuxer:** Merge consecutive Uint8Arrays in h265 transmuxer ([#10046](https://github.com/shaka-project/shaka-player/issues/10046)) ([d9075a7](https://github.com/shaka-project/shaka-player/commit/d9075a722c9148115236ea7330ab08f9612915d3))
...
* Honors streaming.retryParameters for segments ([#9796](https://github.com/shaka-project/shaka-player/issues/9796)) ([6994617](https://github.com/shaka-project/shaka-player/commit/6994617679a44b419bd3f0bfa81795fd102e477c))
* Improve NativeTextDisplayer robustness, track-kind issues and enhance cleanup logic ([#9776](https://github.com/shaka-project/shaka-player/issues/9776)) ([e2ff716](https://github.com/shaka-project/shaka-player/commit/e2ff71678fa17b2f603e6e43ec8b595be6edd924))
* **MSF:** fix namespace tuple encoding in SUBSCRIBE message ([#9803](https://github.com/shaka-project/shaka-player/issues/9803)) ([41a7e94](https://github.com/shaka-project/shaka-player/commit/41a7e94f6ca4bdd27a60c58098164886ea210719))
* **MSF:** move catalog typedefs to externs to prevent property mangling ([#9804](https://github.com/shaka-project/shaka-player/issues/9804)) ([32a011e](https://github.com/shaka-project/shaka-player/commit/32a011e9d70d04f15f5ea545a709dc1a97ff4839))
* **MSF:** support draft-14 SubgroupHeader types (0x10-0x1D) ([#9802](https://github.com/shaka-project/shaka-player/issues/9802)) ([4f5355b](https://github.com/shaka-project/shaka-player/commit/4f5355b19988464914f205bbdd8e488784e8f4ab))
* prevent negative times in Stats ([#9784](https://github.com/shaka-project/shaka-player/issues/9784)) ([bf8ca93](https://github.com/shaka-project/shaka-player/commit/bf8ca93da5719b815d78ecb5cc26d7e302dc750c))
* Set IntersectionObserver root to null (document not supported in Chrome 63) ([#9782](https://github.com/shaka-project/shaka-player/issues/9782)) ([be89e9a](https://github.com/shaka-project/shaka-player/commit/be89e9a5669c3efeda5d979c438f44c4e2d668e0))
* **tXml:** Return default value for a missing attribute ([#9734](https://github.com/shaka-project/shaka-player/issues/9734)) ([310c586](https://github.com/shaka-project/shaka-player/commit/310c586825931292a5f01b3068f0e8b57fe69691))


### Performance Improvements

* Eliminate DataViewReader allocation and use native clz32 in ExpGolomb ([#9779](https://github.com/shaka-project/shaka-player/issues/9779)) ([1468e36](https://github.com/shaka-project/shaka-player/commit/1468e36a8206f45c307160077ddc1739152f8dc6))
* Improve performance of TsParser ([#9783](https://github.com/shaka-project/shaka-player/issues/9783)) ([308bb72](https://github.com/shaka-project/shaka-player/commit/308bb724e2f5b4bbfc617de124fe58c7cfdc592e))
* Remove redundant base64/xml conversions in PlayReady ([#9778](https://github.com/shaka-project/shaka-player/issues/9778)) ([9e44b72](https://github.com/shaka-project/shaka-player/commit/9e44b722e41c4024c119f79d3aa29f7865af1717))
