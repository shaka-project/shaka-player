...
* **net:** Avoid dropping low-latency segments when a retried request succeeds ([#10646](https://github.com/shaka-project/shaka-player/issues/10646)) ([1545966](https://github.com/shaka-project/shaka-player/commit/1545966a5ab6cff01223db2619f984c04a4901e5))
* Prevent destroy() from hanging when playback is wedged ([#10624](https://github.com/shaka-project/shaka-player/issues/10624)) ([00bc821](https://github.com/shaka-project/shaka-player/commit/00bc82147ad78adac27bc66b77772aaa998752d9)), closes [#10623](https://github.com/shaka-project/shaka-player/issues/10623)
* **WebVTT:** Parse every fragment of a multi-fragment MP4 segment ([#10642](https://github.com/shaka-project/shaka-player/issues/10642)) ([514e7b9](https://github.com/shaka-project/shaka-player/commit/514e7b91cddefcfac64db3578f02e56270bae2de))
...
* **Mp4Parser:** Don't hang on a 64-bit largesize of 0 ([#10548](https://github.com/shaka-project/shaka-player/issues/10548)) ([747f0e7](https://github.com/shaka-project/shaka-player/commit/747f0e7a9991f2eca267d53501526a65ba17379c)), closes [#10542](https://github.com/shaka-project/shaka-player/issues/10542)
* Prevent infinite loop on zero-length WVTT payload box ([#10565](https://github.com/shaka-project/shaka-player/issues/10565)) ([bf71114](https://github.com/shaka-project/shaka-player/commit/bf71114de00e2eb2d9e2dc15d42be0c61914e03f)), closes [#10561](https://github.com/shaka-project/shaka-player/issues/10561)
...
* **DASH:** Live to VOD transition with multi period start not at 0 ([#10480](https://github.com/shaka-project/shaka-player/issues/10480)) ([e60c095](https://github.com/shaka-project/shaka-player/commit/e60c0957d0bdcf454f7c55ac04271f6d1805c58b))
* **Transmux:** Support audio-only MPEG-TS renditions labeled 'labeled 'audio/mp2t' ([#10473](https://github.com/shaka-project/shaka-player/issues/10473)) ([6c94422](https://github.com/shaka-project/shaka-player/commit/6c94422e38d7040e11df6be2e21d2ec403fec2b2))
* **TS:** Fix slice_type parsing in multi-slice H.264 frames ([#10477](https://github.com/shaka-project/shaka-player/issues/10477)) ([784b1d9](https://github.com/shaka-project/shaka-player/commit/784b1d9df7166bd40834fd0bc07aca63dfdf0058)), closes [#10468](https://github.com/shaka-project/shaka-player/issues/10468)

## [4.15.57](https://github.com/shaka-project/shaka-player/compare/v4.15.56...v4.15.57) (2026-08-21)


### Bug Fixes

* Avoid quadratic copying of prefetched segment data ([#10448](https://github.com/shaka-project/shaka-player/issues/10448)) ([40e50ce](https://github.com/shaka-project/shaka-player/commit/40e50ce59a1839a371519bb0a0bf700a50d39c60)), closes [#10446](https://github.com/shaka-project/shaka-player/issues/10446)
* **offline:** Close the database when another connection needs it ([#10435](https://github.com/shaka-project/shaka-player/issues/10435)) ([3587ec3](https://github.com/shaka-project/shaka-player/commit/3587ec38ce1b99f7b481732549a9a149f2020d84))
* **offline:** Don't leak an IndexedDB connection ([#10434](https://github.com/shaka-project/shaka-player/issues/10434)) ([e1a18ce](https://github.com/shaka-project/shaka-player/commit/e1a18ce2282a94ffe4d1ea5470267bde8a6bd7ab))
* **test:** Skip Widevine tests on Edge with a revoked device certificate ([#10449](https://github.com/shaka-project/shaka-player/issues/10449)) ([58fb31c](https://github.com/shaka-project/shaka-player/commit/58fb31cced0c7808e15cdcae02074d06620f84cb)), closes [#10442](https://github.com/shaka-project/shaka-player/issues/10442)

## [4.15.56](https://github.com/shaka-project/shaka-player/compare/v4.15.55...v4.15.56) (2026-08-15)


### Bug Fixes

* Avoid re-downloading init segments on unbuffered seek ([#10428](https://github.com/shaka-project/shaka-player/issues/10428)) ([d0cb990](https://github.com/shaka-project/shaka-player/commit/d0cb990abff175021ea30fb63f1c00b72ded4d86)), closes [#10373](https://github.com/shaka-project/shaka-player/issues/10373)
* Fix stuck playback on multiplexed TS content ([#10431](https://github.com/shaka-project/shaka-player/issues/10431)) ([ec71a82](https://github.com/shaka-project/shaka-player/commit/ec71a8210ba8cef4b54c936729c376d7b397b0ec))
...
* Retry the stall-breaking action when a stall persists ([#10327](https://github.com/shaka-project/shaka-player/issues/10327)) ([9465674](https://github.com/shaka-project/shaka-player/commit/9465674eae666d84c0e5661d1321a2d7ea75a8c7))
* **TS:** Fix timestamps when a segment straddles the 33-bit PTS/DTS rollover ([#10324](https://github.com/shaka-project/shaka-player/issues/10324)) ([1c6cc79](https://github.com/shaka-project/shaka-player/commit/1c6cc79350775c619b41a9f864cd26fd6ce70dbb))
...
* Correct device detection for PlayStation 4 Pro to enable 4K resolution ([#10269](https://github.com/shaka-project/shaka-player/issues/10269)) ([ea9f514](https://github.com/shaka-project/shaka-player/commit/ea9f51460211ae79c475ee0d16eba96c48635c39))
...
* Avoid race condition in concurrent getAllThumbnails calls ([#10022](https://github.com/shaka-project/shaka-player/issues/10022)) ([d7d69ea](https://github.com/shaka-project/shaka-player/commit/d7d69ea670a5769ca78ba6d6c97cbdea1d185183))
* **text:** include regionAnchorX/Y in region cache key ([#10073](https://github.com/shaka-project/shaka-player/issues/10073)) ([209f0fb](https://github.com/shaka-project/shaka-player/commit/209f0fb3b6386282b9cd1f2b4e70205d85547422))


### Performance Improvements

* **media:** replace slice with in-place array truncation ([#10070](https://github.com/shaka-project/shaka-player/issues/10070)) ([490567c](https://github.com/shaka-project/shaka-player/commit/490567cba67eabb058597157aa55fe0ddcdaf9e2))

## [4.15.42](https://github.com/shaka-project/shaka-player/compare/v4.15.41...v4.15.42) (2026-05-04)


### Performance Improvements

* **DASH:** lazy segment reference creation ([#10050](https://github.com/shaka-project/shaka-player/issues/10050)) ([6a3e89e](https://github.com/shaka-project/shaka-player/commit/6a3e89e96a53e231a4413c83aa75c609ef85de05))
* Remove unnecessary Uint8ArrayUtils.concat calls in Mp4Generator ([#10047](https://github.com/shaka-project/shaka-player/issues/10047)) ([5a0ec3e](https://github.com/shaka-project/shaka-player/commit/5a0ec3e64c4bff8a7cfdb90ea84dd9847aa7e9e0))
...
* Fix MIME type detection for uppercase types ([#9976](https://github.com/shaka-project/shaka-player/issues/9976)) ([e62e4c7](https://github.com/shaka-project/shaka-player/commit/e62e4c70ab69efe6ff4878574a066af03a734b8e))
* include unencrypted decodingConfigs in preferredKeySystems loop ([#9975](https://github.com/shaka-project/shaka-player/issues/9975)) ([d95dddb](https://github.com/shaka-project/shaka-player/commit/d95dddb301315217d4dac8b28199f8db559afbd5))
* Limit recursion depth in TXml to prevent stack overflow DoS ([#9964](https://github.com/shaka-project/shaka-player/issues/9964)) ([8ff2f13](https://github.com/shaka-project/shaka-player/commit/8ff2f1324c76c0d9e66b4c3aae8bfc61f01c0e4f))


### Performance Improvements

* **transmuxer:** Reduce allocations in the h264 transmuxer ([#9963](https://github.com/shaka-project/shaka-player/issues/9963)) ([f5a68a6](https://github.com/shaka-project/shaka-player/commit/f5a68a6514c7ca7f2d7ed116a1d6025bc79a2f80))
...
* **HLS:** Add support for DTS and DTS-HD audio codec variants ([#9863](https://github.com/shaka-project/shaka-player/issues/9863)) ([f119954](https://github.com/shaka-project/shaka-player/commit/f11995449e9c93b03a242ddb701d71a97adb7322))
* **HLS:** Prevent infinite manifest update delay ([#9867](https://github.com/shaka-project/shaka-player/issues/9867)) ([0a03ac3](https://github.com/shaka-project/shaka-player/commit/0a03ac3383f6a1be5875870f6bccba30b39e8241))
* Increase tolerance for duplicate segment detection ([#9865](https://github.com/shaka-project/shaka-player/issues/9865)) ([67bdc27](https://github.com/shaka-project/shaka-player/commit/67bdc27c13fba6ff283c9288df570b9cf9acdd95))
* **util:** Add support for MPEG-2 video codec ([#9860](https://github.com/shaka-project/shaka-player/issues/9860)) ([04d7bd7](https://github.com/shaka-project/shaka-player/commit/04d7bd7937e9030347bf7bf7d278b4c2e1bb8bf5))


### Performance Improvements

* **DASH:** loop over adaptation sets using the partition method ([#9862](https://github.com/shaka-project/shaka-player/issues/9862)) ([b59ba35](https://github.com/shaka-project/shaka-player/commit/b59ba354aee82eabe0cba40adb2b23c4d5cb1aa3))
* **HLS:** parse tag string directly instead of creating an array ([#9856](https://github.com/shaka-project/shaka-player/issues/9856)) ([ac89f9a](https://github.com/shaka-project/shaka-player/commit/ac89f9a72dd39fa82510d378b589ec790d4c3ce9))
* **HLS:** reduce GC pressure when parsing HLS manifest tags ([#9857](https://github.com/shaka-project/shaka-player/issues/9857)) ([99322cd](https://github.com/shaka-project/shaka-player/commit/99322cdbf980cc5ad5a00eed245c947960eb16de))
* **net:** avoid array allocations in XHR header parsing to reduce GC pressure ([#9874](https://github.com/shaka-project/shaka-player/issues/9874)) ([ac6c787](https://github.com/shaka-project/shaka-player/commit/ac6c787b20aa6353efc24d4923f10a99cbe24b68))
* **player:** stop recreating functions on video time update ([#9854](https://github.com/shaka-project/shaka-player/issues/9854)) ([0671a7d](https://github.com/shaka-project/shaka-player/commit/0671a7d9cd6cc5f0185e1f49f8d5518b4da7e506))
* **Transmuxer:** replace identical object literals with named constants ([#9852](https://github.com/shaka-project/shaka-player/issues/9852)) ([e5b3951](https://github.com/shaka-project/shaka-player/commit/e5b3951621f10ba3b2626546c39de977d88e539b))
* **VTT:** reduce GC pressure in VTT text parser ([#9869](https://github.com/shaka-project/shaka-player/issues/9869)) ([3f5840b](https://github.com/shaka-project/shaka-player/commit/3f5840be0747a2f94af9ec843b58fe6cf724623f))
...
* **UI:** sync seek position with hover timestamp using consistent position calculation ([#9818](https://github.com/shaka-project/shaka-player/issues/9818)) ([567aa1d](https://github.com/shaka-project/shaka-player/commit/567aa1d02071a6b82f951b3288aca0c9aff667a1))


### Performance Improvements

* **DASH:** Add period caching to speed up manifest parsing ([#9353](https://github.com/shaka-project/shaka-player/issues/9353)) ([67363ad](https://github.com/shaka-project/shaka-player/commit/67363adee7593e068b0951e342aabd5ecf0b29db))
* **net:** Optimize getExtension URI parsing ([#9816](https://github.com/shaka-project/shaka-player/issues/9816)) ([69256ed](https://github.com/shaka-project/shaka-player/commit/69256ed3d9a032e11f2a31e69f10a7766eb859b1))

## [4.15.33](https://github.com/shaka-project/shaka-player/compare/v4.15.32...v4.15.33) (2026-03-09)
...
* Fix CryptoKey definition ([#9686](https://github.com/shaka-project/shaka-player/issues/9686)) ([c846b37](https://github.com/shaka-project/shaka-player/commit/c846b3738eaba469b9dcbfb45ce03f043d6d595d))
* Fix video freezes when seeking to the end when the audio and video duration are slightly different ([#9695](https://github.com/shaka-project/shaka-player/issues/9695)) ([0046f52](https://github.com/shaka-project/shaka-player/commit/0046f5217c0e30a73d1005077172a7cc898ccc15))
* **UI:** fix presentation time display when display time is larger than duration ([#9712](https://github.com/shaka-project/shaka-player/issues/9712)) ([1827710](https://github.com/shaka-project/shaka-player/commit/182771045823ac4e7d1388f6918b404cd73f3262)), closes [#9711](https://github.com/shaka-project/shaka-player/issues/9711)
* Validate that mediaElement.getStartDate returns a Date ([#9701](https://github.com/shaka-project/shaka-player/issues/9701)) ([a3dfe32](https://github.com/shaka-project/shaka-player/commit/a3dfe3291c267b01922bf74ff128eb92fb2cc4cc))
...
* **ABR:** Safeguard calls to this.switch_ ([#9565](https://github.com/shaka-project/shaka-player/issues/9565)) ([40a5e8d](https://github.com/shaka-project/shaka-player/commit/40a5e8d72f669feb920d2d902117d50340ea6904))
* don't clear text displayer cache for vtt if we're clearing cea cache ([#9538](https://github.com/shaka-project/shaka-player/issues/9538)) ([646d117](https://github.com/shaka-project/shaka-player/commit/646d1174521149e160ddd86c61dd7a4fdbb39dcd))
* Fix alignItems usage on old devices ([#9544](https://github.com/shaka-project/shaka-player/issues/9544)) ([04b9b39](https://github.com/shaka-project/shaka-player/commit/04b9b391f64e0f5fa403360333487289d82790c6))
* **Thumbnails:** Fix thumbnails precision issues ([#9536](https://github.com/shaka-project/shaka-player/issues/9536)) ([ea9f88b](https://github.com/shaka-project/shaka-player/commit/ea9f88b4076408d55f105d8d22805bc9452eef4a))
* **Transmuxer:** Keep stream width/height if it already exists ([#9553](https://github.com/shaka-project/shaka-player/issues/9553)) ([b9f3891](https://github.com/shaka-project/shaka-player/commit/b9f38911486f37da4167fdc22395a522050c352d))
* **TTML:** Fix MP4 TTML Parser producing invalid image subtitles ([#9559](https://github.com/shaka-project/shaka-player/issues/9559)) ([a1bb5c1](https://github.com/shaka-project/shaka-player/commit/a1bb5c16b357f31bd26054d1221919c1b924b51e))


### Performance Improvements

* Use Map.getOrInsert/getOrInsertComputed native methods ([#9546](https://github.com/shaka-project/shaka-player/issues/9546)) ([ec9226b](https://github.com/shaka-project/shaka-player/commit/ec9226b4d4aa5e25d004eac3ad95a710cd7b5c50))

## [4.15.25](https://github.com/shaka-project/shaka-player/compare/v4.15.24...v4.15.25) (2025-12-22)


### Bug Fixes

* Fix external text track timing when using HLS ([#9511](https://github.com/shaka-project/shaka-player/issues/9511)) ([5d2b11f](https://github.com/shaka-project/shaka-player/commit/5d2b11fa434b5876dfc30a4c02774494ccbc65e6))
* **HLS:** Support playback with gaps ([#9506](https://github.com/shaka-project/shaka-player/issues/9506)) ([01f261f](https://github.com/shaka-project/shaka-player/commit/01f261f967411061483ac2e33acb3ef86951e0ae))
* Prefer disableStream over create a gap when a segment is missing ([#9516](https://github.com/shaka-project/shaka-player/issues/9516)) ([bdaf1bb](https://github.com/shaka-project/shaka-player/commit/bdaf1bbeb2fd94ee0a9b138e050ab8dd66e0659e))
...
* Fix default modifyCueCallback config ([#9322](https://github.com/shaka-project/shaka-player/issues/9322)) ([dad5b05](https://github.com/shaka-project/shaka-player/commit/dad5b05b048a44e85234532e846090936c619162))
* Fix infinite evict loop on text unload ([#9331](https://github.com/shaka-project/shaka-player/issues/9331)) ([760d192](https://github.com/shaka-project/shaka-player/commit/760d1929ace7ac31ac49b43ea5ea35b26962342a))
* **UI:** Support non-square pixels in getResolutionLabel_ ([#9300](https://github.com/shaka-project/shaka-player/issues/9300)) ([347f895](https://github.com/shaka-project/shaka-player/commit/347f89555097d12e124adda7c192dcfc2bbeb752))
* **WebVTT:** Fix times when using HLS without X-TIMESTAMP-MAP ([#9313](https://github.com/shaka-project/shaka-player/issues/9313)) ([9689774](https://github.com/shaka-project/shaka-player/commit/968977474069e3a484f03438910354c907bd86b1))
...
* Allow calculate the segment size from partials segments ([#9094](https://github.com/shaka-project/shaka-player/issues/9094)) ([216f354](https://github.com/shaka-project/shaka-player/commit/216f354dccaf7a8a2716df35e61ab1a7aff4d4e5))
* Avoid null pointer exception on MSE reset ([#9089](https://github.com/shaka-project/shaka-player/issues/9089)) ([fe4ba68](https://github.com/shaka-project/shaka-player/commit/fe4ba685881b00d89dbc06e164bedd00e47f8950))
* Bad init segment size calculation when using byte ranges ([#9092](https://github.com/shaka-project/shaka-player/issues/9092)) ([6e56e4e](https://github.com/shaka-project/shaka-player/commit/6e56e4e61ae70f6d0726dd3f2decf74e3f00dc09))
* Bad segment size calculation when using byte ranges ([#9090](https://github.com/shaka-project/shaka-player/issues/9090)) ([ebb92d0](https://github.com/shaka-project/shaka-player/commit/ebb92d0263b2316aa47cffbbd5ae23ce4329de50))
* Fix audio/video bandwidth calculation when only one of them is provided ([#9091](https://github.com/shaka-project/shaka-player/issues/9091)) ([2e8ab29](https://github.com/shaka-project/shaka-player/commit/2e8ab297f6edf321d6be6694ec128d84a801fd41))
* Fix blink subtitles when using NativeTextDisplayer in Safari ([#9082](https://github.com/shaka-project/shaka-player/issues/9082)) ([357d85b](https://github.com/shaka-project/shaka-player/commit/357d85bc9b045a80376fd981dd56b213ef435fc5))
* Fix getLiveLatency when using Apple's native HLS ([#9083](https://github.com/shaka-project/shaka-player/issues/9083)) ([212d150](https://github.com/shaka-project/shaka-player/commit/212d1508d4436affc3b44029281fb243c1c812ee))
* **HLS:** Allow calculate stream bandwidth using segment size ([#9093](https://github.com/shaka-project/shaka-player/issues/9093)) ([fd0820d](https://github.com/shaka-project/shaka-player/commit/fd0820dc43dc0de4ac287ae67ee9eec19f974622))


### Performance Improvements

* **Ads:** Improve back to live performance when using interstitials and low latency ([#9079](https://github.com/shaka-project/shaka-player/issues/9079)) ([6ae8653](https://github.com/shaka-project/shaka-player/commit/6ae8653ed324852d262821c1c4a2f5844fc38194))
* **HLS:** Assume that partial segments have the same mimetype as full segments ([#9080](https://github.com/shaka-project/shaka-player/issues/9080)) ([83e835d](https://github.com/shaka-project/shaka-player/commit/83e835d4c902e49c8feeaa930227dd16b38d1625))
* Speed up `shaka.Player.probeSupport()` ([#9095](https://github.com/shaka-project/shaka-player/issues/9095)) ([ed2e7d8](https://github.com/shaka-project/shaka-player/commit/ed2e7d867eeb8ec30b29d4ba96885fa68ad4af9d))
