...
* **Demo:** Avoid requesting missing UI locales repeatedly ([#10610](https://github.com/shaka-project/shaka-player/issues/10610)) ([9264af8](https://github.com/shaka-project/shaka-player/commit/9264af8af7db209bc61c372e77fe36f520bd8d1d))
* enforce paused state when seeking from ended state ([#10579](https://github.com/shaka-project/shaka-player/issues/10579)) ([a64c992](https://github.com/shaka-project/shaka-player/commit/a64c992aaca437d6ac46c56fef05f592f3236ad6)), closes [#10410](https://github.com/shaka-project/shaka-player/issues/10410)
* **HLS:** Add missing AV2 video codec detection ([#10594](https://github.com/shaka-project/shaka-player/issues/10594)) ([f258442](https://github.com/shaka-project/shaka-player/commit/f2584425fc667b1695883e807ca152ea8d8b61f7))
* **HLS:** Avoid TypeError when a media playlist fails during load() ([#10560](https://github.com/shaka-project/shaka-player/issues/10560)) ([64a7244](https://github.com/shaka-project/shaka-player/commit/64a72441218901bc35a165a0abd16e4fbd6f9e74))
* Keep captions working when periods disagree on caption vs subtitle ([#10600](https://github.com/shaka-project/shaka-player/issues/10600)) ([de583ec](https://github.com/shaka-project/shaka-player/commit/de583ec71359bf5dea4e75e5426f2244c12fab73)), closes [#10599](https://github.com/shaka-project/shaka-player/issues/10599)
...
* **offline:** Avoid DRM license removal failure ([#10510](https://github.com/shaka-project/shaka-player/issues/10510)) ([35d2e26](https://github.com/shaka-project/shaka-player/commit/35d2e26c7f09a7428c5240a9467d779b9d9b0753))
* **offline:** Avoid orphaned DRM sessions on removal failure ([#10511](https://github.com/shaka-project/shaka-player/issues/10511)) ([35f2c8b](https://github.com/shaka-project/shaka-player/commit/35f2c8bcfbdc4c1257094348e756da26814340f0))
* Release XHR handlers once the request is done ([#10506](https://github.com/shaka-project/shaka-player/issues/10506)) ([aada411](https://github.com/shaka-project/shaka-player/commit/aada411e627b59cbd7f1a2cc92e2fcd01e21a9af))
* **Transmuxer:** Fix infinite loop and dropped frames in MPEG audio ([#10529](https://github.com/shaka-project/shaka-player/issues/10529)) ([7699d16](https://github.com/shaka-project/shaka-player/commit/7699d16f7b6ef3734b41b85e55ea490f945e5f80))
...
* **HLS:** Detect audio-only raw content when CODECS is missing ([#10399](https://github.com/shaka-project/shaka-player/issues/10399)) ([2c4ed7e](https://github.com/shaka-project/shaka-player/commit/2c4ed7ef38a5733346a99b4c5d5603eda5f545d9))

## [4.16.42](https://github.com/shaka-project/shaka-player/compare/v4.16.41...v4.16.42) (2026-07-20)


### Bug Fixes

* Prevent screen.orientation methods from being garbage collected on Safari ([#10364](https://github.com/shaka-project/shaka-player/issues/10364)) ([671d343](https://github.com/shaka-project/shaka-player/commit/671d343e298e745e62d6dcf70e177fa262de73c5))
* **security:** prevent glob expansion in shaka-bot comment command parser ([#10281](https://github.com/shaka-project/shaka-player/issues/10281)) ([4c4ec18](https://github.com/shaka-project/shaka-player/commit/4c4ec1861ad10aec1c7cc24fff664f9b6b64715b))
...
* **HLS:** recognize binary/octet-stream as generic binary MIME type ([#10294](https://github.com/shaka-project/shaka-player/issues/10294)) ([6c2c206](https://github.com/shaka-project/shaka-player/commit/6c2c206f1e0fa7840e20f0d95a13da957cf36828))
* Set Default robustness on Android for Widevine key system ([#10289](https://github.com/shaka-project/shaka-player/issues/10289)) ([4891a24](https://github.com/shaka-project/shaka-player/commit/4891a240a328355b9b7cc6eaa82aa756d91f61d4))


### Performance Improvements

* **ts:** derive start time from PES headers ([#10132](https://github.com/shaka-project/shaka-player/issues/10132)) ([6380e2c](https://github.com/shaka-project/shaka-player/commit/6380e2c80bc28ec12973a2f829c959440578e51e))

## [4.16.39](https://github.com/shaka-project/shaka-player/compare/v4.16.38...v4.16.39) (2026-06-29)


### Bug Fixes

* Correct device detection for PlayStation 4 Pro to enable 4K resolution ([#10269](https://github.com/shaka-project/shaka-player/issues/10269)) ([eea9fd2](https://github.com/shaka-project/shaka-player/commit/eea9fd2cce4b46d8564a00fcde72cdacacf6c963))
...
* Avoid hang when loading a new asset after DRM playback ([#10239](https://github.com/shaka-project/shaka-player/issues/10239)) ([87b3ac6](https://github.com/shaka-project/shaka-player/commit/87b3ac6a83b08cb06afd4e31f4990fc42a0142d8))
...
* **Cast:** Use cast platform APIs in MediaCapabilties polyfill ([#10170](https://github.com/shaka-project/shaka-player/issues/10170)) ([f628f65](https://github.com/shaka-project/shaka-player/commit/f628f6541bd78992d1d7ac9efbbf1789e416e2c4))

## [4.16.34](https://github.com/shaka-project/shaka-player/compare/v4.16.33...v4.16.34) (2026-06-01)


### Bug Fixes

* **demo:** Re-enable lazy localization ([#10137](https://github.com/shaka-project/shaka-player/issues/10137)) ([825a8d4](https://github.com/shaka-project/shaka-player/commit/825a8d4e25533afbb21d8a461136a7a98e349887))
* Emit ratechange event when playbackRate stays at 0 ([#10130](https://github.com/shaka-project/shaka-player/issues/10130)) ([c0bcca9](https://github.com/shaka-project/shaka-player/commit/c0bcca9179d2327ff2bb58df4d656190a6893ef1))
* **preload:** Restore adaptation on reused Player with preloaded variant ([#10151](https://github.com/shaka-project/shaka-player/issues/10151)) ([01865e8](https://github.com/shaka-project/shaka-player/commit/01865e873506835ef2e08cc1f714326862232b6a))
...
* fix opus transmux sample duration ([#10090](https://github.com/shaka-project/shaka-player/issues/10090)) ([cea30c4](https://github.com/shaka-project/shaka-player/commit/cea30c47f0de52a4997ea818ddb865d7b740dc42))
* force gap jump when stalled at the end of a buffer ([#10086](https://github.com/shaka-project/shaka-player/issues/10086)) ([522ba06](https://github.com/shaka-project/shaka-player/commit/522ba06570f67b67524b4c47a30ee1dbde846f53))
* **Offline:** Only request the license on download when usePersistentLicense is true ([#10074](https://github.com/shaka-project/shaka-player/issues/10074)) ([2201734](https://github.com/shaka-project/shaka-player/commit/220173438edeaccfc486d01bdb759e63c6968816))


### Performance Improvements

* **player:** avoid full configuration deep-clone in time update callback ([#10098](https://github.com/shaka-project/shaka-player/issues/10098)) ([989ddba](https://github.com/shaka-project/shaka-player/commit/989ddbac9091eada30a38bc05929800ed566d684))
* **transmuxer:** Avoid repeatedly creating empty Uint8Arrays ([#10100](https://github.com/shaka-project/shaka-player/issues/10100)) ([03850f6](https://github.com/shaka-project/shaka-player/commit/03850f62ce01b3e13bcef7bbe4e30a2cd0646a2f))
* **transmuxer:** Reduce per-frame object allocations for h265, ac-3 and ec-3 ([#10094](https://github.com/shaka-project/shaka-player/issues/10094)) ([037c33e](https://github.com/shaka-project/shaka-player/commit/037c33e621c0aa01ab19bb7adc698c930cec6403))
...
* handle AC-4 immersive stereo (IMSA) in HLS and DASH spatial audio detection ([#10007](https://github.com/shaka-project/shaka-player/issues/10007)) ([fdd5676](https://github.com/shaka-project/shaka-player/commit/fdd567624d9541ea6a0a746c2007de3cb7bef96e))


### Performance Improvements

* **segments:** use binary search for segment lookup in more hot paths ([#9997](https://github.com/shaka-project/shaka-player/issues/9997)) ([38ad6cb](https://github.com/shaka-project/shaka-player/commit/38ad6cbfa12ab12a155e8c95d7a6a88592510367))

## [4.16.28](https://github.com/shaka-project/shaka-player/compare/v4.16.27...v4.16.28) (2026-04-20)


### Bug Fixes

* Avoid uncaught TypeError when destroying player during DRM key status change ([#9992](https://github.com/shaka-project/shaka-player/issues/9992)) ([3773838](https://github.com/shaka-project/shaka-player/commit/37738381f1d084191ff7dfb395049cc3ec5de49c))
* Clamp playback rate to 16x and improve playhead movement behavior ([#9996](https://github.com/shaka-project/shaka-player/issues/9996)) ([8d7fa85](https://github.com/shaka-project/shaka-player/commit/8d7fa856f0bde8a1e5f84c5de89de121001b35b7))
* **HLS:** Fix SAMPLE-AES identity stall at waitingforkey event on track switch ([#10000](https://github.com/shaka-project/shaka-player/issues/10000)) ([6b53fe6](https://github.com/shaka-project/shaka-player/commit/6b53fe65efc2eb1ef22936333e9004d0abdbd87a))
...
* Fix HDR detection in some devices ([#9908](https://github.com/shaka-project/shaka-player/issues/9908)) ([9736944](https://github.com/shaka-project/shaka-player/commit/97369442f37bad3398694c7464859047ddb39d4a))


### Performance Improvements

* **media:** replace filter calls in SegmentIndex with binary search ([#9880](https://github.com/shaka-project/shaka-player/issues/9880)) ([a3a3cc1](https://github.com/shaka-project/shaka-player/commit/a3a3cc16c65311b5fcf183ed2d55a678a2c4bbb8))
* **TS:** Eliminate per-PES wrapper array allocations in parse loop ([#9883](https://github.com/shaka-project/shaka-player/issues/9883)) ([83c317c](https://github.com/shaka-project/shaka-player/commit/83c317c7b2269a4e955f7a106b0e16ef5c2d29b8))
...
* Prevent live stream infinite buffering when isAudioMuxedInVideo is present ([#9835](https://github.com/shaka-project/shaka-player/issues/9835)) ([471e892](https://github.com/shaka-project/shaka-player/commit/471e8928694cfc616c9b4f3387241be89df34d91))
...
* Improve NativeTextDisplayer robustness, track-kind issues and enhance cleanup logic ([#9776](https://github.com/shaka-project/shaka-player/issues/9776)) ([56e0c64](https://github.com/shaka-project/shaka-player/commit/56e0c641cd2ccc34b03869dc497887c2f916faeb))
* prevent negative times in Stats ([#9784](https://github.com/shaka-project/shaka-player/issues/9784)) ([f742c4f](https://github.com/shaka-project/shaka-player/commit/f742c4fc3930ecfdb0b64c5103699bde4fb7589e))
* **tXml:** Return default value for a missing attribute ([#9734](https://github.com/shaka-project/shaka-player/issues/9734)) ([f87e1a8](https://github.com/shaka-project/shaka-player/commit/f87e1a8edff5ba375a5c6a6b8099dae1505d0570))


### Performance Improvements

* Eliminate DataViewReader allocation and use native clz32 in ExpGolomb ([#9779](https://github.com/shaka-project/shaka-player/issues/9779)) ([221080d](https://github.com/shaka-project/shaka-player/commit/221080df7fa020f003f64244c51e9ab63b93eb96))
* Improve performance of TsParser ([#9783](https://github.com/shaka-project/shaka-player/issues/9783)) ([8137611](https://github.com/shaka-project/shaka-player/commit/81376117f5b6c0ddf6005b5431609722343fcc58))
...
* Do not update the player position with negative playback rates if the video is paused ([#9732](https://github.com/shaka-project/shaka-player/issues/9732)) ([961529e](https://github.com/shaka-project/shaka-player/commit/961529ef82340123afed118439144feb77819516))
* **net:** Avoid duplicate progressUpdated in HttpXHRPlugin onload ([#9726](https://github.com/shaka-project/shaka-player/issues/9726)) ([62966be](https://github.com/shaka-project/shaka-player/commit/62966befa0491bf9f45020c01012418f02b2e28c))
* **TTML:** Update position alignment map ([#9735](https://github.com/shaka-project/shaka-player/issues/9735)) ([1ab7453](https://github.com/shaka-project/shaka-player/commit/1ab7453693b07cd6f82ea31e7c66407857d8532d))
* **UITextDisplayer:** avoid ResizeObserver loop warning ([#9722](https://github.com/shaka-project/shaka-player/issues/9722)) ([26aa79a](https://github.com/shaka-project/shaka-player/commit/26aa79a63a3ebcd22e3596d15de5d02ba3efc828))
...
* **ci:** Fix Firefox tests running on Windows ([#9670](https://github.com/shaka-project/shaka-player/issues/9670)) ([7b30a7a](https://github.com/shaka-project/shaka-player/commit/7b30a7a59f7f4e84845432caabf01f8faa6c401f))
* Correctly destroy enqueue blocking operations ([#9677](https://github.com/shaka-project/shaka-player/issues/9677)) ([b521769](https://github.com/shaka-project/shaka-player/commit/b5217695a0931ac6239d2288440862e8cd35803e))
* Setup correct video codecs on MSE ([#9667](https://github.com/shaka-project/shaka-player/issues/9667)) ([b32ba73](https://github.com/shaka-project/shaka-player/commit/b32ba7314b4d5f813b5fd9f2640b58325e41c977))
...
* **demo:** Fix assets metadata ([#9609](https://github.com/shaka-project/shaka-player/issues/9609)) ([7108fac](https://github.com/shaka-project/shaka-player/commit/7108fac74194f4551533481233e12b459a142f32))
* Dispatch metadata events when stream is paused and the user seeks ([#9628](https://github.com/shaka-project/shaka-player/issues/9628)) ([2001993](https://github.com/shaka-project/shaka-player/commit/2001993574c43abbc592c0e9c222e02cd02e6c24))
* Fix startAtSegmentBoundary config when using a live stream ([#9640](https://github.com/shaka-project/shaka-player/issues/9640)) ([84925ed](https://github.com/shaka-project/shaka-player/commit/84925ed712158724c120871022970ab7531aaf34))
* **LCEVC:** Return early if playerInterface object is destroyed ([#9621](https://github.com/shaka-project/shaka-player/issues/9621)) ([e93e02e](https://github.com/shaka-project/shaka-player/commit/e93e02e5d884feb140128e7b59057ca3d374ea2c))


### Performance Improvements

* **ABR:** Minor performance optimization in EWMA alpha calculation ([#9623](https://github.com/shaka-project/shaka-player/issues/9623)) ([046c657](https://github.com/shaka-project/shaka-player/commit/046c657c21fd26893acdd6a645915b472c14c57e))
* Minor performance optimizations in TXml text processing and root lookup ([#9622](https://github.com/shaka-project/shaka-player/issues/9622)) ([c3cebbc](https://github.com/shaka-project/shaka-player/commit/c3cebbcd095d751cdbf41d11813d3a5e74762e40))
...
* **Ads:** Remove duplicate listener on IMA CS integration ([#9367](https://github.com/shaka-project/shaka-player/issues/9367)) ([0b2b3fb](https://github.com/shaka-project/shaka-player/commit/0b2b3fb9e2dba676861114a0fce6a2d3d726d274))
* Ensure that the ABR has all the updated variants after making the initial selection ([#9344](https://github.com/shaka-project/shaka-player/issues/9344)) ([e6cabaf](https://github.com/shaka-project/shaka-player/commit/e6cabaf7367427267bd1045c3621bd79c837926e))
* Fix infinity initial loop when no autoplay and there is a initial gap ([#9372](https://github.com/shaka-project/shaka-player/issues/9372)) ([a84113e](https://github.com/shaka-project/shaka-player/commit/a84113eba149d4e5a8fe5569e4a874c9c65d0960))
* Increase tolerance of completion ratio calculation ([#9366](https://github.com/shaka-project/shaka-player/issues/9366)) ([72147e5](https://github.com/shaka-project/shaka-player/commit/72147e586881ed74a6ff811b0bb6acaee466ed3a)), closes [#9365](https://github.com/shaka-project/shaka-player/issues/9365)
* **UI:** Fix constructed through DOM auto-setup ([#9352](https://github.com/shaka-project/shaka-player/issues/9352)) ([584361f](https://github.com/shaka-project/shaka-player/commit/584361f870d9f0b775bc5c835047afde4fde6ec7))
* **Xbox:** Enable little-endian PlayReady key IDs to resolve DRM error ([#9348](https://github.com/shaka-project/shaka-player/issues/9348)) ([9197f9e](https://github.com/shaka-project/shaka-player/commit/9197f9ea13d94f07b981f4be8f062b598c6d12ba))
...
* **Cast:** Allow serialize arrays ([#9277](https://github.com/shaka-project/shaka-player/issues/9277)) ([29b3ccf](https://github.com/shaka-project/shaka-player/commit/29b3ccf21155507fa76ef52d9cb9b452bba7858d))
* **Cast:** Allow serialize nested events ([#9281](https://github.com/shaka-project/shaka-player/issues/9281)) ([d4512ca](https://github.com/shaka-project/shaka-player/commit/d4512cab8a15c645c784313c0d51a4ea7009764b))
* **Cast:** Allow serialize nested events ([#9283](https://github.com/shaka-project/shaka-player/issues/9283)) ([64310c3](https://github.com/shaka-project/shaka-player/commit/64310c37d90a0ad7f57024889aa7053d30ad9489))
* Delay position change during codec switch ([#9293](https://github.com/shaka-project/shaka-player/issues/9293)) ([72b09b0](https://github.com/shaka-project/shaka-player/commit/72b09b0d7a1cedf0a5c957428b4dbebeef97d8aa))
...
* Make sure the player is attached when loading a new stream ([#9292](https://github.com/shaka-project/shaka-player/issues/9292)) ([2f87297](https://github.com/shaka-project/shaka-player/commit/2f87297d9d4d6f8f2d5f71ef3c6740af368fb680))
* **UI:** Allow play in VR in all compatible devices ([#9297](https://github.com/shaka-project/shaka-player/issues/9297)) ([149de1c](https://github.com/shaka-project/shaka-player/commit/149de1c494483a6c2466da6b94bc46313c0a71b1))
...
* **UI:** Avoid show NaN in ad info ([#9284](https://github.com/shaka-project/shaka-player/issues/9284)) ([19e6122](https://github.com/shaka-project/shaka-player/commit/19e61221fee0f68b909baaa607db805705b6c18a))
...
* **UI:** Disable VR mode while casting ([#9296](https://github.com/shaka-project/shaka-player/issues/9296)) ([9832a60](https://github.com/shaka-project/shaka-player/commit/9832a60fa6a9091c21711361ef3fddfe4f1ef4ec))
...
* **CMCD:** Add ts key support ([#8971](https://github.com/shaka-project/shaka-player/issues/8971)) ([ab3a452](https://github.com/shaka-project/shaka-player/commit/ab3a452cea4b596e1f8b123bc81cd68400b0302a))
...
* **UI:** Change SVG icons for statistics ([#8985](https://github.com/shaka-project/shaka-player/issues/8985)) ([9ab921a](https://github.com/shaka-project/shaka-player/commit/9ab921aed9fcf4854586fc504f034caacdf31849))
...
* avoid calling new Date(null * 1000) ([#8963](https://github.com/shaka-project/shaka-player/issues/8963)) ([47ea45d](https://github.com/shaka-project/shaka-player/commit/47ea45d360a7a44b69aa7f3f222007d2f4f9ff38))
...
* **Demo:** Assign valid regex to asset name input ([#8815](https://github.com/shaka-project/shaka-player/issues/8815)) ([3dd685c](https://github.com/shaka-project/shaka-player/commit/3dd685c3c892aaf8f1f1798dbc2e072a385a62ce))
...
* Fix probeSupport when testing opus and flac codecs ([#8987](https://github.com/shaka-project/shaka-player/issues/8987)) ([d7d3c51](https://github.com/shaka-project/shaka-player/commit/d7d3c518158580e8df42950467f7effa1dc89931))
...
* **HLS:** mediaSequenceToStartTime isn't maintained correctly for AUDIO manifest ([#8784](https://github.com/shaka-project/shaka-player/issues/8784)) ([e23112e](https://github.com/shaka-project/shaka-player/commit/e23112ec678bd433804d6f22c9c41d194e10e16d))
