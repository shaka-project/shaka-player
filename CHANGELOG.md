...
* Fix audio properties detection ([#6867](https://github.com/shaka-project/shaka-player/issues/6867)) ([fc6a95e](https://github.com/shaka-project/shaka-player/commit/fc6a95ee880551effc80389d75f567ec8a0c03d3))
* Fix continues to play a few seconds after reaching playRangeEnd ([#6861](https://github.com/shaka-project/shaka-player/issues/6861)) ([e1b5fa8](https://github.com/shaka-project/shaka-player/commit/e1b5fa88121d01aa38f58265f055cf600ab8ddd8))
* Fix normalized codec for Dolby Vision ([#6865](https://github.com/shaka-project/shaka-player/issues/6865)) ([4efbd29](https://github.com/shaka-project/shaka-player/commit/4efbd29bf809ab670e1fd42f7a94a6a44999513d))
* **UI:** update French translations ([#6873](https://github.com/shaka-project/shaka-player/issues/6873)) ([e1520bf](https://github.com/shaka-project/shaka-player/commit/e1520bf480993cec0f0df901287863e7ff6c6c95))
* **UI:** update Portuguese translations ([#6874](https://github.com/shaka-project/shaka-player/issues/6874)) ([6ed887b](https://github.com/shaka-project/shaka-player/commit/6ed887bc796df78c00f8df2a9bbf365b17bf150a))
* **UI:** update Spanish translations ([#6875](https://github.com/shaka-project/shaka-player/issues/6875)) ([24d28da](https://github.com/shaka-project/shaka-player/commit/24d28daa0fd62fb41ed76d1dcff6b1fa52a8c23a))
...
* Exclude fetch polyfill from fetch plugin ([#6838](https://github.com/shaka-project/shaka-player/issues/6838)) ([53ebac4](https://github.com/shaka-project/shaka-player/commit/53ebac4bad05372e240a4c3c4fd4ae6b7dfbaf87))
* **TTML:** Extended subtitle codec support ([#6832](https://github.com/shaka-project/shaka-player/issues/6832)) ([f3955d8](https://github.com/shaka-project/shaka-player/commit/f3955d8595c631569b454455643d2802bbcee57b)), closes [#6831](https://github.com/shaka-project/shaka-player/issues/6831)
* **TTML:** Fix timing parsing when using 1dp ([#6830](https://github.com/shaka-project/shaka-player/issues/6830)) ([7712f2d](https://github.com/shaka-project/shaka-player/commit/7712f2d4eea7c67d5382c9244f51ad05153a2ee0)), closes [#6829](https://github.com/shaka-project/shaka-player/issues/6829)
* **UI:** update Polish translations ([#6846](https://github.com/shaka-project/shaka-player/issues/6846)) ([f2eb867](https://github.com/shaka-project/shaka-player/commit/f2eb867794c5430e77376b9f64ab519bb550d9a7))
...
* **ABR:** Fix variant choose when two variants have the same bandwidth but different resolution ([#6760](https://github.com/shaka-project/shaka-player/issues/6760)) ([ea8b380](https://github.com/shaka-project/shaka-player/commit/ea8b380098a27a3409a84ba50d3172cbb0a8164d))
* **HLS:** Fix seekRange when using delta playlist ([#6758](https://github.com/shaka-project/shaka-player/issues/6758)) ([41fdc8b](https://github.com/shaka-project/shaka-player/commit/41fdc8b629741f69f907155cdcd14cf6e595ee59))
* **HLS:** Ignore query params in the uri of EXT-X-SESSION-KEY tags ([#6755](https://github.com/shaka-project/shaka-player/issues/6755)) ([36425bd](https://github.com/shaka-project/shaka-player/commit/36425bd1c3b79eeba733966451de29c436367328))

## [4.8.11](https://github.com/shaka-project/shaka-player/compare/v4.8.10...v4.8.11) (2024-06-05)


### Bug Fixes

* Avoid filter manifest when the DRM is not initialized ([#6737](https://github.com/shaka-project/shaka-player/issues/6737)) ([0545c5e](https://github.com/shaka-project/shaka-player/commit/0545c5e2b26bcb38163fe63b0f579b3f25125c48))
* **preload:** Fix error handling ([#6753](https://github.com/shaka-project/shaka-player/issues/6753)) ([b400d9d](https://github.com/shaka-project/shaka-player/commit/b400d9d21d549d21e46222da0a9e4078daf0bd07))
* **preload:** Fix preload error reporting ([#6746](https://github.com/shaka-project/shaka-player/issues/6746)) ([3f09fbe](https://github.com/shaka-project/shaka-player/commit/3f09fbe6795fb9803779f9cdb5c2b7e0f27e6944))
* Support for Zenterio ([#6717](https://github.com/shaka-project/shaka-player/issues/6717)) ([78797b7](https://github.com/shaka-project/shaka-player/commit/78797b7a92fe2139cebcc20f52514d7028c378c0))
* **UI:** Don't show presentation time in ads ([#6752](https://github.com/shaka-project/shaka-player/issues/6752)) ([30c2c8a](https://github.com/shaka-project/shaka-player/commit/30c2c8a9514014cb6fca9091d06825478bcd262f))
* **UI:** Fix resolution sorting ([#6742](https://github.com/shaka-project/shaka-player/issues/6742)) ([ce545e0](https://github.com/shaka-project/shaka-player/commit/ce545e08de45bb8590d692fe7aa90081b885079f))
