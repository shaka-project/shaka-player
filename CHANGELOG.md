...
* **Ads:** Don't load useless segments when using playoutLimit on interstitial ads ([#7469](https://github.com/shaka-project/shaka-player/issues/7469)) ([d1ec8dc](https://github.com/shaka-project/shaka-player/commit/d1ec8dc5f497f4ac37a2e40ca027eb5b5b96296e))
* **Ads:** Limit interstitial duration to actual duration if available ([#7480](https://github.com/shaka-project/shaka-player/issues/7480)) ([9af4397](https://github.com/shaka-project/shaka-player/commit/9af439782b501136700c05261240975f356b699e))
* **Ads:** Limit interstitial duration to actual duration if available when using src= ([#7488](https://github.com/shaka-project/shaka-player/issues/7488)) ([c0b8966](https://github.com/shaka-project/shaka-player/commit/c0b8966b634580346abc7328a57215a1f34fb48f))
...
* Fix disable stream when no manifest ([#7497](https://github.com/shaka-project/shaka-player/issues/7497)) ([5fa20dd](https://github.com/shaka-project/shaka-player/commit/5fa20dda04a7635abf742a6934994ed9f2daa829))
* Fix metadata timing when using TS ([#7478](https://github.com/shaka-project/shaka-player/issues/7478)) ([1b4ea37](https://github.com/shaka-project/shaka-player/commit/1b4ea37a52935e4ed44803b49c3049451a65477a))
* Fix reset MSE to last independent segment ([#7494](https://github.com/shaka-project/shaka-player/issues/7494)) ([8a01b67](https://github.com/shaka-project/shaka-player/commit/8a01b673b21dde3d82c3da54420faff85b3a535f))
* Fix select HLG tracks when using AUTO hdr level ([#7470](https://github.com/shaka-project/shaka-player/issues/7470)) ([5799156](https://github.com/shaka-project/shaka-player/commit/57991562febef08cce8faa2091f8369333ad010d))
* Fix Windows detection ([#7476](https://github.com/shaka-project/shaka-player/issues/7476)) ([1aef0d1](https://github.com/shaka-project/shaka-player/commit/1aef0d1154ca26bb92dfc5edb531f0bea9c6a83f))
* **MSS:** Don't allow prefetch segments with self-generated data ([#7485](https://github.com/shaka-project/shaka-player/issues/7485)) ([4bbb9f5](https://github.com/shaka-project/shaka-player/commit/4bbb9f5bede2b493eb6014db4f1890147c978e51))
* **MSS:** Fix timeline repetitions ([#7484](https://github.com/shaka-project/shaka-player/issues/7484)) ([7a45a57](https://github.com/shaka-project/shaka-player/commit/7a45a57d639f254dd8ed78a43dadd2494860a587))
* **UI:** Don't enable StatisticsButton when create overflow menu ([#7481](https://github.com/shaka-project/shaka-player/issues/7481)) ([3b1ecae](https://github.com/shaka-project/shaka-player/commit/3b1ecaef86daa0d9788ca5222057833885b21c02))
* **UI:** Hidden cursor correctly ([#7464](https://github.com/shaka-project/shaka-player/issues/7464)) ([11ab62a](https://github.com/shaka-project/shaka-player/commit/11ab62a0d56e730bc05f8a5e6c85cbfd63f8cc75))
...
* **DASH:** Allow mixing SegmentTemplate-SegmentTimeline with SegmentTemplate-numbering ([#7286](https://github.com/shaka-project/shaka-player/issues/7286)) ([9d4caab](https://github.com/shaka-project/shaka-player/commit/9d4caab8943fe67f2660271d721568f0d7a0aaf4))
* **DASH:** Clear streamMap when period is removed from the manifest ([#7297](https://github.com/shaka-project/shaka-player/issues/7297)) ([71a8414](https://github.com/shaka-project/shaka-player/commit/71a84144a1fe203b69f049cfa7ac7e74c1a2bf0a))
* **DASH:** Clear usedPeriodIds when period is removed from the manifest ([#7305](https://github.com/shaka-project/shaka-player/issues/7305)) ([cbce2dc](https://github.com/shaka-project/shaka-player/commit/cbce2dcca7a45fdc56f09ed456860c9d7a005e79))
* **DASH:** Clone closedCaptions map in PeriodCombiner output stream ([#7309](https://github.com/shaka-project/shaka-player/issues/7309)) ([5eff3d9](https://github.com/shaka-project/shaka-player/commit/5eff3d9116b9b395019fe88ca281a79b939eddb4)), closes [#7303](https://github.com/shaka-project/shaka-player/issues/7303)
* **DASH:** Evict (by time) indexes in MetaSegmentIndex ([#7296](https://github.com/shaka-project/shaka-player/issues/7296)) ([a919feb](https://github.com/shaka-project/shaka-player/commit/a919febf0ef5115689128aa266af7ac1fe40fd73))
* Do not seek to first subtitle ([#7312](https://github.com/shaka-project/shaka-player/issues/7312)) ([b7a940a](https://github.com/shaka-project/shaka-player/commit/b7a940acc02df30ad544c93b2ec50ae702d6080b)), closes [#7310](https://github.com/shaka-project/shaka-player/issues/7310)


### Performance Improvements

* **DASH:** Create segment indexes only on new periods ([#7294](https://github.com/shaka-project/shaka-player/issues/7294)) ([0333f9e](https://github.com/shaka-project/shaka-player/commit/0333f9ef563a39d9b877a562e79bc160d486c881))
* **DASH:** Delete old matchedStreams ([#7301](https://github.com/shaka-project/shaka-player/issues/7301)) ([729afb1](https://github.com/shaka-project/shaka-player/commit/729afb1089b39641d647f34bf11bceb2816929b1))
* **DASH:** Delete old matchedStreams when using trickmodeVideo ([#7306](https://github.com/shaka-project/shaka-player/issues/7306)) ([ea25ca3](https://github.com/shaka-project/shaka-player/commit/ea25ca3b418f0919f3406f8c0c84988c4b81af38))
* Only use tXml parent when necessary ([#7304](https://github.com/shaka-project/shaka-player/issues/7304)) ([81a0efa](https://github.com/shaka-project/shaka-player/commit/81a0efa36d99bd5c9bf41a04b3568d4431c35107))
...
* **ABR:** Do not adapt between spatial & non spatial audio ([#7067](https://github.com/shaka-project/shaka-player/issues/7067)) ([077fda6](https://github.com/shaka-project/shaka-player/commit/077fda60950097abc9cf3c69805e2e70235297e9))
* **DASH:** Fix codec/mimeType for single text file ([#7075](https://github.com/shaka-project/shaka-player/issues/7075)) ([c932376](https://github.com/shaka-project/shaka-player/commit/c9323763450ffca98591ce573523923a7c88e7d6))
* **DASH:** Fix period combining when roles are equal ([#7065](https://github.com/shaka-project/shaka-player/issues/7065)) ([617f157](https://github.com/shaka-project/shaka-player/commit/617f1578c15c9021e1d905269d6199e14f22fd73))
* Disable CC with disableText config ([#7078](https://github.com/shaka-project/shaka-player/issues/7078)) ([1b9435b](https://github.com/shaka-project/shaka-player/commit/1b9435b42f1e6c37cb30d74dc4cc68d9415d7c63))
* Only check encryptionScheme when is not null and not empty string ([#7079](https://github.com/shaka-project/shaka-player/issues/7079)) ([bcbcbe8](https://github.com/shaka-project/shaka-player/commit/bcbcbe847187c1679232c40602071e6cfe15951f))
* Unify maxDisabledTime behaviour ([#7077](https://github.com/shaka-project/shaka-player/issues/7077)) ([8ea2560](https://github.com/shaka-project/shaka-player/commit/8ea256004663a3c5aad9c477aac3a9a70ee1b8ee))
...
* Avoid clear buffer when select the same audio track ([#6959](https://github.com/shaka-project/shaka-player/issues/6959)) ([f7c849b](https://github.com/shaka-project/shaka-player/commit/f7c849be4d5aed436e8a8e582ef04e9a459d9c51))
* Exclude future segments in notifyTimeRange calculations ([#6970](https://github.com/shaka-project/shaka-player/issues/6970)) ([32d63c6](https://github.com/shaka-project/shaka-player/commit/32d63c66e8587307964a79bf6509ff944517f4fd))
* Filter duplicate cues on text displayer append ([#6949](https://github.com/shaka-project/shaka-player/issues/6949)) ([4e1f528](https://github.com/shaka-project/shaka-player/commit/4e1f5281e0948dc446d77cb74a73f4f7faa4882f))
* Fix NaN and empty objects in getNonDefaultConfiguration ([#6956](https://github.com/shaka-project/shaka-player/issues/6956)) ([b15bb94](https://github.com/shaka-project/shaka-player/commit/b15bb943d6a0ccc44c28cb10a0b5b31bdf4d109e))
* **SimpleTextDisplayer:** Do not disable metadata & chapters tracks ([#6948](https://github.com/shaka-project/shaka-player/issues/6948)) ([b9e7ffe](https://github.com/shaka-project/shaka-player/commit/b9e7ffe1d6023c66b9d719cb60ec4f48045bfa3c))
* **SSA:** Support files with line breaks that are not necessary ([#6947](https://github.com/shaka-project/shaka-player/issues/6947)) ([f54170e](https://github.com/shaka-project/shaka-player/commit/f54170edeb3cd8743ec7856c021492b47f6caa37))
* **Stats:** Fix completionPercent for Live ([#6957](https://github.com/shaka-project/shaka-player/issues/6957)) ([4dcc8ae](https://github.com/shaka-project/shaka-player/commit/4dcc8ae4feeeca45719e130f5c9b819d95837c01))
* **TTML:** Fix font styles parsing ([#6969](https://github.com/shaka-project/shaka-player/issues/6969)) ([5decb34](https://github.com/shaka-project/shaka-player/commit/5decb344df14a2173839052e98ca7a03da7a8b41))
* **TTML:** Show background color with image subtitles ([#6967](https://github.com/shaka-project/shaka-player/issues/6967)) ([40241e6](https://github.com/shaka-project/shaka-player/commit/40241e65a34bd043069f670641f57feceaeb04a2))
* **UI:** Don't display NaN stats ([#6958](https://github.com/shaka-project/shaka-player/issues/6958)) ([7b894e6](https://github.com/shaka-project/shaka-player/commit/7b894e6c2d6479e72f9edd4489791136d32c6ce5))


### Performance Improvements

* **DRM:** compare init data only when config flag is set ([#6952](https://github.com/shaka-project/shaka-player/issues/6952)) ([030386c](https://github.com/shaka-project/shaka-player/commit/030386ca7afb5fe9e4bfa9919b36ea43f7c5b96c))
* **HLS:** do not loop twice when processing nalus ([#6954](https://github.com/shaka-project/shaka-player/issues/6954)) ([7a2fc6d](https://github.com/shaka-project/shaka-player/commit/7a2fc6d7d0df6f01534d6e46048f08eb1d6d3839))
