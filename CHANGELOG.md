...
* Disable translate of cues when using UITextDisplayer ([#8636](https://github.com/shaka-project/shaka-player/issues/8636)) ([66a61a8](https://github.com/shaka-project/shaka-player/commit/66a61a87aceded7e3a22f52684016eddae1891f9))
* Fix dispatch complete event when the percentage is greater than 100 ([#8643](https://github.com/shaka-project/shaka-player/issues/8643)) ([27ed102](https://github.com/shaka-project/shaka-player/commit/27ed102e7dfb8d7353ade1daf5f9c55363759ebb))
* Fix metadata timestamp when using raw segments ([#8654](https://github.com/shaka-project/shaka-player/issues/8654)) ([a7081a2](https://github.com/shaka-project/shaka-player/commit/a7081a2101394d3d4fa99628079ee698d6e50d33))
* **HLS:** Fix disableAudio and disableVideo when loading a media playlist ([#8642](https://github.com/shaka-project/shaka-player/issues/8642)) ([503a2ab](https://github.com/shaka-project/shaka-player/commit/503a2ab53e183d44b3281e586c88f48b07ea5258))
* **net:** Fix "Payload length does not match range requested bytes" when using open end ([#8651](https://github.com/shaka-project/shaka-player/issues/8651)) ([8be2097](https://github.com/shaka-project/shaka-player/commit/8be209730701885395f04c52defc27f4e346ae65))
* Use proper method for checking is object an array ([#8644](https://github.com/shaka-project/shaka-player/issues/8644)) ([6b15f3d](https://github.com/shaka-project/shaka-player/commit/6b15f3df4c47fa576e8ecd8a8deea1a0623e3246))


### Performance Improvements

* Init source buffers synchronously ([#8646](https://github.com/shaka-project/shaka-player/issues/8646)) ([dc1d6d7](https://github.com/shaka-project/shaka-player/commit/dc1d6d757162e2888d67a1bf33de99efee775ac4))
* Optimize DRM compatibility check across streams ([#8652](https://github.com/shaka-project/shaka-player/issues/8652)) ([f5c05a8](https://github.com/shaka-project/shaka-player/commit/f5c05a895461a2929cbb37643d92eb44c503baac))
* Remove redundant collection in Streaming Engine ([#8645](https://github.com/shaka-project/shaka-player/issues/8645)) ([b3f4d53](https://github.com/shaka-project/shaka-player/commit/b3f4d53e16d0132ec44b7b936c71c11e32396cdd))

## [4.13.23](https://github.com/shaka-project/shaka-player/compare/v4.13.22...v4.13.23) (2025-05-22)


### Bug Fixes

* Allow use isLive, seekRange and isAudioOnly when using remote playback ([#8629](https://github.com/shaka-project/shaka-player/issues/8629)) ([8367e96](https://github.com/shaka-project/shaka-player/commit/8367e968bde613ec86b1d8ed241e4174b2c0562c))
* Avoid reset MSE engine when using remote playback ([#8626](https://github.com/shaka-project/shaka-player/issues/8626)) ([cc5d459](https://github.com/shaka-project/shaka-player/commit/cc5d4596914765d58f2b42e5239ee37ac5ab1695))
* **UI:** Fix visibility events on the UI ([#8619](https://github.com/shaka-project/shaka-player/issues/8619)) ([58bfc3d](https://github.com/shaka-project/shaka-player/commit/58bfc3d991afa6e5cfc1320e5206965a879bce4c))
* **WebOS:** Do not throw error during parsing ID3 ([#8623](https://github.com/shaka-project/shaka-player/issues/8623)) ([8a05f56](https://github.com/shaka-project/shaka-player/commit/8a05f56c02a434412eefa0bdea37522bcbbb0e97))


### Performance Improvements

* **net:** Avoid parsing headers twice ([#8618](https://github.com/shaka-project/shaka-player/issues/8618)) ([452b213](https://github.com/shaka-project/shaka-player/commit/452b2138f30443b6bae4efd587bdbe3c2c7bc40f))
...
* **Offline:** Handle missing window.matchMedia API ([#8442](https://github.com/shaka-project/shaka-player/issues/8442)) ([68682cb](https://github.com/shaka-project/shaka-player/commit/68682cb32d0af4c3eac9445cdb30b27ded8b2f79))
* **UI:** Avoid show resolution bandwidth when it's not necessary ([#8440](https://github.com/shaka-project/shaka-player/issues/8440)) ([55615b9](https://github.com/shaka-project/shaka-player/commit/55615b957511b9d54f91501b82856536a0682916))
* **UI:** Check remote availability on remote button ([#8453](https://github.com/shaka-project/shaka-player/issues/8453)) ([fe98cb1](https://github.com/shaka-project/shaka-player/commit/fe98cb1d2ba719bf5d7931303856be7485c9c7c2))


### Performance Improvements

* **DASH:** Release period combiner after parsing a VOD ([#8443](https://github.com/shaka-project/shaka-player/issues/8443)) ([6fda02f](https://github.com/shaka-project/shaka-player/commit/6fda02f130d140e86853f2e0b4928f824a508f45))
...
* Check addTextTrack in video ([#8388](https://github.com/shaka-project/shaka-player/issues/8388)) ([d78ed65](https://github.com/shaka-project/shaka-player/commit/d78ed656871506732c109c7c182eff386c47beec))
* Count line break characters as ASCII ([#8376](https://github.com/shaka-project/shaka-player/issues/8376)) ([186fd5f](https://github.com/shaka-project/shaka-player/commit/186fd5f2010790ef8395f07637b6509ed3f334ac)), closes [#8336](https://github.com/shaka-project/shaka-player/issues/8336)
* Detect and skip stall correctly ([#8390](https://github.com/shaka-project/shaka-player/issues/8390)) ([7b08970](https://github.com/shaka-project/shaka-player/commit/7b08970fe820d55428c7fb2ee4d2295a8b95e2b1))
* FRMA generation ([#8367](https://github.com/shaka-project/shaka-player/issues/8367)) ([5e30126](https://github.com/shaka-project/shaka-player/commit/5e3012692ef6aaa8447f03f59ecc2d63163060a5))
* Handle missing window.matchMedia API ([#8385](https://github.com/shaka-project/shaka-player/issues/8385)) ([202792b](https://github.com/shaka-project/shaka-player/commit/202792bd1c6a261a556734f1cc34566ace6c23bd))
* Handle null response body for fetch responses ([#8384](https://github.com/shaka-project/shaka-player/issues/8384)) ([014eefb](https://github.com/shaka-project/shaka-player/commit/014eefb2629df25cbf776cf0364f81cc31c7eae0))
* Improve maxResolution detection on Tizen ([#8365](https://github.com/shaka-project/shaka-player/issues/8365)) ([41e07aa](https://github.com/shaka-project/shaka-player/commit/41e07aa985df6a3c103b43998428fae1c07270ac))
* **Offline:** Fix HLS-AES download ([#8374](https://github.com/shaka-project/shaka-player/issues/8374)) ([42a2c50](https://github.com/shaka-project/shaka-player/commit/42a2c500ec861c0550596c8110d5e54fbac00fdd))
* Read TRUN data_offset as signed int ([#8383](https://github.com/shaka-project/shaka-player/issues/8383)) ([d08f1bc](https://github.com/shaka-project/shaka-player/commit/d08f1bc8de18b6b5a6481f16fa68ce406cc62492))
* Support more Dolby codec notations ([#8387](https://github.com/shaka-project/shaka-player/issues/8387)) ([31a871a](https://github.com/shaka-project/shaka-player/commit/31a871a6936e496f18fea99507ca03054959d736))
* **UI:** Don't allow click on the buttons when the UI is not visible ([#8396](https://github.com/shaka-project/shaka-player/issues/8396)) ([e256102](https://github.com/shaka-project/shaka-player/commit/e256102a53c8589e9051442ca15b6a5c1afc886c))
* **UI:** honors singleClickForPlayAndPause when made a single tap with seekOnTaps = true ([#8393](https://github.com/shaka-project/shaka-player/issues/8393)) ([983584c](https://github.com/shaka-project/shaka-player/commit/983584c848eebbaa48b7f7ac9c0273fefd9a1e29))

## [4.13.14](https://github.com/shaka-project/shaka-player/compare/v4.13.13...v4.13.14) (2025-03-31)


### Bug Fixes

* **HLS:** Avoid duplicate init segment request when using SAMPLE-AES ([#8361](https://github.com/shaka-project/shaka-player/issues/8361)) ([2d7b53f](https://github.com/shaka-project/shaka-player/commit/2d7b53f570af0927e23fd2aeaee7da551105ef71))
* **HLS:** Fix variable substitution when using relative paths ([#8350](https://github.com/shaka-project/shaka-player/issues/8350)) ([7a84b8c](https://github.com/shaka-project/shaka-player/commit/7a84b8cd86af6818bde9c18319361f987cb2fae2))
* **UI:** Make UI display 4096x2160 (DCI 4k) video as also being "4k" ([#8359](https://github.com/shaka-project/shaka-player/issues/8359)) ([f737ca0](https://github.com/shaka-project/shaka-player/commit/f737ca00f3cdceba2150f845d2daf0b3551943a8))


### Performance Improvements

* **ContentWorkarounds:** Do not override codec twice ([#8358](https://github.com/shaka-project/shaka-player/issues/8358)) ([286602b](https://github.com/shaka-project/shaka-player/commit/286602ba8eb42aaff0d7379b654d334554c0668b))
* Stop parsing the mp4 when the init segment is encrypted on ContentWorkarounds ([#8353](https://github.com/shaka-project/shaka-player/issues/8353)) ([11d0142](https://github.com/shaka-project/shaka-player/commit/11d014210f693203ada776cc3ee5da298123450e))
...
* **Ads:** Destroy preloadManagers on stop interstitials ([#8268](https://github.com/shaka-project/shaka-player/issues/8268)) ([54e0079](https://github.com/shaka-project/shaka-player/commit/54e00792f06694626c638ba3d70cec0f272e43de))
* Call modifyCueCallback in src= mode ([#8254](https://github.com/shaka-project/shaka-player/issues/8254)) ([294ffac](https://github.com/shaka-project/shaka-player/commit/294ffacc0fbe0826e7a6376d2d7d2669b8056c81))
* Closure compiler removes call to modifyCueCallback in src= mode ([#8261](https://github.com/shaka-project/shaka-player/issues/8261)) ([0d83886](https://github.com/shaka-project/shaka-player/commit/0d83886336d3662d27efd9bdc215f8b4558ec160))
* **hls:** Removing Possible encoding problem detected ([#8253](https://github.com/shaka-project/shaka-player/issues/8253)) ([3f46c0d](https://github.com/shaka-project/shaka-player/commit/3f46c0d2e5ffab21e3b2efaaa15ac2b8084fd21b))
* Make shaka.util.Lazy work with null ([#8267](https://github.com/shaka-project/shaka-player/issues/8267)) ([5e054c2](https://github.com/shaka-project/shaka-player/commit/5e054c2f6218fbf03cf643c072b82b0af82c9489))
* Persist selected audio track role after variant update in `selectVariantTrack` ([#8249](https://github.com/shaka-project/shaka-player/issues/8249)) ([33b8205](https://github.com/shaka-project/shaka-player/commit/33b8205c8e38754f59e4975d61646183af82ad8f)), closes [#8248](https://github.com/shaka-project/shaka-player/issues/8248)
* **UI:** Disable save video frame button while casting ([#8258](https://github.com/shaka-project/shaka-player/issues/8258)) ([cd8bed5](https://github.com/shaka-project/shaka-player/commit/cd8bed5f47d96dfdb57ab5c1df6f5d1fb0f7164d))
* Update region observer with new rules for small regions ([#8275](https://github.com/shaka-project/shaka-player/issues/8275)) ([9613ca0](https://github.com/shaka-project/shaka-player/commit/9613ca0aea7eb7d7684c17b21f74f3b75d6303b6))
